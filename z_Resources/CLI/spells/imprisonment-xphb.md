...
- **Chaining.** Chains firmly rooted in the ground hold the target in place. The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained) condition and can't be moved by any means.  
...
- **Slumber.** The target has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious) condition and can't be awoken.  
- **Ending the Spell.** When you cast the spell, specify a trigger that will end it. The trigger can be as simple or as elaborate as you choose, but the DM must agree that it has a high likelihood of happening within the next decade. The trigger must be an observable action, such as someone making a particular offering at the temple of your god, saving your true love, or defeating a specific monster.  
    ...
    A [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md) spell can end the spell only if it is cast with a level 9 spell slot, targeting either the prison or the component used to create it.  
