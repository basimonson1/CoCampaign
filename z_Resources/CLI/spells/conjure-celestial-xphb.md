...
- **Healing Light.** The target regains [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal to `4d12` plus your spellcasting ability modifier.  
- **Searing Light.** The target makes a Dexterity saving throw, taking `6d12` Radiant damage on a failed save or half as much damage on a successful one.  
    ...
    Until the spell ends, [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md) fills the Cylinder, and when you move on your turn, you can also move the Cylinder up to 30 feet.  
