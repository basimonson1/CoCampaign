...
You touch a creature and end the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition on it. For the duration, the target has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on saving throws to avoid or end the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition, and it has [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) to Poison damage.
