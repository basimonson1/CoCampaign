...
For the duration, the target appears dead to outward inspection and to spells used to determine the target's status. The target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded) and [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) conditions, and its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) is 0.

The target also has [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) to all damage except Psychic damage, and it has [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md) to the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition.
