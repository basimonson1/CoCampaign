...
Swarming locusts fill a 20-foot-radius Sphere centered on a point you choose within range. The Sphere remains for the duration, and its area is [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md) and [Difficult Terrain](z_Resources/CLI/rules/variant-rules/difficult-terrain-xphb.md).
