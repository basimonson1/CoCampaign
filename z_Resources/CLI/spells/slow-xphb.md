...
An affected target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) is halved, it takes a -2 penalty to AC and Dexterity saving throws, and it can't take Reactions. On its turns, it can take either an action or a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md), not both, and it can make only one attack if it takes the [Attack](z_Resources/CLI/rules/actions.md#Attack) action. If it casts a spell with a Somatic component, there is a  chance the spell fails as a result of the target making the spell's gestures too slowly.
