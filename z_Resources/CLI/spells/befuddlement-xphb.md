...
On a failed save, the target takes `10d12` Psychic damage and can't cast spells or take the [Magic](z_Resources/CLI/rules/actions.md#Magic) action. At the end of every 30 days, the target repeats the save, ending the effect on a success. The effect can also be ended by the [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md), [Heal](z_Resources/CLI/spells/heal-xphb.md), or [Wish](z_Resources/CLI/spells/wish-xphb.md) spell.
