...
![](z_Resources/CLI/spells/img/phantom-steed.webp#right)
...
For the duration, you or a creature you choose can ride the steed. The steed uses the [Riding Horse](z_Resources/CLI/bestiary/beast/riding-horse-xmm.md) stat block, except it has a [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) of 100 feet and can travel 13 miles in an hour. When the spell ends, the steed gradually fades, giving the rider 1 minute to dismount. The spell ends early if the steed takes any damage.
