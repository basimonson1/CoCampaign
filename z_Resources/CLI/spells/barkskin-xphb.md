...
You touch a willing creature. Until the spell ends, the target's skin assumes a bark-like appearance, and the target has an [Armor Class](z_Resources/CLI/rules/variant-rules/armor-class-xphb.md) of 17 if its AC is lower than that.
