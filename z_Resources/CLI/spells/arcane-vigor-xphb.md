...
You tap into your life force to heal yourself. Roll one or two of your unexpended [Hit Point Dice](z_Resources/CLI/rules/variant-rules/hit-point-dice-xphb.md), and regain a number of [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal to the roll's total plus your spellcasting ability modifier. Those dice are then expended.
