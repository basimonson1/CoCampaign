...
If the target is held shut by [Arcane Lock](z_Resources/CLI/spells/arcane-lock-xphb.md), that spell is suppressed for 10 minutes, during which time the target can be opened and closed.
