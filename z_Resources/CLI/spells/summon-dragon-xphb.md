...
![](z_Resources/CLI/spells/img/summon-dragon.webp#right)
...
You call forth a Dragon spirit. It manifests in an unoccupied space that you can see within range and uses the [Draconic Spirit](z_Resources/CLI/bestiary/dragon/draconic-spirit-xphb.md) stat block. The creature disappears when it drops to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) or when the spell ends.
