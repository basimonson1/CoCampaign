...
Until the spell ends, you control any water inside an area you choose that is a Cube up to 100 feet on a side, using one of the following effects. As a [Magic](z_Resources/CLI/rules/actions.md#Magic) action on your later turns, you can repeat the same effect or choose a different one.
