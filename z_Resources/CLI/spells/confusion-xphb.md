...
| 7-8 | The target doesn't move, and it takes the [Attack](z_Resources/CLI/rules/actions.md#Attack) action to make one melee attack against a random creature within reach. If none are within reach, the target takes no action. |
