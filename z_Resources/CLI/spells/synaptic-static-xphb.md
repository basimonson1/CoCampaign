...
On a failed save, a target also has muddled thoughts for 1 minute. During that time, it subtracts `1d6` from all its attack rolls and ability checks, as well as any Constitution saving throws to maintain [Concentration](z_Resources/CLI/rules/conditions.md#Concentration). The target makes an Intelligence saving throw at the end of each of its turns, ending the effect on itself on a success.
