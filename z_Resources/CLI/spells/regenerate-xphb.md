...
A creature you touch regains `4d8 + 15` [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md). For the duration, the target regains 1 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) at the start of each of its turns, and any severed body parts regrow after 2 minutes.
