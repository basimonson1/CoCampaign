...
You create a 20-foot-radius Sphere of fog centered on a point within range. The Sphere is [Heavily Obscured](z_Resources/CLI/rules/variant-rules/heavily-obscured-xphb.md). It lasts for the duration or until a strong wind (such as one created by [Gust of Wind](z_Resources/CLI/spells/gust-of-wind-xphb.md)) disperses it.
