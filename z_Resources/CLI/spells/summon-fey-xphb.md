...
![](z_Resources/CLI/spells/img/summon-fey.webp#right)
...
You call forth a Fey spirit. It manifests in an unoccupied space that you can see within range and uses the [Fey Spirit](z_Resources/CLI/bestiary/fey/fey-spirit-xphb.md) stat block. When you cast the spell, choose a mood: Fuming, Mirthful, or Tricksy. The creature resembles a Fey creature of your choice marked by the chosen mood, which determines certain details in its stat block. The creature disappears when it drops to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) or when the spell ends.
