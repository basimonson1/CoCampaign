...
Until the spell ends, sleet falls in a 40-foot-tall, 20-foot-radius Cylinder centered on a point you choose within range. The area is [Heavily Obscured](z_Resources/CLI/rules/variant-rules/heavily-obscured-xphb.md), and exposed flames in the area are doused.

Ground in the Cylinder is [Difficult Terrain](z_Resources/CLI/rules/variant-rules/difficult-terrain-xphb.md). When a creature enters the Cylinder for the first time on a turn or starts its turn there, it must succeed on a Dexterity saving throw or have the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition and lose [Concentration](z_Resources/CLI/rules/conditions.md#Concentration).
