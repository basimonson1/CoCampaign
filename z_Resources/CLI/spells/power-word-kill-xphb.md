...
You compel one creature you can see within range to die. If the target has 100 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) or fewer, it dies. Otherwise, it takes `12d12` Psychic damage.
