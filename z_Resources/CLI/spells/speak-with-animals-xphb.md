...
![](z_Resources/CLI/spells/img/speak-with-animals.webp#right)
...
For the duration, you can comprehend and verbally communicate with Beasts, and you can use any of the [Influence](z_Resources/CLI/rules/actions.md#Influence) action's skill options with them.
