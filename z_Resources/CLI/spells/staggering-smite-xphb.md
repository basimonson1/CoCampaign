...
The target takes an extra `4d6` Psychic damage from the attack, and the target must succeed on a Wisdom saving throw or have the [Stunned](z_Resources/CLI/rules/conditions.md#Stunned) condition until the end of your next turn.
