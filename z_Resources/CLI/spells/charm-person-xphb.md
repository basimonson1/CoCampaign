...
One Humanoid you can see within range makes a Wisdom saving throw. It does so with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) if you or your allies are fighting it. On a failed save, the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition until the spell ends or until you or your allies damage it. The [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) creature is Friendly to you. When the spell ends, the target knows it was [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) by you.
