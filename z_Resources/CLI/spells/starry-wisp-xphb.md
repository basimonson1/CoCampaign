...
You launch a mote of light at one creature or object within range. Make a ranged spell attack against the target. On a hit, the target takes `1d8` Radiant damage, and until the end of your next turn, it emits [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md) in a 10-foot radius and can't benefit from the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible) condition.
