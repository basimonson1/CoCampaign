...
The target can take a [Study](z_Resources/CLI/rules/actions.md#Study) action to examine the phantasm with an Intelligence ([Investigation](z_Resources/CLI/rules/skills.md#Investigation)) check against your spell save DC. If the check succeeds, the target realizes that the phantasm is an illusion, and the spell ends.
