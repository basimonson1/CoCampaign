...
Channeling the chill of the grave, make a melee spell attack against a target within reach. On a hit, the target takes `1d10` Necrotic damage, and it can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) until the end of your next turn.
