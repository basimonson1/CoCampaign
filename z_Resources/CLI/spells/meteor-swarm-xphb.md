...
A nonmagical object that isn't being worn or carried also takes the damage if it's in the spell's area, and the object starts [burning](z_Resources/CLI/traps-hazards/burning-xphb.md) if it's flammable.
