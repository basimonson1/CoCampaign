...
- **Grovel.** The target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition and then ends its turn.  
- **Halt.** On its turn, the target doesn't move and takes no action or [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md).  
