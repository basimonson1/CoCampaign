...
In addition, you can take the [Disengage](z_Resources/CLI/rules/actions.md#Disengage) action as a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md) for the spell's duration.
