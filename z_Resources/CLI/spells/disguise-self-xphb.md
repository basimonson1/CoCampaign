...
To discern that you are disguised, a creature must take the [Study](z_Resources/CLI/rules/actions.md#Study) action to inspect your appearance and succeed on an Intelligence ([Investigation](z_Resources/CLI/rules/skills.md#Investigation)) check against your spell save DC.
