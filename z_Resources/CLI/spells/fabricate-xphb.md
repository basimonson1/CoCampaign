...
Creatures and magic items can't be created by this spell. You also can't use it to create items that require a high degree of skill—such as weapons and armor—unless you have proficiency with the type of [Artisan's Tools](z_Resources/CLI/items/artisans-tools-xphb.md) used to craft such objects.
