...
- 1 [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion) level  
- The [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) or [Petrified](z_Resources/CLI/rules/conditions.md#Petrified) condition  
- A curse, including the target's [Attunement](z_Resources/CLI/rules/variant-rules/attunement-xphb.md) to a cursed magic item  
- Any reduction to one of the target's ability scores  
- Any reduction to the target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) maximum  
