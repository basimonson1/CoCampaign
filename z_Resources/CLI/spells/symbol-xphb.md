...
The glyph is nearly imperceptible and requires a successful Wisdom ([Perception](z_Resources/CLI/rules/skills.md#Perception)) check against your spell save DC to notice.
...
Each target makes a Wisdom saving throw. On a failed save, a target argues with other creatures for 1 minute. During this time, it is incapable of meaningful communication and has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks.

## Fear

Each target must succeed on a Wisdom saving throw or have the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) condition for 1 minute. While [Frightened](z_Resources/CLI/rules/conditions.md#Frightened), the target must move at least 30 feet away from the glyph on each of its turns, if able.

## Pain

Each target must succeed on a Constitution saving throw or have the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) condition for 1 minute.

## Sleep

Each target must succeed on a Wisdom saving throw or have the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious) condition for 10 minutes. A creature awakens if it takes damage or if someone takes an action to shake it awake.

## Stunning

Each target must succeed on a Wisdom saving throw or have the [Stunned](z_Resources/CLI/rules/conditions.md#Stunned) condition for 1 minute.
