...
An immobile, [Invisible](z_Resources/CLI/rules/conditions.md#Invisible), Cube-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
This spell can't be dispelled by [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md).
