...
You touch one Large or smaller object that isn't being worn or carried by someone else. Until the spell ends, the object sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md) in a 20-foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 20 feet. The light can be colored as you like.
