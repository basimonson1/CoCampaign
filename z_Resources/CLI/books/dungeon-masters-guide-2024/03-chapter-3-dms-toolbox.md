...
![A Blob of Annihilation att...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/021-02-001-blob-attack.webp#center "A Blob of Annihilation attacks Sharn, the City of Towers, in the world of Eberron")
...
As described in the "Player's Handbook", [alignment](z_Resources/CLI/rules/variant-rules/alignment-xphb.md) is a roleplaying tool. It is a quick way to describe a creature's moral and ethical orientation. Like other elements of the game, it's meant to be a tool to serve you and your game, not a constraint or burden. Alignment can help your game in three ways: as a tool for player characters, as a descriptor of a creature's demeanor, and as a summary of an organization's ethos.
...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile [Attitude]](z_Resources/CLI/rules/variant-rules/hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly [Attitude]](z_Resources/CLI/rules/variant-rules/friendly-attitude-xphb.md) attitude, ready to help those in need.

#### Personality

"Chapter 2" of the "Player's Handbook" offers a [table of brief personality traits](z_Resources/CLI/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md) linked to alignment that can inspire you in playing an NPC or another monster in your game.
...
![An exciting chase nears its conclusion](z_Resources/CLI/books/dungeon-masters-guide-2024/img/022-02-002-party-gives-chase.webp#center)
...
Know the capabilities of the characters in your party before you make a chase an important feature of an adventure. A character with a high Speed or the right spell (such as [Dimension Door](z_Resources/CLI/spells/dimension-door-xphb.md), [Fly](z_Resources/CLI/spells/fly-xphb.md), or [Hold Monster](z_Resources/CLI/spells/hold-monster-xphb.md)) can often end a chase before it begins.

### Beginning a Chase

A chase requires at least one quarry and at least one pursuer. Any participants not already in [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md) order must roll Initiative as the chase begins. As in combat, each participant in the chase can take one action and move on its turn.
...
Participants in the chase are strongly motivated to take the [Dash](z_Resources/CLI/rules/actions.md#Dash) action every round. Pursuers who stop to cast spells and make attacks run the risk of losing their quarry, and a quarry that doesn't take the Dash action is likely to be caught.

#### Dashing

A chase participant can take the [Dash](z_Resources/CLI/rules/actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion) level. A participant drops out of the chase if its Speed is 0.

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range.

Chase participants can't normally make [Opportunity Attacks](z_Resources/CLI/rules/actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time. However, participants can still be the targets of Opportunity Attacks from creatures not participating in the chase. For example, adventurers who chase a thief past a gang of ruffians might provoke Opportunity Attacks from the ruffians.
...
If neither side gives up the chase, the quarry makes a Dexterity ([Stealth](z_Resources/CLI/rules/skills.md#Stealth)) check on Initiative count 0 each round, after every participant in the chase has taken its turn. If the quarry is never out of the lead pursuer's sight, the check fails automatically. Otherwise, compare the check's total to the [Passive Perception](z_Resources/CLI/rules/variant-rules/passive-perception-xphb.md) scores of the pursuers. If the quarry consists of multiple creatures, they all make the check separately, so it's possible for one quarry to escape while others remain in the chase.

The quarry can gain [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) or [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on its check based on the circumstances, as shown in the Escape Factors table.

![Ending a Chase; Escape Factors](z_Resources/CLI/tables/ending-a-chase-escape-factors-xdmg.md)

Other factors might help or hinder the quarry's ability to escape, at your discretion. For example, a quarry with a [Faerie Fire](z_Resources/CLI/spells/faerie-fire-xphb.md) spell cast on it might have Disadvantage on checks made to escape because it's much easier to spot.

If the total of the quarry's check is greater than the highest [Passive Perception](z_Resources/CLI/rules/variant-rules/passive-perception-xphb.md) score of the pursuers, the quarry escapes. If not, the chase continues for another round. Escape doesn't necessarily mean the quarry has outpaced its pursuers. For example, in a city, escape might mean the quarry ducked into a crowd or slipped around a corner, leaving no clue as to where it went.
...
![An ill-advised attempt to ...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/023-02-003-sylgar-theft.webp#center "An ill-advised attempt to steal Xanathar's pet goldfish, Sylgar, leads to a heated chase")
...
Characters can create their own complications to shake off pursuers or slow their quarry (for example, casting the [Web](z_Resources/CLI/spells/web-xphb.md) spell in a narrow alleyway). Adjudicate these at your discretion.

![Urban Chase Complications](z_Resources/CLI/tables/urban-chase-complications-xdmg.md)

![Wilderness Chase Complications](z_Resources/CLI/tables/wilderness-chase-complications-xdmg.md)
...
![You might alter the Sailor...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/024-02-004-seas-of-greyhawk.webp#center "You might alter the Sailor background to reflect a character's youth on the seas of Greyhawk")
...
![Baba Yaga invents a new cr...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/025-02-005-baba-yaga.webp#center "Baba Yaga invents a new creature—a fire-breathing Giant Toad!")
...
You can alter a creature's size and creature type as you please. For example, you can use an [Ogre](z_Resources/CLI/bestiary/giant/ogre-xmm.md) stat block for a human bully—just make it a Medium Humanoid instead of a Large Giant.

#### Ability Scores

You can usually change a creature's Intelligence, Wisdom, and Charisma scores freely unless the ability is used for spellcasting. For example, a [Black Pudding](z_Resources/CLI/bestiary/ooze/black-pudding-xmm.md) stat block could represent a sapient alien if you raise its Intelligence and Charisma to 10 or so. It's usually best to leave its Strength, Dexterity, and Constitution scores alone, as changes to these scores can alter a monster's attack bonus, damage, [Armor Class](z_Resources/CLI/rules/variant-rules/armor-class-xphb.md), or [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md), which in turn can alter its [Challenge Rating](z_Resources/CLI/rules/variant-rules/challenge-rating-xphb.md).

#### Languages

You can change any or all of the languages the creature knows. You might want to add languages if you've made a creature sapient that wasn't before. You can also add or remove [telepathy](z_Resources/CLI/rules/variant-rules/telepathy-xphb.md) or other forms of communication.

#### Proficiencies

You can give a creature any skill proficiencies you want and give it [Expertise](z_Resources/CLI/rules/variant-rules/expertise-xphb.md) if you want it to be very skilled. If you want a creature to be good at hiding, give it Expertise in the [Stealth](z_Resources/CLI/rules/skills.md#Stealth) skill. If its keen senses make it an excellent tracker or otherwise adept at finding hidden foes, give it Expertise in the [Perception](z_Resources/CLI/rules/skills.md#Perception) skill. (You can also increase its Wisdom, as noted above.)

You can also swap a monster's saving throw proficiencies. If it has none, you can add one or two.

#### Senses

[Blindsight](z_Resources/CLI/rules/senses.md#Blindsight), [Darkvision](z_Resources/CLI/rules/senses.md#Darkvision), [Tremorsense](z_Resources/CLI/rules/senses.md#Tremorsense), and [Truesight](z_Resources/CLI/rules/senses.md#Truesight) have no bearing on a creature's Challenge Rating. You can add or remove them freely.
...
You can freely change the name and flavor of an attack, as well as its damage type. For example, you can turn an ordinary [Skeleton](z_Resources/CLI/bestiary/undead/skeleton-xmm.md) into an ice skeleton that deals Cold damage as it accosts characters with a blade of ice or hurls shards of ice at them.

#### Resistances and Immunities

If a creature doesn't have [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) or [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md) to one or more damage types, you can give it Resistance or Immunity to one or two damage types. You can also change the damage type of its existing Resistances and Immunities.
...
You can also use traits from other stat blocks in the "Monster Manual", provided you don't add traits that alter a creature's Hit Points, confer [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md), or change the amount of damage the creature deals to other creatures.

#### Creature Traits

- **Aversion to Fire.** If the creature takes Fire damage, it has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.  
- **Battle Ready.** The creature has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md) rolls.  
- **Beast Whisperer.** The creature can communicate with Beasts as if they shared a common language.  
- **Death Jinx.** When the creature dies, one random creature within 10 feet of the dead creature is targeted by a [Bane](z_Resources/CLI/spells/bane-xphb.md) spell (save DC 13), which lasts for its full duration.  
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile [Attitude]](z_Resources/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Imp](z_Resources/CLI/bestiary/fiend/imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile [Attitude]](z_Resources/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Ochre Jelly](z_Resources/CLI/bestiary/ooze/ochre-jelly-xmm.md) in the same space.  
- **Fey Ancestry.** The creature has Advantage on saving throws it makes to avoid or end the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition, and magic can't put it to sleep.  
- **Forbiddance.** The creature can't enter a residence without an invitation from one of its occupants.  
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
- **Light.** The creature sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet. As a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md), the creature can suppress this light or cause it to return. The light winks out if the creature dies.  
- **Mimicry.** The creature can mimic Beast sounds and Humanoid voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](z_Resources/CLI/rules/skills.md#Insight)) check.  
- **Poison Tolerant.** The creature has Advantage on saving throws it makes to avoid or end the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition.  
...
- **Slaad Host.** When the creature dies, a [Hostile [Attitude]](z_Resources/CLI/rules/variant-rules/hostile-attitude-xphb.md) [Slaad Tadpole](z_Resources/CLI/bestiary/aberration/slaad-tadpole-xmm.md) bursts from its innards in the same space.  
- **Steadfast.** The creature has [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md) to the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) condition while it can see an ally within 30 feet of itself.  
...
- **Warrior's Wrath.** The creature has Advantage on melee attack rolls against any [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md) creature.  
...
One capability can replace a similar one. For example, a [Potion of Climbing](z_Resources/CLI/items/potion-of-climbing-xdmg.md) could become a *Potion of Swimming*.

#### Altered Form

You can alter a magic item's form while leaving its properties intact. For example, you can turn a [Ring of the Ram](z_Resources/CLI/items/ring-of-the-ram-xdmg.md) into a wand or a [Cloak of Protection](z_Resources/CLI/items/cloak-of-protection-xdmg.md) into some other worn object (such as a circlet) without altering the item's properties.

#### Altered Damage Types

An item that deals damage of one type could instead deal damage of another type. For example, a [Flame Tongue](z_Resources/CLI/items/flame-tongue-xdmg.md) sword could deal Lightning damage instead of Fire damage.

#### Combining Items

You can merge the properties of two magic items of the same rarity into a single item, provided no more than one of them requires [Attunement](z_Resources/CLI/rules/variant-rules/attunement-xphb.md). For example, you could combine the properties of a [Helm of Comprehending Languages](z_Resources/CLI/items/helm-of-comprehending-languages-xdmg.md) with those of a [Helm of Telepathy](z_Resources/CLI/items/helm-of-telepathy-xdmg.md) into a single helmet. This makes the item more powerful (and probably increases its rarity), but it won't break your game.
...
A magic item should either let a character do something they couldn't do before or improve the character's ability to do something they can do already. For example, a [Ring of Jumping](z_Resources/CLI/items/ring-of-jumping-xdmg.md) lets its wearer jump greater distances, thus augmenting what a character can already do. A [Ring of the Ram](z_Resources/CLI/items/ring-of-the-ram-xdmg.md), however, gives a character the ability to deal Force damage.
...
![Power Level; Magic Item Power by Rarity](z_Resources/CLI/tables/power-level-magic-item-power-by-rarity-xdmg.md)
...
If the item grants a bonus that other items also grant, it's a good idea to require [Attunement](z_Resources/CLI/rules/variant-rules/attunement-xphb.md) so characters don't try to collect too many of those items.

## Creating a Spell

![Ringlerun's spell research...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/026-02-006-ringlerun-researching.webp#center "Ringlerun's spell research leads in unexpected directions as he unintentionally creates a flying gelatinous cubelet")
...
![Spell Damage](z_Resources/CLI/tables/spell-damage-xdmg.md)
...
![The curse of demonic posse...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/027-02-007-demonic-possession.webp#center "The curse of demonic possession has devastating effects")

Every curse has rules that govern it. A curse typically takes one of the forms detailed below.

#### Bestow Curse

The simplest curses are created by the [Bestow Curse](z_Resources/CLI/spells/bestow-curse-xphb.md) spell. The effects of such curses are limited and can be ended by the [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md) spell.
...
You decide how a spell like [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md) affects a creature with accursed origins. For example, you might decide that a mummy was created through a curse and it can be destroyed permanently only by casting *Remove Curse* on its corpse.
...
A creature affected by such a curse should know why they're being punished and be able to learn how to end their curse, likely by symbolically righting the wrong they committed. How a spell like [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md) affects a curse that's part of your adventure is up to you—the spell might merely suppress the effects of the curse for a time. Regardless, narrative curses should feel like rare, potent magic rooted in the lore of your campaign.
...
A creature that becomes the target of Demonic Possession must succeed on a DC 15 Charisma saving throw or be possessed by a bodiless demonic entity. Whenever the possessed creature rolls a 1 on a [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md), the demonic entity takes control of the creature and determines the creature's behavior thereafter. At the end of each of the possessed creature's later turns, the creature makes a DC 15 Charisma saving throw, regaining control of itself on a success.

After finishing a Long Rest, a creature with Demonic Possession makes a DC 15 Charisma saving throw. On a successful save, the effect ends on the creature. A [Dispel Evil and Good](z_Resources/CLI/spells/dispel-evil-and-good-xphb.md) spell or any magic that removes a curse also ends the effect on it.
...
- [Cackle Fever](z_Resources/CLI/rules/diseases.md#Cackle%20Fever)  
- [Sewer Plague](z_Resources/CLI/rules/diseases.md#Sewer%20Plague)  
- [Sight Rot](z_Resources/CLI/rules/diseases.md#Sight%20Rot)  
...
![Sometimes death—even the d...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/028-02-008-death-passage.webp#center "Sometimes death—even the death of an entire party—is just a passage to new adventures")
...
The character has 1 Hit Point and the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious) condition. The character can regain Hit Points as normal, but the character remains Unconscious until they are targeted by a [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md) spell or experience a sudden awakening (see below).
...
You can also reward a player who describes a memory or something else occupying the dying character's thoughts with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on the Death Save.
...
It's also possible for dead characters to be brought back to life. The most common way is through spells such as [Revivify](z_Resources/CLI/spells/revivify-xphb.md) and [Raise Dead](z_Resources/CLI/spells/raise-dead-xphb.md). It's up to you to decide how easy it is for characters to access those spells if they can't cast them. The "Player's Handbook" offers suggested prices for [spellcasting services](z_Resources/CLI/tables/spellcasting-services-xphb.md).
...
A powerful individual finds the adventurers' bodies and has them raised from the dead, putting the adventurers in the debt of their rescuer. What if the adventurers wake up decades after their death, returned to life by a [Resurrection](z_Resources/CLI/spells/resurrection-xphb.md) spell cast by someone who believed they had an important role to play in this future era?
...
With the [Utilize](z_Resources/CLI/rules/actions.md#Utilize) action, a creature can try to force open a door that is barred or locked, doing so with a successful Strength ([Athletics](z_Resources/CLI/rules/skills.md#Athletics)) check. The table provides the DC of the check. For bigger doors, double or triple the Hit Points and increase the DC of the check by 5.

![Doors](z_Resources/CLI/tables/doors-xdmg.md)

#### Barred Door

A barred door has no lock. A creature on the barred side of the door can take the [Utilize](z_Resources/CLI/rules/actions.md#Utilize) action to lift the bar from its braces, allowing the door to be opened.

#### Locked Door

Characters who don't have the key to a locked door can try to pick the lock using [Thieves' Tools](z_Resources/CLI/items/thieves-tools-xphb.md). The Lock Complexity table tells you how long it takes to try to pick a lock based on its complexity. At the end of that time, the character picks the lock by making a successful Dexterity ([Sleight of Hand](z_Resources/CLI/rules/skills.md#Sleight%20of%20Hand)) check using Thieves' Tools. The DC is determined by the lock's quality, as shown in the Lock Quality table.

![Locked Door; Lock Complexity](z_Resources/CLI/tables/locked-door-lock-complexity-xdmg.md)

![Locked Door; Lock Quality](z_Resources/CLI/tables/locked-door-lock-quality-xdmg.md)
...
With the [Search](z_Resources/CLI/rules/actions.md#Search) action, a character can search for a secret door along a 10-foot-square section of wall and make a Wisdom ([Perception](z_Resources/CLI/rules/skills.md#Perception)) check. On a successful check, the character finds any secret door hidden in that section of wall as well as the mechanism to open the door. The DC of the check depends on how well the secret door is hidden, as shown in the Secret Doors table.

You can instead call for an Intelligence ([Investigation](z_Resources/CLI/rules/skills.md#Investigation)) check if the challenge involves deducing that a door is present from noticeable clues, rather than spotting those clues in the first place. See ""Perception"" in "chapter 2" for more advice.

![Secret Doors](z_Resources/CLI/tables/secret-doors-xdmg.md)
...
Typically made of iron or wood, a portcullis blocks a passage or an archway until it is raised into the ceiling by a winch and chain. Creatures within 5 feet of a lowered portcullis can make ranged attacks or cast spells through it, and they have [Three-Quarters Cover](z_Resources/CLI/tables/cover-xphb.md) against attacks, spells, and other effects originating from the opposite side. A portcullis can also be attacked and destroyed, using the AC and Hit Points of a metal door (if iron) or a wooden door (if wood).

Winching a portcullis up or down requires the Utilize action. If a creature can't reach the winch (usually because it's on the other side of the portcullis), lifting the portcullis requires the [Utilize](z_Resources/CLI/rules/actions.md#Utilize) action and a successful Strength ([Athletics](z_Resources/CLI/rules/skills.md#Athletics)) check. The DC of the check depends on the type of portcullis, as shown in the Portcullises table.

![Portcullises](z_Resources/CLI/tables/portcullises-xdmg.md)
...
![Dungeons; Dungeon Quirks](z_Resources/CLI/tables/dungeons-dungeon-quirks-xdmg.md)

### Mapping a Dungeon

![A dungeon built by giants ...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/029-02-009-giants-dungeon.webp#center "A dungeon built by giants offers enormous adventures")
...
When you design a guard post, decide how many guards are on duty, note their [Passive Perception](z_Resources/CLI/rules/variant-rules/passive-perception-xphb.md) scores, and decide what they do when they notice intruders (see ""Monster Behavior"" in "chapter 4"). Some will rush headlong into a fight, while others will negotiate, sound an alarm, or flee to get help.
...
Sapient creatures often have laboratories, workshops, libraries, forges, and studios. Because such areas tend to contain valuable equipment, their doors are often locked and sometimes even warded by [Glyph of Warding](z_Resources/CLI/spells/glyph-of-warding-xphb.md) spells and similar effects.

### Dungeon Decay

The States of Ruin table can help you determine the general conditions of a dungeon area.

![Dungeon Decay; States of Ruin](z_Resources/CLI/tables/dungeon-decay-states-of-ruin-xdmg.md)

## Environmental Effects

![A friendly bronze dragon k...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/030-02-010-bronze-dragon-v-ship.webp#center "A friendly bronze dragon keeps a watchful eye on a storm-tossed ship")
...
- [Dead Magic Zone](z_Resources/CLI/traps-hazards/dead-magic-zone-xdmg.md)  
- [Deep Water](z_Resources/CLI/traps-hazards/deep-water-xdmg.md)  
- [Extreme Cold](z_Resources/CLI/traps-hazards/extreme-cold-xdmg.md)  
- [Extreme Heat](z_Resources/CLI/traps-hazards/extreme-heat-xdmg.md)  
- [Frigid Water](z_Resources/CLI/traps-hazards/frigid-water-xdmg.md)  
- [Heavy Precipitation](z_Resources/CLI/traps-hazards/heavy-precipitation-xdmg.md)  
- [High Altitude](z_Resources/CLI/traps-hazards/high-altitude-xdmg.md)  
- [Planar Effects](z_Resources/CLI/traps-hazards/planar-effects-xdmg.md)  
- [Slippery Ice](z_Resources/CLI/traps-hazards/slippery-ice-xdmg.md)  
- [Strong Wind](z_Resources/CLI/traps-hazards/strong-wind-xdmg.md)  
- [Thin Ice](z_Resources/CLI/traps-hazards/thin-ice-xdmg.md)  
- [Wild Magic Zone](z_Resources/CLI/traps-hazards/wild-magic-zone-xdmg.md)  
...
Whenever the characters encounter something that is supernaturally frightful, use the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) condition as the baseline effect. Fear effects typically require a Wisdom saving throw, with a save DC set based on how terrifying the situation is. The Sample Fear DCs table provides some examples.

![Fear Effects; Sample Fear DCs](z_Resources/CLI/tables/fear-effects-sample-fear-dcs-xdmg.md)

Typically, a [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) creature repeats the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- The Frightened creature must take the [Dash](z_Resources/CLI/rules/actions.md#Dash) action on each of its turns and uses its movement to get farther away from the source of its fear.  
- Attack rolls against the Frightened creature have [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md).  
...
![Sample Mental Stress Effects](z_Resources/CLI/tables/sample-mental-stress-effects-xdmg.md)
...
The character has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened), [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated), or [Stunned](z_Resources/CLI/rules/conditions.md#Stunned) condition for `1d10` minutes. This condition might be accompanied by alarming behavior or hallucinations. These effects can be suppressed with the [Calm Emotions](z_Resources/CLI/spells/calm-emotions-xphb.md) spell or removed by the [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md) spell.

##### Long-Term Effects

The character has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on some or all ability checks for `1d10 × 10` hours, stemming from an unwillingness or inability to exert a particular set of abilities. The character might feel enervated and unable to exert much Strength, for example, or become so suspicious of others that Charisma checks are more difficult. These effects can be suppressed with the Calm Emotions spell or removed by the Lesser Restoration spell.

##### Indefinite Effects

An indefinite effect is a long-term effect (see above) that lasts until removed by a [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md) spell. It can be suppressed by a Calm Emotions spell.

![Fight, flight, or freeze?](z_Resources/CLI/books/dungeon-masters-guide-2024/img/031-02-011-fight-flight-or-freeze.webp#center)
...
![When faced with a troll, t...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/032-02-012-troll-v-firearms.webp#center "When faced with a troll, there's no time to figure out the right way to hold a shotgun")
...
Firearm Bullets are destroyed upon use in a modern firearm. Futuristic firearms use Energy Cells that become depleted but could possibly be recharged with the proper equipment, at your discretion. An [Energy Cell](z_Resources/CLI/items/energy-cell-xdmg.md) weighs 1/2 lb.

![Firearms](z_Resources/CLI/tables/firearms-xdmg.md)
...
As an action, you can either throw a grenade at a point up to 60 feet away or use a Grenade Launcher to propel the grenade to a point up to 1,000 feet away. The grenade explodes at that point, creating a particular effect in a 20-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md).

#### Fragmentation Grenade

Each creature in the [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) makes a DC 15 Dexterity saving throw, taking 17 (`5d6`) Piercing damage on a failed save or half as much damage on a successful one.

#### Smoke Grenade

The area of the [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) is [Heavily Obscured](z_Resources/CLI/rules/variant-rules/heavily-obscured-xphb.md) by smoke for 1 minute. A strong wind (such as the [Gust of Wind](z_Resources/CLI/spells/gust-of-wind-xphb.md) spell) disperses the smoke.

#### Gunpowder

Setting fire to a container full of Gunpowder causes it to explode. When a container explodes, each creature in a 10-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) centered on the container makes a DC 12 Dexterity saving throw, taking 10 (`3d6`) Fire damage (for a powder horn) or 24 (`7d6`) Fire damage (for a keg) on a failed save or half as much damage on a successful one.

### Alien Technology

When adventurers find a piece of technology that isn't from their world or time period, they can deduce what it is with a successful Intelligence ([Investigation](z_Resources/CLI/rules/skills.md#Investigation)) check, with the DC depending on the complexity of the item: DC 10 for a relatively simple item like a calculator or a lighter, or DC 20 for a complex item such as a computer, a chainsaw, or a hovercraft. You may require a separate Intelligence ([Investigation](z_Resources/CLI/rules/skills.md#Investigation)) check to determine whether a character can activate or operate the technology; a character who has observed the item in use or has operated a similar item either has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on the check or succeeds on the check automatically (your choice).
...
**Titans** are the creations of deities. They might be manufactured on a divine forge, born from the blood spilled by a god, or otherwise brought about through divine will or substance. Some titans, including [krakens](z_Resources/CLI/bestiary/monstrosity/kraken-xmm.md) and the [tarrasque](z_Resources/CLI/bestiary/monstrosity/tarrasque-xmm.md), appear in the "Monster Manual".
...
The "Player's Handbook" describes common hazards that adventurers encounter, such as [falling](z_Resources/CLI/traps-hazards/falling-xphb.md) and [dehydration](z_Resources/CLI/traps-hazards/dehydration-xphb.md). This section details some more unusual hazards you can add to a location to make it more challenging.
...
- [Brown Mold](z_Resources/CLI/traps-hazards/brown-mold-xdmg.md)  
- [Fireball Fungus](z_Resources/CLI/traps-hazards/fireball-fungus-xdmg.md)  
- [Green Slime](z_Resources/CLI/traps-hazards/green-slime-xdmg.md)  
- [Inferno](z_Resources/CLI/traps-hazards/inferno-xdmg.md)  
- [Poisonous Gas](z_Resources/CLI/traps-hazards/poisonous-gas-xdmg.md)  
- [Quicksand Pit](z_Resources/CLI/traps-hazards/quicksand-pit-xdmg.md)  
- [Razorvine](z_Resources/CLI/traps-hazards/razorvine-xdmg.md)  
- [River Styx](z_Resources/CLI/traps-hazards/river-styx-xdmg.md)  
- [Rockslide](z_Resources/CLI/traps-hazards/rockslide-xdmg.md)  
- [Vicious Vine](z_Resources/CLI/traps-hazards/vicious-vine-xdmg.md)  
- [Webs](z_Resources/CLI/traps-hazards/webs-xdmg.md)  
- [Yellow Mold](z_Resources/CLI/traps-hazards/yellow-mold-xdmg.md)  

![](z_Resources/CLI/books/dungeon-masters-guide-2024/img/035-02-015-spiders.webp#center)
...
![Fortifications; Maintenance Costs](z_Resources/CLI/tables/fortifications-maintenance-costs-xdmg.md)
...
![Queen Yolande of Celene is...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/036-02-016-queen-yolande.webp#center "Queen Yolande of Celene is grateful for adventurers' aid")
...
Whenever you would otherwise make a number of [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md) for identical monsters, the Mob Results table can help you determine the number of successful [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md) the monsters get without having to roll dice. Follow these steps:

- **Step 1.** Determine the minimum `d20` roll the monsters need to succeed on the [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md) using the following formula:  

**Roll needed** = target number−monster's bonus

- **Step 2.** Find the roll needed on the Mob Results table. If all the monsters have [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on the roll (for example, if they're attacking and have the Pack Tactics trait, or if they're making a saving throw against a spell and have the Magic Resistance trait), find the roll needed in the With Advantage column. If all the monsters have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) (for example, if they're attacking a creature protected by the [Blur](z_Resources/CLI/spells/blur-xphb.md) spell), use the With Disadvantage column. Otherwise, use the Normal column.  
- **Step 3.** Read across the table to find a fractional number of successes you can easily apply to the group of monsters. That's the fraction of monsters that succeed on the [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md).  

![Average Results; Mob Results](z_Resources/CLI/tables/average-results-mob-results-xdmg.md)

### Adjudicating Areas of Effect

When the characters are fighting a large number of monsters, it's not always practical to use miniatures on a battle grid or some other visual aid. So how do you determine how many monsters are affected by the Wizard's [Fireball](z_Resources/CLI/spells/fireball-xphb.md) spell or some other area of effect?
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](z_Resources/CLI/spells/shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md) includes only three creatures.

![Adjudicating Areas of Effect; Targets in Area of Effect](z_Resources/CLI/tables/adjudicating-areas-of-effect-targets-in-area-of-effect-xdmg.md)
...
Eight [Zombies](z_Resources/CLI/bestiary/undead/zombie-xmm.md) surround and attack a Fighter. The zombies' attack bonus is +3, and the Fighter's AC is 18, so the roll needed is 15 (18−3). Finding 15 in the "Normal" column and reading across to the "Out of 8" column, the DM gets a result of 2/8—two of the zombies hit. Using the zombies' average damage (4 Bludgeoning damage), the Fighter takes 8 Bludgeoning damage.

After seeing the Fighter mauled by zombies, the Bard casts [Shatter](z_Resources/CLI/spells/shatter-xphb.md), centering the spell on the Fighter. (The Bard trusts that the Fighter will succeed on the Constitution saving throw and survive the resulting damage.) The spell affects a 10-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md), and the Targets in Area of Effect table suggests that such an area should encompass three zombies. However, the DM decides that all eight zombies (and the Fighter) are affected. The zombies' Constitution saving throw bonus is +3, and the Bard's spell saving throw DC is 16, so the roll needed is 13 (16−3). Finding 13 in the "Normal" column and reading across to the "Out of 8" column, the DM gets a result of 3/8, so three of the zombies succeed on their saving throws.

Seeing a larger crowd of zombies in the distance, the Wizard casts [Fireball](z_Resources/CLI/spells/fireball-xphb.md). The spell covers a 20-foot-radius Sphere. The Targets in Area of Effect table suggests that area covers ten zombies, but the DM rules that they're densely packed together and adds `1d3`, rolling a 2. So the spell engulfs twelve zombies in its area. The zombies' Dexterity saving throw modifier is −2, and the Wizard's spell save DC is 16, so the roll needed is 18 (16−[−2]). Finding 18 in the Normal column and reading across to the Out of 6 column, the DM gets a result of 1/6. Twelve times 1/6 is 2, so two of the twelve zombies succeed on the save.
...
![Nonplayer Characters come in all shapes and sizes](z_Resources/CLI/books/dungeon-masters-guide-2024/img/037-02-017-nonplayer-characters.webp#center)
...
![1: Common Names](z_Resources/CLI/tables/1-common-names-xdmg.md)

![2: Guttural Names](z_Resources/CLI/tables/2-guttural-names-xdmg.md)

![3: Lyrical Names](z_Resources/CLI/tables/3-lyrical-names-xdmg.md)

![4: Monosyllabic Names](z_Resources/CLI/tables/4-monosyllabic-names-xdmg.md)

![5: Sinister Names](z_Resources/CLI/tables/5-sinister-names-xdmg.md)

![6: Whimsical Names](z_Resources/CLI/tables/6-whimsical-names-xdmg.md)

#### Stat Block

![](z_Resources/CLI/books/dungeon-masters-guide-2024/img/038-02-018-lone-npc.webp#center)
...
Choose the NPC's [alignment](z_Resources/CLI/rules/variant-rules/alignment-xphb.md), which can help you sketch the outlines of an NPC's behavior and personality. See the "Player's Handbook" and ""Alignment"" in this chapter for more information.
...
For example, if you find the adventurers unexpectedly arguing with a Lawful Neutral guard, you might create a cooperative but laconic guard who is happy to help the adventurers but speaks curtly, hoping to end the conversation as quickly as possible. Or, looking at the [Imp](z_Resources/CLI/bestiary/fiend/imp-xmm.md) stat block in the "Player's Handbook" and noting its highest ability (Dexterity) and its lowest (Strength), you might decide that the little devil is fidgety and indirect, constantly on the move and talking in circles to get to its point
...
![NPC Appearance](z_Resources/CLI/tables/npc-appearance-xdmg.md)

#### Secret

Describe a secret the NPC is trying to hide or protect. The NPC Secrets table provides several ideas.

![NPC Secrets](z_Resources/CLI/tables/npc-secrets-xdmg.md)

![Download PDF](z_Resources/CLI/books/dungeon-masters-guide-2024/img/039-02-019-npc-tracker-sheet.webp#center)
...
- **Milquetoast Healer.** Absent a healer of their own, the characters might love an NPC healer whose personality matters less than the healer's devotion to the party and ability to cast [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md) or [Revivify](z_Resources/CLI/spells/revivify-xphb.md) when needed.  
...
![As a member of another gro...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/040-02-020-npc-healer.webp#center "As a member of another group of heroes, Niko first joined Sheila, Diana, Eric, and Presto as an NPC healer")
...
If the characters own or operate a sailing ship or similar vessel, you can use these rules to track the loyalty of individual crew members or the ship's crew as a whole. If at least half the crew's Loyalty Scores drop to 0 during a voyage, the crew turns [Hostile [Attitude]](z_Resources/CLI/rules/variant-rules/hostile-attitude-xphb.md) and stages a mutiny. If the ship is berthed, disloyal crew members leave the ship and never return.

## Poison

Given their insidious and deadly nature, poisons are a favorite tool among assassins and evil creatures.

![Zarak applies poison to his dagger](z_Resources/CLI/books/dungeon-masters-guide-2024/img/041-02-021-zarak-poison-dagger.webp#center)

Poisons come in the following four types:

- **Contact.** Contact poison can be smeared on an object and remains potent until it is touched or washed off. A creature that touches contact poison with exposed skin suffers its effects.  
- **Ingested.** A creature must swallow an entire dose of ingested poison to suffer its effects. The dose can be delivered in food or a liquid. You may decide that a partial dose has a reduced effect, such as allowing [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on the saving throw or dealing only half as much damage on a failed save.  
- **Inhaled.** Poisonous powders and gases take effect when inhaled. Blowing the powder or releasing the gas subjects creatures in a 5-foot [Cube [Area of Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) to its effect. The resulting cloud dissipates immediately afterward. Holding one's breath is ineffective against inhaled poisons, as they affect nasal membranes, tear ducts, and other parts of the body.  
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) condition. The effort takes `1d6` minutes, after which the character makes a DC 20 Intelligence ([Nature](z_Resources/CLI/rules/skills.md#Nature)) check using a [Poisoner's Kit](z_Resources/CLI/items/poisoners-kit-xphb.md). On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.
...
- [Assassin's Blood](z_Resources/CLI/items/assassins-blood-xdmg.md)  
- [Burnt Othur Fumes](z_Resources/CLI/items/burnt-othur-fumes-xdmg.md)  
- [Carrion Crawler Mucus](z_Resources/CLI/items/carrion-crawler-mucus-xdmg.md)  
- [Essence of Ether](z_Resources/CLI/items/essence-of-ether-xdmg.md)  
- [Lolth's Sting](z_Resources/CLI/items/lolths-sting-xdmg.md)  
- [Malice](z_Resources/CLI/items/malice-xdmg.md)  
- [Midnight Tears](z_Resources/CLI/items/midnight-tears-xdmg.md)  
- [Oil of Taggit](z_Resources/CLI/items/oil-of-taggit-xdmg.md)  
- [Pale Tincture](z_Resources/CLI/items/pale-tincture-xdmg.md)  
- [Purple Worm Poison](z_Resources/CLI/items/purple-worm-poison-xdmg.md)  
- [Serpent Venom](z_Resources/CLI/items/serpent-venom-xdmg.md)  
- [Torpor](z_Resources/CLI/items/torpor-xdmg.md)  
- [Truth Serum](z_Resources/CLI/items/truth-serum-xdmg.md)  
- [Wyvern Poison](z_Resources/CLI/items/wyvern-poison-xdmg.md)  
...
![Level-Based Renown](z_Resources/CLI/tables/level-based-renown-xdmg.md)

## Settlements

![Life in a city is full of fantastical surprises!](z_Resources/CLI/books/dungeon-masters-guide-2024/img/042-02-022-city-life.webp#center)
...
![Settlement Tables and Tracker; Defining Traits](z_Resources/CLI/tables/settlement-tables-and-tracker-defining-traits-xdmg.md)

![Settlement Tables and Tracker; Claims to Fame](z_Resources/CLI/tables/settlement-tables-and-tracker-claims-to-fame-xdmg.md)

![Settlement Tables and Tracker; Current Calamities](z_Resources/CLI/tables/settlement-tables-and-tracker-current-calamities-xdmg.md)

![Settlement Tables and Tracker; Local Leaders](z_Resources/CLI/tables/settlement-tables-and-tracker-local-leaders-xdmg.md)

![Settlement Tables and Tracker; Tavern Names](z_Resources/CLI/tables/settlement-tables-and-tracker-tavern-names-xdmg.md)

![Settlement Tables and Tracker; Random Shops](z_Resources/CLI/tables/settlement-tables-and-tracker-random-shops-xdmg.md)

![](z_Resources/CLI/books/dungeon-masters-guide-2024/img/043-02-023-flagon-with-coins.webp#center)

![Download PDF](z_Resources/CLI/books/dungeon-masters-guide-2024/img/044-02-024-settlement-tracker-sheet.webp#center)
...
- [Ballista](z_Resources/CLI/objects/ballista-xdmg.md)  
- [Cannon](z_Resources/CLI/objects/cannon-xdmg.md)  
- [Flamethrower Coach](z_Resources/CLI/objects/flamethrower-coach-xdmg.md)  
- [Lightning Cannon](z_Resources/CLI/objects/lightning-cannon-xdmg.md)  
- [Mangonel](z_Resources/CLI/objects/mangonel-xdmg.md)  
- [Ram](z_Resources/CLI/objects/ram-xdmg.md)  
- [Siege Tower](z_Resources/CLI/objects/siege-tower-xdmg.md)  
- [Suspended Cauldron](z_Resources/CLI/objects/suspended-cauldron-xdmg.md)  
- [Trebuchet](z_Resources/CLI/objects/trebuchet-xdmg.md)  

## Supernatural Gifts

![A magical creature like a ...](z_Resources/CLI/books/dungeon-masters-guide-2024/img/047-02-027-unicorn.webp#center "A magical creature like a unicorn might bestow a supernatural gift")
...
- [Blessing of Health](z_Resources/CLI/rewards/blessing-of-health-xdmg.md)  
- [Blessing of Magic Resistance](z_Resources/CLI/rewards/blessing-of-magic-resistance-xdmg.md)  
- [Blessing of Protection](z_Resources/CLI/rewards/blessing-of-protection-xdmg.md)  
- [Blessing of Understanding](z_Resources/CLI/rewards/blessing-of-understanding-xdmg.md)  
- [Blessing of Valhalla](z_Resources/CLI/rewards/blessing-of-valhalla-xdmg.md)  
- [Blessing of Weapon Enhancement](z_Resources/CLI/rewards/blessing-of-weapon-enhancement-xdmg.md)  
- [Blessing of Wound Closure](z_Resources/CLI/rewards/blessing-of-wound-closure-xdmg.md)  
...
A Charm can't be removed from a creature by anything short of divine intervention or a [Wish](z_Resources/CLI/spells/wish-xphb.md) spell. A character can't benefit from multiple instances of a Charm at the same time.

A typical Charm mimics the effects of a Potion or spell, so it is easy to create more Charms of your own.

- [Charm of Animal Conjuring](z_Resources/CLI/rewards/charm-of-animal-conjuring-xdmg.md)  
- [Charm of Darkvision](z_Resources/CLI/rewards/charm-of-darkvision-xdmg.md)  
- [Charm of Feather Falling](z_Resources/CLI/rewards/charm-of-feather-falling-xdmg.md)  
- [Charm of Heroism](z_Resources/CLI/rewards/charm-of-heroism-xdmg.md)  
- [Charm of Restoration](z_Resources/CLI/rewards/charm-of-restoration-xdmg.md)  
- [Charm of the Slayer](z_Resources/CLI/rewards/charm-of-the-slayer-xdmg.md)  
- [Charm of Vitality](z_Resources/CLI/rewards/charm-of-vitality-xdmg.md)  
...
- [Collapsing Roof](z_Resources/CLI/traps-hazards/collapsing-roof-xdmg.md)  
- [Falling Net](z_Resources/CLI/traps-hazards/falling-net-xdmg.md)  
- [Fire-Casting Statue](z_Resources/CLI/traps-hazards/fire-casting-statue-xdmg.md)  
- [Hidden Pit](z_Resources/CLI/traps-hazards/hidden-pit-xdmg.md)  
- [Poisoned Darts](z_Resources/CLI/traps-hazards/poisoned-darts-xdmg.md)  
- [Poisoned Needle](z_Resources/CLI/traps-hazards/poisoned-needle-xdmg.md)  
- [Rolling Stone](z_Resources/CLI/traps-hazards/rolling-stone-xdmg.md)  
- [Spiked Pit](z_Resources/CLI/traps-hazards/spiked-pit-xdmg.md)  
...
![Building Your Own Traps; Building a Trap](z_Resources/CLI/tables/building-your-own-traps-building-a-trap-xdmg.md)