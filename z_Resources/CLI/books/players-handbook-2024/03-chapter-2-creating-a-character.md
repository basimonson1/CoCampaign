...
![World-traveling explorers ...](z_Resources/CLI/books/players-handbook-2024/img/012-02-001-world-traveling-explorers.webp#center "World-traveling explorers Hank, Bobby, Sheila, Diana, and Presto stand on the threshold of their next adventure")
...
![Choose a Class; Class Overview](z_Resources/CLI/tables/choose-a-class-class-overview-xphb.md)

> [!note] A Balanced Party
> 
> The classic D&D party comprises a [Cleric](z_Resources/CLI/classes/cleric-xphb.md), [Fighter](z_Resources/CLI/classes/fighter-xphb.md), [Rogue](z_Resources/CLI/classes/rogue-xphb.md), and [Wizard](z_Resources/CLI/classes/wizard-xphb.md). Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
> 
> - **Cleric.** Replace with [Bard](z_Resources/CLI/classes/bard-xphb.md) or [Druid](z_Resources/CLI/classes/druid-xphb.md)  
> - **Fighter.** Replace with [Barbarian](z_Resources/CLI/classes/barbarian-xphb.md), [Monk](z_Resources/CLI/classes/monk-xphb.md), [Paladin](z_Resources/CLI/classes/paladin-xphb.md), or [Ranger](z_Resources/CLI/classes/ranger-xphb.md)  
> - **Rogue.** Replace with [Bard](z_Resources/CLI/classes/bard-xphb.md) or [Ranger](z_Resources/CLI/classes/ranger-xphb.md)  
> - **Wizard.** Replace with [Bard](z_Resources/CLI/classes/bard-xphb.md), [Sorcerer](z_Resources/CLI/classes/sorcerer-xphb.md), or [Warlock](z_Resources/CLI/classes/warlock-xphb.md)  
^a-balanced-party

#### Write Your Level

Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [Experience Points](z_Resources/CLI/rules/variant-rules/experience-points-xphb.md) (XP).
...
![Choose a Background; Ability Scores and Backgrounds](z_Resources/CLI/tables/choose-a-background-ability-scores-and-backgrounds-xphb.md)
...
Your background and class both provide starting equipment. Any coins that you gain at this step can be immediately spent on equipment from "chapter 6". In addition, you can have one [trinket](z_Resources/CLI/items/trinket-xphb.md) at no cost at the end of this chapter.
...
![Consider how your choices ...](z_Resources/CLI/books/players-handbook-2024/img/013-02-002-character-choices.webp#center "Consider how your choices combine to set your character on the path to adventure")

#### Choose a Species

Choose a species for your character. The following species options are detailed in "chapter 4": [Aasimar](z_Resources/CLI/races/aasimar-xphb.md), [Dragonborn](z_Resources/CLI/races/dragonborn-xphb.md), [Dwarf](z_Resources/CLI/races/dwarf-xphb.md), [Elf](z_Resources/CLI/races/elf-xphb.md), [Gnome](z_Resources/CLI/races/gnome-xphb.md), [Goliath](z_Resources/CLI/races/goliath-xphb.md), [Halfling](z_Resources/CLI/races/halfling-xphb.md), [Human](z_Resources/CLI/races/human-xphb.md), [Orc](z_Resources/CLI/races/orc-xphb.md), and [Tiefling](z_Resources/CLI/races/tiefling-xphb.md). Once you've chosen a species, write it on your character sheet. Then record your species' traits.

Your character's [size](z_Resources/CLI/rules/variant-rules/size-xphb.md) and [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) are determined by the character's species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
![Choose Languages; Standard Languages](z_Resources/CLI/tables/choose-languages-standard-languages-xphb.md)
...
![Choose Languages; Rare Languages](z_Resources/CLI/tables/choose-languages-rare-languages-xphb.md)
...
![Ability Score Point Costs](z_Resources/CLI/tables/ability-score-point-costs-xphb.md)
...
![Assign Ability Scores; Standard Array by Class](z_Resources/CLI/tables/assign-ability-scores-standard-array-by-class-xphb.md)
...
![Determine Ability Modifiers; Ability Scores and Modifiers](z_Resources/CLI/tables/determine-ability-modifiers-ability-scores-and-modifiers-xphb.md)
...
![](z_Resources/CLI/books/players-handbook-2024/img/014-02-003-strength-icon.webp#center)

![Describe Appearance and Personality; Strength](z_Resources/CLI/tables/describe-appearance-and-personality-strength-xphb.md)

![](z_Resources/CLI/books/players-handbook-2024/img/015-02-004-dexterity-icon.webp#center)

![Describe Appearance and Personality; Dexterity](z_Resources/CLI/tables/describe-appearance-and-personality-dexterity-xphb.md)

![](z_Resources/CLI/books/players-handbook-2024/img/016-02-005-constitution-icon.webp#center)

![Describe Appearance and Personality; Constitution](z_Resources/CLI/tables/describe-appearance-and-personality-constitution-xphb.md)

![](z_Resources/CLI/books/players-handbook-2024/img/017-02-006-intelligence-icon.webp#center)

![Describe Appearance and Personality; Intelligence](z_Resources/CLI/tables/describe-appearance-and-personality-intelligence-xphb.md)

![](z_Resources/CLI/books/players-handbook-2024/img/018-02-007-wisdom-icon.webp#center)

![Describe Appearance and Personality; Wisdom](z_Resources/CLI/tables/describe-appearance-and-personality-wisdom-xphb.md)

![](z_Resources/CLI/books/players-handbook-2024/img/019-02-008-charisma-icon.webp#center)

![Describe Appearance and Personality; Charisma](z_Resources/CLI/tables/describe-appearance-and-personality-charisma-xphb.md)
...
![Alignments might be visual...](z_Resources/CLI/books/players-handbook-2024/img/020-02-009-alignments.webp#center "Alignments might be visualized as a grid like this—along with creatures that embody those alignments")
...
> 
> Most creatures that lack the capacity for rational thought don't have alignments; they are unaligned. [Sharks](z_Resources/CLI/bestiary/beast/reef-shark-xmm.md) are savage predators, for example, but they aren't evil; they are unaligned.
^unaligned-creatures
...
![Alignment and Personality; Personality Traits by Alignment](z_Resources/CLI/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md)
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([Perception](z_Resources/CLI/rules/skills.md#Perception)) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([Perception](z_Resources/CLI/rules/skills.md#Perception)) checks. For example, if your character has a Wisdom of 15 and proficiency in the [Perception](z_Resources/CLI/rules/skills.md#Perception) skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
Without armor or a shield, your base [Armor Class](z_Resources/CLI/rules/variant-rules/armor-class-xphb.md) is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in "chapter 6". A class feature might give you a different way to calculate your AC.
...
![Adventuring equipment impr...](z_Resources/CLI/books/players-handbook-2024/img/021-02-010-adventuring-equipment.webp#center "Adventuring equipment improves as a character progresses through the tiers of play")

While going on adventures, your character gains experience, represented by [Experience Points](z_Resources/CLI/rules/variant-rules/experience-points-xphb.md) (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
![Level Advancement; Character Advancement](z_Resources/CLI/tables/level-advancement-character-advancement-xphb.md)
...
- **Adjust Hit Points and Hit Point Dice.** Each time you gain a level, you gain an additional Hit Die. Roll that die, add your Constitution modifier to the roll, and add the total (minimum of 1) to your Hit Point maximum. Instead of rolling, you can use the fixed value shown in the Fixed Hit Points by Class table.  
    ...
    ![Adjust Hit Points and Hit Point Dice; Fixed Hit Points by Class](z_Resources/CLI/tables/adjust-hit-points-and-hit-point-dice-fixed-hit-points-by-class-xphb.md)  
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [Fireball](z_Resources/CLI/spells/fireball-xphb.md), [Lightning Bolt](z_Resources/CLI/spells/lightning-bolt-xphb.md), and [Raise Dead](z_Resources/CLI/spells/raise-dead-xphb.md). Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
![Starting Equipment at Higher Levels](z_Resources/CLI/tables/starting-equipment-at-higher-levels-xphb.md)
...
If you have multiple ways to calculate your [Armor Class](z_Resources/CLI/rules/variant-rules/armor-class-xphb.md), you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
![Spellcasting; Multiclass Spellcaster: Spell Slots per Spell Level](z_Resources/CLI/tables/spellcasting-multiclass-spellcaster-spell-slots-per-spell-level-xphb.md)
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [Burning Hands](z_Resources/CLI/spells/burning-hands-xphb.md), has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
![A character with Paladin a...](z_Resources/CLI/books/players-handbook-2024/img/022-02-011-paladin-warlock-multiclass.webp#center "A character with Paladin and Warlock levels might call on both a mighty oath and an otherworldly patron")

## Trinkets

When you make your character, you can roll once on the [Trinkets](z_Resources/CLI/items/trinket-xphb.md) table to gain a Tiny trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.