...
|--------------|-----------------|
| 3rd | [Aid](z_Resources/CLI/spells/aid-xphb.md), [Bless](z_Resources/CLI/spells/bless-xphb.md), [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md), [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md) |
| 5th | [Mass Healing Word](z_Resources/CLI/spells/mass-healing-word-xphb.md), [Revivify](z_Resources/CLI/spells/revivify-xphb.md) |
| 7th | [Aura of Life](z_Resources/CLI/spells/aura-of-life-xphb.md), [Death Ward](z_Resources/CLI/spells/death-ward-xphb.md) |
| 9th | [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md), [Mass Cure Wounds](z_Resources/CLI/spells/mass-cure-wounds-xphb.md) |
^life-domain-spells

### Disciple of Life (Level 3)

When a spell you cast with a spell slot restores [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) to a creature, that creature regains additional [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) on the turn you cast the spell. The additional [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal 2 plus the spell slot's level.

### Preserve Life (Level 3)

As a [Magic](z_Resources/CLI/rules/actions.md#Magic) action, you present your [Holy Symbol](z_Resources/CLI/items/holy-symbol-xphb.md) and expend a use of your Channel Divinity to evoke healing energy that can restore a number of [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal to five times your Cleric level. Choose [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md) creatures within 30 feet of yourself (which can include you), and divide those [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) among them. This feature can restore a creature to no more than half its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) maximum.

### Blessed Healer (Level 6)

The healing spells you cast on others heal you as well. Immediately after you cast a spell with a spell slot that restores [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) to one creature other than you, you regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal to 2 plus the spell slot's level.

### Supreme Healing (Level 17)

When you would normally roll one or more dice to restore [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) to a creature with a spell or Channel Divinity, don't roll those dice for the healing; instead use the highest number possible for each die. For example, instead of restoring `2d6` [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) to a creature with a spell, you restore 12.