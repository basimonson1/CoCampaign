...
At the start of your first turn of each combat, your [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) increases by 10 feet until the end of that turn.
...
When you roll [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md), you can add your Wisdom modifier to the roll.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md) |
| 5th | [Rope Trick](z_Resources/CLI/spells/rope-trick-xphb.md) |
| 9th | [Fear](z_Resources/CLI/spells/fear-xphb.md) |
| 13th | [Greater Invisibility](z_Resources/CLI/spells/greater-invisibility-xphb.md) |
| 17th | [Seeming](z_Resources/CLI/spells/seeming-xphb.md) |
^gloom-stalker-spells

### Umbral Sight (Level 3)

You gain [Darkvision](z_Resources/CLI/rules/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](z_Resources/CLI/rules/senses.md#Darkvision) when you gain this feature, its range increases by 60 feet.

You are also adept at evading creatures that rely on [Darkvision](z_Resources/CLI/rules/senses.md#Darkvision). While entirely in [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md), you have the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible) condition to any creature that relies on [Darkvision](z_Resources/CLI/rules/senses.md#Darkvision) to see you in that [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md).
...
The target and each creature within 10 feet of it must make a Wisdom saving throw against your spell save DC. On a failed save, a creature has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) condition until the start of your next turn.

### Shadowy Dodge (Level 15)

When a creature makes an attack roll against you, you can take a [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md) to impose [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on that roll. Whether the attack hits or misses, you can then teleport up to 30 feet to an unoccupied space you can see.