...
- **Skill Proficiencies**: *Choose 3:* [Animal Handling](z_Resources/CLI/rules/skills.md#Animal%20Handling), [Athletics](z_Resources/CLI/rules/skills.md#Athletics), [Insight](z_Resources/CLI/rules/skills.md#Insight), [Investigation](z_Resources/CLI/rules/skills.md#Investigation), [Nature](z_Resources/CLI/rules/skills.md#Nature), [Perception](z_Resources/CLI/rules/skills.md#Perception), [Stealth](z_Resources/CLI/rules/skills.md#Stealth), or [Survival](z_Resources/CLI/rules/skills.md#Survival)
...
**Starting Equipment:** *Choose A or B:* (A) [Studded Leather Armor](z_Resources/CLI/items/studded-leather-armor-xphb.md), [Scimitar](z_Resources/CLI/items/scimitar-xphb.md), [Shortsword](z_Resources/CLI/items/shortsword-xphb.md), [Longbow](z_Resources/CLI/items/longbow-xphb.md), [20 Arrows](z_Resources/CLI/items/arrows-20-xphb.md), [Quiver](z_Resources/CLI/items/quiver-xphb.md), [Druidic Focus](z_Resources/CLI/items/druidic-focus-xphb.md) ([sprig of mistletoe](z_Resources/CLI/items/sprig-of-mistletoe-xphb.md)), [Explorer's Pack](z_Resources/CLI/items/explorers-pack-xphb.md), and 7 GP; or (B) 150 GP

## Multiclassing Ranger

- **Skill Proficiencies**: *Choose 1:* [Animal Handling](z_Resources/CLI/rules/skills.md#Animal%20Handling), [Athletics](z_Resources/CLI/rules/skills.md#Athletics), [Insight](z_Resources/CLI/rules/skills.md#Insight), [Investigation](z_Resources/CLI/rules/skills.md#Investigation), [Nature](z_Resources/CLI/rules/skills.md#Nature), [Perception](z_Resources/CLI/rules/skills.md#Perception), [Stealth](z_Resources/CLI/rules/skills.md#Stealth), or [Survival](z_Resources/CLI/rules/skills.md#Survival)
...
The Ranger Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Ranger spells. [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md) and [Ensnaring Strike](z_Resources/CLI/spells/ensnaring-strike-xphb.md) are recommended.
...
Whenever you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), you can replace one spell on your list with another Ranger spell for which you have spell slots.
...
You can use a [Druidic Focus](z_Resources/CLI/items/druidic-focus-xphb.md) as a [Spellcasting Focus](z_Resources/CLI/rules/variant-rules/spellcasting-focus-xphb.md) for your Ranger spells.

### Favored Enemy (Level 1)

You always have the [Hunter's Mark](z_Resources/CLI/spells/hunters-mark-xphb.md) spell prepared. You can cast it twice without expending a spell slot, and you regain all expended uses of this ability when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).

The number of times you can cast the spell without a spell slot increases when you reach certain Ranger levels, as shown in the Favored [Enemy](z_Resources/CLI/rules/variant-rules/enemy-xphb.md) column of the Ranger Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [weapon mastery properties](z_Resources/CLI/rules/variant-rules/weapon-mastery-properties-xphb.md) of two kinds of weapons of your choice with which you have proficiency, such as [Longbows](z_Resources/CLI/items/longbow-xphb.md) and [Shortswords](z_Resources/CLI/items/shortsword-xphb.md).

Whenever you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), you can change the kinds of weapons you chose. For example, you could switch to using the [weapon mastery properties](z_Resources/CLI/rules/variant-rules/weapon-mastery-properties-xphb.md) of [Scimitars](z_Resources/CLI/items/scimitar-xphb.md) and [Longswords](z_Resources/CLI/items/longsword-xphb.md).
...
Choose one of your skill proficiencies with which you lack [Expertise](z_Resources/CLI/rules/variant-rules/expertise-xphb.md). You gain [Expertise](z_Resources/CLI/rules/variant-rules/expertise-xphb.md) in that skill.
...
You gain the [Ability Score Improvement](z_Resources/CLI/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Ranger levels 8, 12, and 16.
...
Your [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) increases by 10 feet while you aren't wearing Heavy armor. You also have a [Climb Speed](z_Resources/CLI/rules/variant-rules/climb-speed-xphb.md) and a [Swim Speed](z_Resources/CLI/rules/variant-rules/swim-speed-xphb.md) equal to your [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md).
...
Choose two of your skill proficiencies with which you lack [Expertise](z_Resources/CLI/rules/variant-rules/expertise-xphb.md). You gain [Expertise](z_Resources/CLI/rules/variant-rules/expertise-xphb.md) in those skills.
...
As a [Magic](z_Resources/CLI/rules/actions.md#Magic) action, you can give yourself a number of [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md) equal to `1d8` plus your Wisdom modifier (minimum of 1). You can use this action a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).

#### Decrease Exhaustion

Whenever you finish a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md), your [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion) level, if any, decreases by 1.
...
Taking damage can't break your [Concentration](z_Resources/CLI/rules/conditions.md#Concentration) on Hunter's Mark.

### Nature's Veil (Level 14)

You invoke spirits of nature to magically hide yourself. As a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md), you can give yourself the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible) condition until the end of your next turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).
...
You have [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on attack rolls against the creature currently marked by your Hunter's Mark.

### Feral Senses (Level 18)

Your connection to the forces of nature grants you [Blindsight](z_Resources/CLI/rules/senses.md#Blindsight) with a range of 30 feet.
