...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), you take `2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) and [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md).

Each time you use this feature again before finishing a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), the Necrotic damage per spell level increases by `1d12`.