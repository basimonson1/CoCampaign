...
You gain one of the following feature options of your choice. Whenever you finish a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md) or [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), you can replace the chosen option with the other one.

#### Colossus Slayer

Your tenacity can wear down even the most resilient foes. When you hit a creature with a weapon, the weapon deals an extra `1d8` damage to the target if it's missing any of its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md). You can deal this extra damage only once per turn.
...
[Opportunity Attacks](z_Resources/CLI/rules/actions.md#Opportunity%20Attack) have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) against you.

#### Multiattack Defense

When a creature hits you with an attack roll, that creature has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on all other attack rolls against you this turn.
...
When you take damage, you can take a [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md) to give yourself [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) to that damage and any other damage of the same type until the end of the current turn.