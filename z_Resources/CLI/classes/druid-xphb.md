...
- **Skill Proficiencies**: *Choose 2:* [Animal Handling](z_Resources/CLI/rules/skills.md#Animal%20Handling), [Arcana](z_Resources/CLI/rules/skills.md#Arcana), [Insight](z_Resources/CLI/rules/skills.md#Insight), [Medicine](z_Resources/CLI/rules/skills.md#Medicine), [Nature](z_Resources/CLI/rules/skills.md#Nature), [Perception](z_Resources/CLI/rules/skills.md#Perception), [Religion](z_Resources/CLI/rules/skills.md#Religion), or [Survival](z_Resources/CLI/rules/skills.md#Survival)
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: [Herbalism Kit](z_Resources/CLI/items/herbalism-kit-xphb.md)
- **Armor Training**: [Light armor](z_Resources/CLI/rules/item-types.md#Light%20Armor) and [Shields](z_Resources/CLI/items/shield-xphb.md)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](z_Resources/CLI/items/leather-armor-xphb.md), [Shield](z_Resources/CLI/items/shield-xphb.md), [Sickle](z_Resources/CLI/items/sickle-xphb.md), [Druidic Focus (Quarterstaff)](z_Resources/CLI/items/druidic-focus-xphb.md), [Explorer's Pack](z_Resources/CLI/items/explorers-pack-xphb.md), [Herbalism kit](z_Resources/CLI/items/herbalism-kit-xphb.md), 9 GP; or (B) 50 GP

## Multiclassing Druid

- **Armor Training**: [Light armor](z_Resources/CLI/rules/item-types.md#Light%20Armor), [Shields](z_Resources/CLI/items/shield-xphb.md)
...
You know Druidic, the secret language of Druids. While learning this ancient tongue, you also unlocked the magic of communicating with animals; you always have the [Speak with Animals](z_Resources/CLI/spells/speak-with-animals-xphb.md) spell prepared.

You can use Druidic to leave hidden messages. You and others who know Druidic automatically spot such a message. Others spot the message's presence with a successful DC 15 Intelligence ([Investigation](z_Resources/CLI/rules/skills.md#Investigation)) check but can't decipher it without magic.
...
- **Magician**  
    ...
    You know one extra cantrip from the Druid spell list. In addition, your mystical connection to nature gives you a bonus to your Intelligence ([Arcana](z_Resources/CLI/rules/skills.md#Arcana) or [Nature](z_Resources/CLI/rules/skills.md#Nature)) checks. The bonus equals your Wisdom modifier (minimum bonus of +1).  
...
You know two cantrips of your choice from the Druid spell list. [Druidcraft](z_Resources/CLI/spells/druidcraft-xphb.md) and [Produce Flame](z_Resources/CLI/spells/produce-flame-xphb.md) are recommended.
...
The Druid Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Druid spell list. [Animal Friendship](z_Resources/CLI/spells/animal-friendship-xphb.md), [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md), [Faerie Fire](z_Resources/CLI/spells/faerie-fire-xphb.md), and [Thunderwave](z_Resources/CLI/spells/thunderwave-xphb.md) are recommended.
...
Whenever you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells with other Druid spells for which you have spell slots.
...
You can use a [Druidic Focus](z_Resources/CLI/items/druidic-focus-xphb.md) as a [Spellcasting Focus](z_Resources/CLI/rules/variant-rules/spellcasting-focus-xphb.md) for your Druid spells.

### Wild Companion (Level 2)

You can summon a nature spirit that assumes an animal form to aid you. As a [Magic](z_Resources/CLI/rules/actions.md#Magic) action, you can expend a spell slot or a use of Wild Shape to cast the [Find Familiar](z_Resources/CLI/spells/find-familiar-xphb.md) spell without Material components.

When you cast the spell in this way, the familiar is Fey and disappears when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).

### Wild Shape (Level 2)

The power of nature allows you to assume the form of an animal. As a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md), you shape-shift into a Beast form that you have learned for this feature (see "Known Forms" below). You stay in that form for a number of hours equal to half your Druid level or until you use Wild Shape again, have the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) condition, or die. You can also leave the form early as a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md).

#### Number of Uses

You can use Wild Shape twice. You regain one expended use when you finish a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).

You gain additional uses when you reach certain Druid levels, as shown in the Wild Shape column of the Druid Features table.

#### Known Forms

You know four Beast forms for this feature, chosen from among Beast stat blocks that have a maximum [Challenge Rating](z_Resources/CLI/rules/variant-rules/challenge-rating-xphb.md) of 1/4 and that lack a [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md) (see appendix B for stat block options). The [Rat](z_Resources/CLI/bestiary/beast/rat-xmm.md), [Riding Horse](z_Resources/CLI/bestiary/beast/riding-horse-xmm.md), [Spider](z_Resources/CLI/bestiary/beast/spider-xmm.md), and [Wolf](z_Resources/CLI/bestiary/beast/wolf-xmm.md) are recommended. Whenever you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md), you can replace one of your known forms with another eligible form.

When you reach certain Druid levels, your number of known forms and the maximum [Challenge Rating](z_Resources/CLI/rules/variant-rules/challenge-rating-xphb.md) for those forms increases, as shown in the Beast Shapes table. In addition, starting at level 8, you can adopt a form that has a [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md).
...
- **Temporary Hit Points.** When you assume a Wild Shape form, you gain a number of [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md) equal to your Druid level.  
- **Game Statistics.** Your game statistics are replaced by the Beast's stat block, but you retain your creature type; [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md); [Hit Point Dice](z_Resources/CLI/rules/variant-rules/hit-point-dice-xphb.md); Intelligence, Wisdom, and Charisma scores; class features; languages; and feats. You also retain your skill and saving throw proficiencies and use your [Proficiency](z_Resources/CLI/rules/variant-rules/proficiency-xphb.md) for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast's stat block is higher than yours, use the one in the stat block.  
- **No Spellcasting.** You can't cast spells, but shape-shifting doesn't break your [Concentration](z_Resources/CLI/rules/conditions.md#Concentration) or otherwise interfere with a spell you've already cast.  
...
You gain the [Ability Score Improvement](z_Resources/CLI/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Druid levels 8, 12, and 16.

### Wild Resurgence (Level 5)

Once on each of your turns, if you have no uses of Wild Shape left, you can give yourself one use by expending a spell slot (no action required).

In addition, you can expend one use of Wild Shape (no action required) to give yourself a level 1 spell slot, but you can't do so again until you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Dimensional Travel](z_Resources/CLI/feats/boon-of-dimensional-travel-xphb.md) is recommended.
...
Whenever you roll [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md) and have no uses of Wild Shape left, you regain one expended use of it.

#### Nature Magician

You can convert uses of Wild Shape into a spell slot (no action required). Choose a number of your unexpended uses of Wild Shape and convert them into a single spell slot, with each use contributing 2 spell levels. For example, if you convert two uses of Wild Shape, you produce a level 4 spell slot. Once you use this benefit, you can't do so again until you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).
