...
![](z_Resources/CLI/adventures/light-of-xaryxis/img/029-11-001-part-three-splash.webp#center)
...
[Princess Xedalli](z_Resources/CLI/bestiary/npc/princess-xedalli-lox.md) reveals that her evil twin, Xeleth, orchestrated the attack on the characters' world in accordance with the dying wish of their father, Emperor Xavan. If the characters help her become empress, Xedalli vows to save their world.

To have any hope against [Prince Xeleth](z_Resources/CLI/bestiary/npc/prince-xeleth-lox.md)'s forces, the characters must travel to Doomspace and find [Warwyck Blastimoff](z_Resources/CLI/bestiary/npc/warwyck-blastimoff-lox.md), Commodore's Krux's former comrade-in-arms. Warwyck has been trying to raise an armada with the help of a mercane arms merchant named [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md).

### Princess Xedalli

Xedalli, a chaotic neutral [astral elf aristocrat](z_Resources/CLI/bestiary/humanoid/astral-elf-aristocrat-bam.md) (see "Boo's Astral Menagerie"), wears a [ring of shooting stars](z_Resources/CLI/items/ring-of-shooting-stars-xdmg.md) and is initially friendly toward the characters. She shares the following information with the characters if she learns about the attack on their world:
...
Xedalli conceals one important fact from the characters: one doesn't need to be a member of the imperial family to destroy Xaryxis, if one has a [ring of shooting stars](z_Resources/CLI/items/ring-of-shooting-stars-xdmg.md) like the one Xedalli wears.

### Old Wounds

After conversing with Xedalli, the characters find [Commodore Krux](z_Resources/CLI/bestiary/npc/commodore-krux-lox.md) sulking by himself.

![Major Warwyck Blastimoff](z_Resources/CLI/adventures/light-of-xaryxis/img/030-11-002-major-warwyck-blastimoff.webp#center)

#### What's Wrong, Big Guy?

If the characters ask Krux why he's sulking, he reveals the source of his shame. Long ago, the commodore tried to destroy the imperial fortress in the Astral Sea, but his fleet was routed by the elven armada. Krux's flagship was one of a handful of vessels to escape, though only after it suffered terrible damage from [Prince Xeleth](z_Resources/CLI/bestiary/npc/prince-xeleth-lox.md)'s solar dragon mount. Krux lost many comrades that day, and his hatred of the Xaryxian Empire is equaled only by his disgust at his own cowardice and failure.

#### Raising Krux's Spirits

Characters can persuade the giff to "buck up" with a successful DC 13 Charisma ([Persuasion](z_Resources/CLI/rules/skills.md#Persuasion)) check. Those who motivate the commodore with a rousing speech or a healthy dose of tough love have advantage on this check. On a successful check, Krux regains his resolve and stands ready once more to tackle the Xaryxian Empire. On a failed check, the giff sulks in his cabin; when he emerges `1d8` hours later, he is pickled in equal measures of ale and shame.

#### What Krux Knows

If his spirits are raised, Krux shares the following information:

- He plans to locate his former adjutant, an old giff comrade-in-arms named [Warwyck Blastimoff](z_Resources/CLI/bestiary/npc/warwyck-blastimoff-lox.md), who left for Doomspace to join the coalition months ago.  
- Krux and Warwyck used to communicate regularly by using [sending stones](z_Resources/CLI/items/sending-stones-xdmg.md), but Krux lost his stone on the Rock of Bral a few days before the characters encountered him.  
...
As they travel to Doomspace, the characters can engage with other crew members. [Commodore Krux](z_Resources/CLI/bestiary/npc/commodore-krux-lox.md), [Grimzod Gargenhale](z_Resources/CLI/bestiary/npc/grimzod-gargenhale-lox.md), and [Topolah](z_Resources/CLI/bestiary/npc/topolah-lox.md) are particularly fun to be around.
...
[Topolah](z_Resources/CLI/bestiary/npc/topolah-lox.md) spends her time making fishing poles and lures, then gives them to characters she likes (see ""Astral Fishing"" in the "Astral Adventurer's Guide").
...
> 
> "There," says Krux, pointing at the biggest of the outer moons. "Aruun is just seven days away. With luck, that's where we'll find my old comrade, [Warwyck Blastimoff](z_Resources/CLI/bestiary/npc/warwyck-blastimoff-lox.md). His mission here is to create unity out of chaos, and knowing him, he's done a bang-up job."
^0c1
...
[Warwyck Blastimoff](z_Resources/CLI/bestiary/npc/warwyck-blastimoff-lox.md), a lawful good [giff shipmate](z_Resources/CLI/bestiary/humanoid/giff-shipmate-bam.md), is out of ammunition and in a hurry. The creatures pursuing him are six [aartuk weedlings](z_Resources/CLI/bestiary/plant/aartuk-weedling-bam.md) and an [aartuk starhorror](z_Resources/CLI/bestiary/plant/aartuk-starhorror-bam.md) (see "Boo's Astral Menagerie" for their stat blocks). The aartuks are hostile and 30 feet away from the characters at the start of this encounter. The priest tries to snare Warwyck with its tongue while the warriors pepper the characters with radiant pellets or engage them in melee.

Once the aartuks are defeated, Warwyck lets out a long sigh of relief, salutes [Commodore Krux](z_Resources/CLI/bestiary/npc/commodore-krux-lox.md), and asks, "Permission to come aboard, sir?"

### Bulette Time

Before Krux can formally introduce Warwyck to the characters, two [bulettes](z_Resources/CLI/bestiary/monstrosity/bulette-xmm.md) erupt from the ground in the characters' midst:
...
> [!gallery]
> ![Doomspace](z_Resources/CLI/adventures/light-of-xaryxis/img/031-map-11-02-doomspace-system.webp#gallery)
> ![Player Version](z_Resources/CLI/adventures/light-of-xaryxis/img/032-map-11-02-doomspace-system-player.webp#gallery)
...
This large moon is home to rampaging [tarrasques](z_Resources/CLI/bestiary/monstrosity/tarrasque-xmm.md). "Aartuks" (see "Boo's Astral Menagerie") and other smaller life forms live in the forests that grow atop Aruun's rocky pillars and plateaus, beyond the reach of the tarrasques.

##### G'vek

This moon is dotted with sheer mountains that have become home to families of aarakocra evacuated from Fyreen. [B'rohgs](z_Resources/CLI/bestiary/giant/brohg-bam.md) (see "Boo's Astral Menagerie"), [death dogs](z_Resources/CLI/bestiary/monstrosity/death-dog-xmm.md), [gorgons](z_Resources/CLI/bestiary/construct/gorgon-xmm.md), [hydras](z_Resources/CLI/bestiary/monstrosity/hydra-xmm.md), and other monsters stalk the foothills.
...
Deep canyons crisscross the surface of this giant ball of ice. The canyons are heated by thermal vents and inhabited by [braxats](z_Resources/CLI/bestiary/giant/braxat-bam.md),* [gaj](z_Resources/CLI/bestiary/aberration/gaj-bam.md),* [megapedes](z_Resources/CLI/bestiary/monstrosity/megapede-bam.md),* [remorhazes](z_Resources/CLI/bestiary/monstrosity/remorhaz-xmm.md), "ssurran",* and [thri-kreen](z_Resources/CLI/bestiary/monstrosity/thri-kreen-marauder-xmm.md). (Creatures marked with an asterisk are described in "Boo's Astral Menagerie".)
...
This small, barren moon is covered with black frost and belongs to Yisheen, a miserly [adult lunar dragon](z_Resources/CLI/bestiary/dragon/adult-lunar-dragon-bam.md) (see "Boo's Astral Menagerie") that abides no solicitors.

##### Yort

This cold, swampy moon is strewn with the petrified skeletons of [kindori](z_Resources/CLI/bestiary/celestial/kindori-bam.md) (see "Boo's Astral Menagerie"). Humanoid evacuees from Fyreen have taken to building shelters among the bones.
...
The two [bulettes](z_Resources/CLI/bestiary/monstrosity/bulette-xmm.md) that appeared at the end of the previous session can be fought, or the characters can retreat to the safety of their ship.

After thanking the characters for their timely rescue, [Warwyck Blastimoff](z_Resources/CLI/bestiary/npc/warwyck-blastimoff-lox.md) informs them that the coalition to defeat the Xaryxian Empire doesn't exist—but that a mercane arms merchant named [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) might be the key to creating one.

If the characters want to form a coalition, they must first persuade [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) to call in his debts. The leaders of various space-dwelling factions are beholden to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) and therefore willing to listen to him, and they command enough spelljamming ships to form an armada. To gain [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s help, the characters must perform in a gladiatorial arena for his amusement and thereby earn the mercane's respect.
...
> 
> "But all is not lost. I've learned that the factions are in debt to a mercane named [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md). He might be willing to help us... for a price."
^0dd

#### Questioning Warwyck

Characters who have questions about [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can get the following information from Warwyck:

- **Vocath the Mercane.** [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) evacuated hundreds of aarakocra, humans, thri-kreen, and ssurran from the doomed world of Fyreen, then sold ships and spelljamming helms to them for next to nothing. All the factions strive to earn his favor.  
- **Vocath's Base.** [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) has a base that orbits one of the nine moons of En. He has renamed the moon after himself. (The characters can use their Wildspace orrery to ascertain that getting from Aruun to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) will take 3 days by spelljamming ship, since the two moons are currently 300 million miles apart.)  
- **Vocath's Arena.** [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) enjoys blood sports, and his base houses a gladiatorial arena where champions do battle with fearsome creatures that [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) has transported from Fyreen. Factions send their greatest warriors to fight in the arena to get [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s attention or to win supplies, weapons, or both.  

### Vocath's Base

The three-day trip from Aruun to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) is uneventful, and [Commodore Krux](z_Resources/CLI/bestiary/npc/commodore-krux-lox.md) spends much of the time catching up with his good friend, Warwyck. Characters who observe the two giff notice that Warwyck's mere presence raises Krux's spirits, filling the commodore with hope and optimism.

![Vocath's Base](z_Resources/CLI/adventures/light-of-xaryxis/img/033-11-004-vocaths-base.webp#center)

When the characters arrive at [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base, read:

> [!readaloud] 
> 
> Floating above the luminous green clouds of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) is a structure made of gray and black stone, with large crystal formations jutting from the underside. Docks radiate outward from a building that is capped by a crystal dome. Several ships are moored here, including a galleon and four others that are shaped like a wasp, a scorpion, a lamprey, and a bird, respectively.
> 
...
The following ships, each of which is equipped with a spelljamming helm, are docked at [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base when the characters arrive:

![Vocath](z_Resources/CLI/adventures/light-of-xaryxis/img/034-11-005-vocath.webp#center)

- **Dock 1.** The Skyrra, a shrike ship, has a crew of eleven [aarakocra](z_Resources/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md) and one [aarakocra spelljammer](z_Resources/CLI/bestiary/humanoid/aarakocra-spelljammer-lox.md) (use the [mage](z_Resources/CLI/bestiary/humanoid/mage-xmm.md) stat block, but give this aarakocra a flying speed of 50 feet).  
- **Dock 2.** The Remora, a lamprey ship, has a crew of twelve [aartuk weedlings](z_Resources/CLI/bestiary/plant/aartuk-weedling-bam.md), three [aartuk starhorrors](z_Resources/CLI/bestiary/plant/aartuk-starhorror-bam.md), and one [aartuk elder](z_Resources/CLI/bestiary/plant/aartuk-elder-bam.md) (see "Boo's Astral Menagerie" for their stat blocks).  
- **Dock 4.** The Tarrasque, a space galleon, has a crew of hadozees (four [hadozee explorers](z_Resources/CLI/bestiary/humanoid/hadozee-explorer-bam.md), fifteen hadozee warriors, and one hadozee [druid](z_Resources/CLI/bestiary/humanoid/druid-xmm.md)).  
- **Dock 5.** The Gadabout, a wasp ship with a torn-off leg, has a crew of two [ssurran defilers](z_Resources/CLI/bestiary/monstrosity/ssurran-defiler-bam.md) and three [ssurran poisoners](z_Resources/CLI/bestiary/monstrosity/ssurran-poisoner-bam.md) (see "Boo's Astral Menagerie" for their stat blocks). Its cargo hold has been turned into a ssurran egg nursery.  
- **Dock 6.** The Vrusk, a scorpion ship, has a crew of eight [thri-kreen hunters](z_Resources/CLI/bestiary/monstrosity/thri-kreen-hunter-bam.md), three [thri-kreen gladiators](z_Resources/CLI/bestiary/monstrosity/thri-kreen-gladiator-bam.md), and one [thri-kreen mystic](z_Resources/CLI/bestiary/monstrosity/thri-kreen-mystic-bam.md), who serves as the spelljammer (see "Boo's Astral Menagerie" for their stat blocks).  
- **Dock 8.** [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s yacht, a damselfly ship called the Devil's Deal, is moored at the end of this dock. For more information about this ship and its crew, see area 6 later in this chapter.  
...
Krux, Gargenhale, [Topolah](z_Resources/CLI/bestiary/npc/topolah-lox.md), and Flinch remain aboard the ship while the characters handle the negotiations with [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md). Warwyck offers to join the characters and will fight alongside them in [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s arena if they ask him to. [Princess Xedalli](z_Resources/CLI/bestiary/npc/princess-xedalli-lox.md) wants to accompany the characters as well, but she won't take part in the arena battle.

#### Tattooed Guards

[Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) employs giff and githyanki guards, each of whom has the mercane's personal sigil tattooed on the back of their right hand. Having this mark allows its bearer to bypass certain security features (see "Magical Effects" below). As an action, a bearer of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s sigil can use the tattoo to cast the [message](z_Resources/CLI/spells/message-xphb.md) spell, communicating only with [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md).

#### Magical Effects

Several magical effects are present on [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base:

- **Extended Telepathy.** [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can establish telepathic contact with any creature on the base that [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can see or that is tattooed with [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s personal sigil.  
- **Lighting.** [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base is brightly lit with [continual flame](z_Resources/CLI/spells/continual-flame-xphb.md) spells in braziers, lamps, and sconces.  
- **Walls of Force.** Transparent, soundproof walls of force separate areas 1, 2, and 3. [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can pass through these magical barriers, as can creatures that are tattooed with his personal sigil. [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can suppress or reactivate one of these walls (no action required), even if he can't see it. Otherwise, nothing can physically pass through these walls. A [disintegrate](z_Resources/CLI/spells/disintegrate-xphb.md) spell destroys a wall of force; a wall is otherwise indestructible and can't be dispelled.  

#### Where's Vocath?

When the characters first arrive at [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base, the [mercane](z_Resources/CLI/bestiary/celestial/mercane-bam.md) (see "Boo's Astral Menagerie") is in his audience chamber (area 4), being attended by his personal bodyguards: Y'thraka, a jovial, lawful neutral [githyanki knight](z_Resources/CLI/bestiary/aberration/githyanki-knight-xmm.md) with an eye patch, and Sergeant Burt Fluke, a foul-mouthed, chaotic neutral [giff shock trooper](z_Resources/CLI/bestiary/humanoid/giff-shock-trooper-bam.md) (see "Boo's Astral Menagerie"). These two accompany [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) wherever he goes.

When [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) decides to stage a gladiatorial contest, he notifies the base's other guards so they can herd spectators onto the arena balcony (area 1). [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) and his bodyguards then relocate to the mercane's private viewing box overlooking the arena, from where [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) presides over the spectacle.

If [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) is in danger, his bodyguards escort him to the damselfly ship berthed at area 6, which the mercane uses to escape from the threat.

#### Vocath's Base Locations

The following locations are depicted on the map of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base.

> [!gallery]
> ![Vocath's Base](z_Resources/CLI/adventures/light-of-xaryxis/img/035-map-11-001-vocaths-base.webp#gallery)
> ![Player Version](z_Resources/CLI/adventures/light-of-xaryxis/img/036-map-11-01-vocaths-base-player.webp#gallery)
...
Mounted to the underside of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s private box, visible to creatures on the arena floor, is a [mirror of life trapping](z_Resources/CLI/items/mirror-of-life-trapping-xdmg.md) whose command words are known only to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md). The mercane has trapped the following creatures inside the mirror and releases some of them during the "Arena Battles" event later in this chapter: one [braxat](z_Resources/CLI/bestiary/giant/braxat-bam.md),* two [b'rohgs](z_Resources/CLI/bestiary/giant/brohg-bam.md),* two [hook horrors](z_Resources/CLI/bestiary/monstrosity/hook-horror-xmm.md), one [megapede](z_Resources/CLI/bestiary/monstrosity/megapede-bam.md),* one [brown scavver](z_Resources/CLI/bestiary/monstrosity/brown-scavver-bam.md),* one [gray scavver](z_Resources/CLI/bestiary/monstrosity/gray-scavver-bam.md),* three [space clowns](z_Resources/CLI/bestiary/fiend/space-clown-bam.md),* and one [space guppy](z_Resources/CLI/bestiary/beast/space-guppy-bam.md).* (Creatures marked with an asterisk are described in "Boo's Astral Menagerie".) Creatures released in this manner materialize in unoccupied spaces on the arena floor as close to the mirror as possible. If the mirror is shattered, all creatures trapped inside it are released at once.

#### 2: Armory

Two walls of force (see "Magical Effects" above) seal off this chamber, where three [giff shipmates](z_Resources/CLI/bestiary/humanoid/giff-shipmate-bam.md) (see "Boo's Astral Menagerie") and three [githyanki warriors](z_Resources/CLI/bestiary/aberration/githyanki-warrior-xmm.md) stand guard. Racks and shelves holding armor and weaponry are mounted to the walls behind them (see "Treasure" below).

##### Treasure

The weapon racks and shelves hold ten [longswords](z_Resources/CLI/items/longsword-xphb.md), ten suits of [half plate](z_Resources/CLI/items/half-plate-armor-xphb.md), four [muskets](z_Resources/CLI/items/musket-xphb.md), four [pistols](z_Resources/CLI/items/pistol-xphb.md), two hundred bullets, twenty [bombs](z_Resources/CLI/items/bomb-xdmg.md), and five [kegs of gunpowder](z_Resources/CLI/items/gunpowder-keg-xdmg.md) (see ""Explosives"" in the "Dungeon Master's Guide" for more information on firearms, bombs, and gunpowder).

#### 3: Vestibule

Stone ramps from the docks ascend to this vestibule, where walls of force (see "Magical Effects" above) block access to areas 2 and 4. Two [giff shipmates](z_Resources/CLI/bestiary/humanoid/giff-shipmate-bam.md) (see "Boo's Astral Menagerie") and two [githyanki warriors](z_Resources/CLI/bestiary/aberration/githyanki-warrior-xmm.md) guard the vestibule.

Visitors seeking an audience with [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) are expected to wait here until the mercane allows them into his audience chamber (area 4).
...
While he is in this room, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can take an action to teleport any number of creatures of his choice that he can see in the room to the arena floor (area 1) or to his tower sanctum (area 5).

##### Treasure

On display are thirty painted statuettes of famous figures from across the multiverse (25 gp each), six blue quartz busts of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) displaying various poses and expressions (250 gp each), and eight model ships (750 gp each), as well as four elaborate tapestries (750 gp each) and four paintings of space-dwelling fauna (750 gp each). Racks hold ornate weapons and armor, including a suit of [+1 chain mail](z_Resources/CLI/items/1-armor-xdmg.md) and a [+1 greatsword](z_Resources/CLI/items/1-weapon-xdmg.md). [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) is willing to sell these magic items for 2,500 gp apiece or trade either one for a different rare magic item.

If a creature other than [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) touches any of the items on display, a mental alarm alerts [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md), letting him know which object was touched.

#### 5: Vocath's Sanctum

> [!readaloud] 
> 
> The perimeter of this fifty-foot-high room is lined with silk-draped windows that afford panoramic views of the luminous clouds below and the distant, dark void that was once Doomspace's sun. Soft music plays throughout the room. Low tables are sprinkled around the floor, topped with refreshments. In the middle of each table rests a stout pedestal surmounted by a cerulean bust of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md).
^0f1

An unlocked stone door leads out to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s private dock (area 6). The music permeating the room is created by magic. [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can change the music and control its volume at will (no action required).

##### Teleporter

While in this room, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) can use an action to teleport any number of creatures of his choice that he can see in the room to area 4. A creature can negate the effect on itself by succeeding on a DC 14 Charisma saving throw.

#### 6: Private Dock

A private dock juts out from [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s tower 80 feet above the public docks. The base of the pier is a wide platform anchored to the tower. An unlocked stone door leading to area 5 is guarded by two [giff shipmates](z_Resources/CLI/bestiary/humanoid/giff-shipmate-bam.md) (see "Boo's Astral Menagerie"), who stand between two 40-foot-tall stone statues of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md).

##### Devil's Deal

[Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s damselfly ship, the Devil's Deal, is berthed at the end of the dock. The ship's crew consists of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s two personal guards (see "Where's Vocath?" above), five [githyanki buccaneers](z_Resources/CLI/bestiary/humanoid/githyanki-buccaneer-bam.md), and a [githyanki xenomancer](z_Resources/CLI/bestiary/humanoid/githyanki-xenomancer-bam.md) who pilots the ship when [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) doesn't want to (see "Boo's Astral Menagerie" for the githyanki stat blocks). [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) has turned the ship's cargo hold into his personal bedchamber.
...
Characters who search [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s bedchamber find a folded-up [portable hole](z_Resources/CLI/items/portable-hole-xdmg.md), inside which the mercane has hidden 500 pp and thirteen gemstones (corundums worth 100 gp each).

### Meeting Vocath

To speak with [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md), the characters must first interact with one or more of his guards, who use their sigil tattoos to contact the mercane and inform him of the characters' arrival. Interested to hear what the characters have to say, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) instructs the guards to bring them to the audience chamber (area 4), where [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) greets them:

> [!readaloud] 
> 
> [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md), a slender blue giant wearing elegant robes, sits on a large throne flanked by two bodyguards: a battle-scarred giff and a githyanki with an eye patch. Both are clad in plate armor.
> 
> "I can't say you look particularly important," drawls the mercane. "So speak. Don't waste my time."
^0f7

[Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) is cold, smug, and oozing with pride. He knows that all the factions in Doomspace compete to please him. He is as dismissive of emotional pleas for the alliance of the Doomspace factions as he is of anything that doesn't turn him a profit.

If the characters mention the conflict with the Xaryxian Empire, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s demeanor turns cold, since that is not an event he sees as ending favorably for him. If Xedalli is present, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) assumes she's either the characters' prisoner or a traitor to the Xaryxian Empire; for her part, Xedalli follows the characters' lead, keeping her identity hidden or disclosing her royal title as appropriate.

If the characters plead for [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s help, read:

> [!readaloud] 
> 
> "Enough with the 'me, me, me,'" [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) says. With a mean glint in his eye, he adds, "I'll arrange a private meeting for you with the faction leaders if you can survive three battles in my arena, with no rest between them. Representatives of the factions will be watching, so fight well. An excellent performance might win their favor."
^0f8

If the characters agree to his terms, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) makes a dismissive gesture, teleports the characters to the arena floor (area 1), and heads to his private box to watch them perform. If [Princess Xedalli](z_Resources/CLI/bestiary/npc/princess-xedalli-lox.md) is present, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) invites her to join him in his private box and watch the spectacle by his side—an offer she accepts politely.

### Arena Battles

After teleporting the characters to the arena floor, the mercane instructs his guards to usher spectators out onto the surrounding balcony, where they begin cheering in anticipation of the spectacle to come. [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) acknowledges the throng from his private balcony. The characters have 1 minute to prepare before the first challenge begins.
...
![](z_Resources/CLI/adventures/light-of-xaryxis/img/037-11-006-arena-battle-splash.webp#center)

#### Match 1: Thrasher and Gnasher

Two [b'rohgs](z_Resources/CLI/bestiary/giant/brohg-bam.md) (see "Boo's Astral Menagerie") appear on the arena floor. They stand fifteen feet tall, have burnt-orange skin, and look somewhat befuddled as the crowd screams excitedly.
...
Brutus, a [braxat](z_Resources/CLI/bestiary/giant/braxat-bam.md), is joined by a [brown scavver](z_Resources/CLI/bestiary/monstrosity/brown-scavver-bam.md) and a [gray scavver](z_Resources/CLI/bestiary/monstrosity/gray-scavver-bam.md) (see "Boo's Astral Menagerie" for their stat blocks). They fight as allies.

#### Match 3: Queen Gorma

> [!readaloud] 
> 
> [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) shouts, "Well done. Now prepare yourselves for the Terror of Doomspace!"
> 
> Out of nowhere, a three-foot-long, wide-eyed space guppy appears before you, wagging its tail in a friendly manner.
^0fd

The characters have a moment to assess their foe—a [space guppy](z_Resources/CLI/bestiary/beast/space-guppy-bam.md) (see "Boo's Astral Menagerie")—before [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) realizes, to his dismay, that he has released the wrong creature. Realizing his mistake, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) throws his arms into the air and says, "Forgive me. Let's try this again."

Queen Gorma, a one-hundred-foot-long [megapede](z_Resources/CLI/bestiary/monstrosity/megapede-bam.md) (see "Boo's Astral Menagerie") appears, snaps up the guppy, and swallows it whole. Meanwhile, the crowd shouts, "Gorma! Gorma! Gorma!" The megapede isn't a picky eater and targets foes indiscriminately.
...
> 
> The figure calls out, "I am [Prince Xeleth](z_Resources/CLI/bestiary/npc/prince-xeleth-lox.md) of the Xaryxian Empire. I've come for my sister, Xedalli. Surrender her to me, you rats, or be annihilated."
^0ff
...
The session opens with [Princess Xedalli](z_Resources/CLI/bestiary/npc/princess-xedalli-lox.md) trying to keep her hopes alive while protecting everyone around her from the wrath of her brother, [Prince Xeleth](z_Resources/CLI/bestiary/npc/prince-xeleth-lox.md), who has [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base surrounded. Xeleth has come for his sister. If Xedalli is either dead or presumed dead, obtaining her [ring of shooting stars](z_Resources/CLI/items/ring-of-shooting-stars-xdmg.md) (the symbol of her right to the Xaryxian throne) is enough to satisfy Xeleth, because he can use it as proof of Xedalli's demise.

If Xeleth gains custody of Xedalli or claims the ring as proof of her death, his fleet withdraws from Doomspace, allowing the characters to renew their efforts to unite Doomspace factions against the Xaryxian Empire. Xeleth's attack on [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base is proof of the threat posed by the astral elves, giving the factions a common enemy.

### The Xaryxian Threat

[Prince Xeleth](z_Resources/CLI/bestiary/npc/prince-xeleth-lox.md) is a chaotic evil [astral elf aristocrat](z_Resources/CLI/bestiary/humanoid/astral-elf-aristocrat-bam.md) (see "Boo's Astral Menagerie") who wears a [ring of shooting stars](z_Resources/CLI/items/ring-of-shooting-stars-xdmg.md). After learning of his sister's escape from custody, Xeleth used the power of the Astral Font (see chapter 11) to cast [divination](z_Resources/CLI/spells/divination-xphb.md). This spell enabled him to determine the whereabouts of his sister's [ring of shooting stars](z_Resources/CLI/items/ring-of-shooting-stars-xdmg.md).

![Prince Xeleth](z_Resources/CLI/adventures/light-of-xaryxis/img/038-11-007-prince-xeteth.webp#center)

The [young solar dragon](z_Resources/CLI/bestiary/dragon/young-solar-dragon-bam.md) (see "Boo's Astral Menagerie") that appeared at the end of the previous session was summoned by Xeleth using Summon Solar Dragon. The figure riding the dragon, however, is not Xeleth himself but an illusion of him, created by Xeleth's [mislead](z_Resources/CLI/spells/mislead-xphb.md) spell. As long as he maintains concentration on the spell, Xeleth can interact with anyone present through this illusion. If the characters attack the illusory Xeleth or the dragon, the dragon retaliates.

#### Star Moth Fleet

The real Xeleth is safely aboard the *Xaryxia*, one of twelve star moths surrounding [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base. The star moths form a ring around the base while staying 250 feet away from it. Their weapons open fire on any ship that tries to leave the base. (See chapter 2 of the "Astral Adventurer's Guide" for information about star moths and their weaponry.)

If the characters decide to attack Xeleth's fleet, use nonplayer characters such as [Commodore Krux](z_Resources/CLI/bestiary/npc/commodore-krux-lox.md), [Warwyck Blastimoff](z_Resources/CLI/bestiary/npc/warwyck-blastimoff-lox.md), [Princess Xedalli](z_Resources/CLI/bestiary/npc/princess-xedalli-lox.md), and [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) to make it clear that doing so would be tantamount to suicide. Each star moth is crewed by an [astral elf honor guard](z_Resources/CLI/bestiary/humanoid/astral-elf-honor-guard-bam.md), who serves as the captain; an [astral elf star priest](z_Resources/CLI/bestiary/humanoid/astral-elf-star-priest-bam.md), who serves as the ship's spelljammer; and eleven [astral elf warriors](z_Resources/CLI/bestiary/humanoid/astral-elf-warrior-bam.md). The fleet is under the command of an [astral elf commander](z_Resources/CLI/bestiary/humanoid/astral-elf-commander-bam.md) named Vael, who also serves as Xeleth's bodyguard aboard the *Xaryxia*. (See "Boo's Astral Menagerie" for the "astral elves' stat blocks".)

#### Vocath's Reaction

Annoyed that the characters have brought [Prince Xeleth](z_Resources/CLI/bestiary/npc/prince-xeleth-lox.md)'s fleet to his doorstep, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) does all he can to prevent the characters from dragging him deeper into their conflict with the Xaryxian Empire—first by insisting that the characters comply with Xeleth's demands, and then by discouraging the Doomspace factions from doing anything that might escalate the current conflict at his base. If Xedalli is by his side, the mercane quietly and politely suggests that she surrender to her brother without a fight.
...
News of Emperor Xavan's death comes as no surprise to [Princess Xedalli](z_Resources/CLI/bestiary/npc/princess-xedalli-lox.md). But she knows her brother well enough to assume he's not being entirely truthful about the rest of it. Xedalli clarifies Xeleth's motivation, addressing [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) and the characters with this reply:
...
Xeleth doesn't deny his sister's accusation, nor do her words change the present situation. Xedalli sees no better option than to accompany her brother back to Xaryxispace. As the encounter unfolds, however, she uses the same trick as Xeleth: she casts [mislead](z_Resources/CLI/spells/mislead-xphb.md), turning [invisible](z_Resources/CLI/rules/conditions.md#Invisible) while creating an illusory duplicate of herself. While [invisible](z_Resources/CLI/rules/conditions.md#Invisible), Xedalli addresses the characters through her illusion and praises them for their heroic attitude while discouraging them from getting involved in Xaryxian politics. While her illusion chatters on, Xedalli surreptitiously removes her [ring of shooting stars](z_Resources/CLI/items/ring-of-shooting-stars-xdmg.md), drops it on the sandy arena floor, and uses a [sending](z_Resources/CLI/spells/sending-xphb.md) spell to communicate the following information to a character she can trust to act on it:
...
After giving up her ring, Xedalli moves back into the space occupied by her illusory image and ends her [mislead](z_Resources/CLI/spells/mislead-xphb.md) spell, making it seem like she was there the whole time.
...
If he thinks Xedalli is dead, Xeleth assumes the characters have her ring and demands that it be tossed into his dragon's mouth (so that the dragon can safely transport it back to Xeleth's ship). If his dragon is defeated before it can deliver the ring, Xeleth orders Commander Vael to teleport to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base with eight [astral elf warriors](z_Resources/CLI/bestiary/humanoid/astral-elf-warrior-bam.md), obtain the ring at any cost, and teleport back to the Xaryxia. [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md), if he's alive, helps the astral elves retrieve the ring. He hopes they'll leave in peace afterward, which they do.

#### Xeleth Denied

If Xeleth is unable to obtain Xedalli or her ring, his fleet opens fire on the ships docked at [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base. (These ships are detailed in chapter 8). After 5 rounds of bombardment, the following ships are destroyed before their crews can mount a defense: the Skyrra, the Remora, the Vrusk, the Tarrasque, and the Gadabout.

Neither the characters' ship nor the *Devil's Deal* ([Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s damselfly ship) is damaged in the initial bombardment. But if either ship tries to leave [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base, the astral elves unleash their next flurry of ballista bolts and mangonel stones against the fleeing ship.

After the astral elves' initial bombardment, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) casts [dimension door](z_Resources/CLI/spells/dimension-door-xphb.md) and boards Xeleth's flagship to negotiate an end to the conflict. If Xedalli is nearby, the mercane takes her along, and together they work out a deal in which Xedalli surrenders to Xeleth and the astral elves leave without further incident.

If [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) isn't around to negotiate a peaceful end to the conflict, Xeleth's fleet docks at the base and deploys troops once it's safe to do so. Enemy leaders are rounded up and executed, and any hope of forming a coalition among the Doomspace factions is lost. (Skip over the "Alliance in Doomspace" and "Assemble the Fleet!" sections.) When the characters are ready to leave Doomspace, continue with the "Red Dragon Rider" section at the end of the chapter.

### Alliance in Doomspace

After Xeleth is placated and his fleet withdraws from Doomspace, [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) arranges a gathering in his private sanctum (area 5 of [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md)'s base, as described in chapter 8). This meeting is attended by the characters and representatives of the five Doomspace factions. [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md) and his bodyguards are also here, observing the proceedings in silence.
...
|----------------|---------|
| Dakaer (neutral, hadozee [hadozee explorer](z_Resources/CLI/bestiary/humanoid/hadozee-explorer-bam.md)*) | Hadozee |
| Rika (neutral good [aarakocra](z_Resources/CLI/bestiary/elemental/aarakocra-skirmisher-xmm.md)) | Aarakocra |
| T'kitka (chaotic neutral [thri-kreen mystic](z_Resources/CLI/bestiary/monstrosity/thri-kreen-mystic-bam.md)*) | Thri-kreen |
| Vortshu (chaotic neutral [aartuk elder](z_Resources/CLI/bestiary/plant/aartuk-elder-bam.md)*) | Aartuk |
| Zoth'ess (neutral [ssurran defiler](z_Resources/CLI/bestiary/monstrosity/ssurran-defiler-bam.md)*) | Ssurran |
^faction-representatives
...
> 
> - A set of artisan's tools or [navigator's tools](z_Resources/CLI/items/navigators-tools-xphb.md)  
> - A [healing kit](z_Resources/CLI/items/healers-kit-xphb.md) or [potion of healing](z_Resources/CLI/items/potion-of-healing-xdmg.md)  
...
> 
> - The Wildspace orrery acquired from [Topolah](z_Resources/CLI/bestiary/npc/topolah-lox.md)  
...
> - By defeating Vortshu in a wrestling match, which requires the character to succeed on three DC 14 Strength ([Athletics](z_Resources/CLI/rules/skills.md#Athletics)) checks before failing three of those checks  
^vortshu
...
> 
> Zoth'ess needs money to repair her ship's broken leg and pay off debts to [Vocath](z_Resources/CLI/bestiary/npc/vocath-lox.md). She demands treasure in exchange for her support.
> 
