...
![](z_Resources/CLI/races/img/tiefling.webp#right)
...
When you reach character levels 3 and 5, you learn a higher-level spell, as shown on the table. You always have that spell prepared. You can cast it once without a spell slot, and you regain the ability to cast it in that way when you finish a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md). You can also cast the spell using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for the spells you cast with this trait (choose the ability when you select the legacy).

**Fiendish Legacies**

| Legacy | Level 1 | Level 3 | Level 5 |
|--------|---------|---------|---------|
| Abyssal | You have Resistance to Poison damage. You also know the [Poison Spray](z_Resources/CLI/spells/poison-spray-xphb.md) cantrip. | [Ray of Sickness](z_Resources/CLI/spells/ray-of-sickness-xphb.md) | [Hold Person](z_Resources/CLI/spells/hold-person-xphb.md) |
| Chthonic | You have Resistance to Necrotic damage. You also know the [Chill Touch](z_Resources/CLI/spells/chill-touch-xphb.md) cantrip. | [False Life](z_Resources/CLI/spells/false-life-xphb.md) | [Ray of Enfeeblement](z_Resources/CLI/spells/ray-of-enfeeblement-xphb.md) |
| Infernal | You have Resistance to Fire damage. You also know the [Fire Bolt](z_Resources/CLI/spells/fire-bolt-xphb.md) cantrip. | [Hellish Rebuke](z_Resources/CLI/spells/hellish-rebuke-xphb.md) | [Darkness](z_Resources/CLI/spells/darkness-xphb.md) |
^fiendish-legacies

### Otherworldly Presence

You know the [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md) cantrip. When you cast it with this trait, the spell uses the same spellcasting ability you use for your Fiendish Legacy Trait.
...
> [!gallery]
![Infernal Tiefling, Chthoni...](z_Resources/CLI/races/img/156-05-029-infernal-chthonic-abyssal.webp "Infernal Tiefling, Chthonic Tiefling, Abyssal Tiefling")
![](z_Resources/CLI/races/img/157-05-028-armored-tiefling.webp)