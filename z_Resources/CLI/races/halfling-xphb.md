...
![](z_Resources/CLI/races/img/halfling.webp#right)
...
You have [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) condition.
...
When you roll a 1 on the `d20` of a [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.

### Naturally Stealthy

You can take the [Hide](z_Resources/CLI/rules/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
