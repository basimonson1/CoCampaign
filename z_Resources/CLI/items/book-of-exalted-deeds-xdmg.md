...
![](z_Resources/CLI/items/img/book-of-exalted-deeds.webp#right)
...
Other creatures that peruse the book's open pages can read the text but glean no deeper meaning and reap no benefits. A Fiend, an Undead, or a servant of a god from the Lower Planes that tries to read from the book takes `24d6` Radiant damage. This damage ignores [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) and [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md), and it can't be reduced or avoided by any means. A creature reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) by this damage disappears in a flash and is destroyed, leaving its possessions behind. The book then vanishes, and the creature's [Attunement](z_Resources/CLI/rules/variant-rules/attunement-xphb.md) to it ends.
...
While attuned to the book, you have [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md) to the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) and [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) conditions and [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) to Psychic damage. These benefits become permanent after you spend the requisite amount of time reading and studying the book.
...
After you spend the requisite amount of time reading and studying the book, you gain a protective halo. This halo sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet. You can dismiss or manifest the halo as a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md). While present, the halo gives you [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on Charisma ([Persuasion](z_Resources/CLI/rules/skills.md#Persuasion)) checks. In addition, Fiends and Undead within the halo's [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md) make attack rolls against you with [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md).
...
- 2 [major beneficial](z_Resources/CLI/tables/artifact-properties-major-beneficial-properties-xdmg.md) properties  
