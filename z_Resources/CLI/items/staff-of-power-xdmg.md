...
This staff has 20 charges and can be wielded as a magic Quarterstaff that grants a +2 bonus to attack rolls and damage rolls made with it. While holding it, you gain a +2 bonus to [Armor Class](z_Resources/CLI/rules/variant-rules/armor-class-xphb.md), saving throws, and spell attack rolls.
...
| Spell | Charge Cost |
|-------|-------------|
| [Cone of Cold](z_Resources/CLI/spells/cone-of-cold-xphb.md) | 5 |
| [Fireball](z_Resources/CLI/spells/fireball-xphb.md) (level 5 version) | 5 |
| [Globe of Invulnerability](z_Resources/CLI/spells/globe-of-invulnerability-xphb.md) | 6 |
| [Hold Monster](z_Resources/CLI/spells/hold-monster-xphb.md) | 5 |
| [Levitate](z_Resources/CLI/spells/levitate-xphb.md) | 2 |
| [Lightning Bolt](z_Resources/CLI/spells/lightning-bolt-xphb.md) (level 5 version) | 5 |
| [Magic Missile](z_Resources/CLI/spells/magic-missile-xphb.md) | 1 |
| [Ray of Enfeeblement](z_Resources/CLI/spells/ray-of-enfeeblement-xphb.md) | 1 |
| [Wall of Force](z_Resources/CLI/spells/wall-of-force-xphb.md) | 5 |
^spell-charge-cost
