...
![](z_Resources/CLI/items/img/amulet-of-the-planes.webp#right)

- **Weight**: 1.0 lbs.

While wearing this amulet, you can take a [Magic](z_Resources/CLI/rules/actions.md#Magic) action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence ([Arcana](z_Resources/CLI/rules/skills.md#Arcana)) check. On a successful check, you cast [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md). On a failed check, you and each creature and object within 15 feet of you travel to a random destination determined by rolling `1d100` and consulting the following table.
