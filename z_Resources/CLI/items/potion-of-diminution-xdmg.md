...
When you drink this potion, you gain the "reduce" effect of the [Enlarge/Reduce](z_Resources/CLI/spells/enlarge-reduce-xphb.md) spell for `1d4` hours (no [Concentration](z_Resources/CLI/rules/conditions.md#Concentration) required).
