...
*Use this column for [Cylinder [Area of Effect]](z_Resources/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md), [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md).