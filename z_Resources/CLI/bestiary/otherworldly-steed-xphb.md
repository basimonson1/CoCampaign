...
---
# [Otherworldly Steed](z_Resources\CLI\bestiary/otherworldly-steed-xphb.md)
...
- "desc": "Wisdom Saving Throw: DC equals your spell save DC, one creature within\
    \ 60 feet the steed can see. Failure: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
...
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/token/otherworldly-steed-xphb.webp"
```
^statblock