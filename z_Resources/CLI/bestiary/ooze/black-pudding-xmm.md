...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [deafened](z_Resources/CLI/rules/conditions.md#Deafened),\
  ...
  \ [grappled](z_Resources/CLI/rules/conditions.md#Grappled), [prone](z_Resources/CLI/rules/conditions.md#Prone),\
...
- "desc": "A creature that hits the pudding with a melee attack roll takes 4 (1d8)\
    ...
    \ -5. The penalty can be removed by casting the [Mending](z_Resources/CLI/spells/mending-xphb.md)\
...
- "desc": "Melee Attack: +5, reach 10 ft. Hit: 17 (4d6 + 3) Acid damage. Nonmagical\
    ...
    \ casting the [Mending](z_Resources/CLI/spells/mending-xphb.md) spell on the armor."
  "name": "Dissolving Pseudopod"
"reactions":
- "desc": "Trigger: While the pudding is Large or Medium and has 10+ [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    \ it becomes [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)\
    \ or is subjected to Lightning or Slashing damage. Response: The pudding splits\
    \ into two new Black Puddings. Each new pudding is one size smaller than the original\
    \ pudding and acts on its [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md).\
    \ The original pudding's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
