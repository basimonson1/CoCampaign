...
|------------|----------------------|
| 1 | An [Amulet of the Planes](z_Resources/CLI/items/amulet-of-the-planes-xdmg.md). |
| 2 | An Artifact of the DM's choice. |
| 3 | The corpses of two gods who were entangled in battle when the blob consumed them. |
| 4 | A Cubic Gate. |
| 5 | A [Deck of Many Things](z_Resources/CLI/items/deck-of-many-things-xdmg.md). |
...
"cr": "23"
"traits":
- "desc": "If the blob is reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
...
- "desc": "The blob has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +15, reach 30 ft. Hit: 24 (3d10 + 8) Force damage."
  "name": "Pseudopod"
- "desc": "The blob moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    ...
    \ a target has [Cover](z_Resources/CLI/rules/variant-rules/cover-xphb.md) against\
    ...
    \ start of each of its turns, is suffocating, has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition, and repeats the save at the end of each of its turns. An engulfed\
    \ creature that is reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The blob lobs a slimy glob at one Large or smaller creature it can see\
    ...
    \ toward the blob, and the target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
