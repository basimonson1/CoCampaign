...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 12 (3d6 + 2) Acid damage."
  "name": "Pseudopod"
"reactions":
- "desc": "Trigger: While the jelly is Large or Medium and has 10+ [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    ...
    \ jelly and acts on its [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md).\
    \ The original jelly's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
