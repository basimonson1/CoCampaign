...
- "desc": "The empyrean casts one of the following spells, requiring no Material components\
    \ and using Wisdom as the spellcasting ability:\n\n1/day each: [Bless](z_Resources/CLI/spells/bless-xphb.md),\
    \ [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md) (as\
    \ an action)"
  "name": "Spellcasting"
- "desc": "The empyrean casts [Healing Word](z_Resources/CLI/spells/healing-word-xphb.md),\
    \ using the same spellcasting ability as Spellcasting.\n\n1/day: [Healing\
    \ Word](z_Resources/CLI/spells/healing-word-xphb.md)"
