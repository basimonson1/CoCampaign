...
---
# [Aartuk Starhorror](z_Resources\CLI\bestiary\plant/aartuk-starhorror-bam.md)
...
- "desc": "The aartuk casts one of the following spells, requiring no spell components\
    \ and using Wisdom as the spellcasting ability:\n\n1/day each: [revivify](z_Resources/CLI/spells/revivify-xphb.md),\
    \ [speak with plants](z_Resources/CLI/spells/speak-with-plants-xphb.md)"
...
- "desc": "Ranged Spell Attack: +2 to hit, range 60 ft., one target. Hit: 7\
  ...
  "name": "Radiant Pellet"
"bonus_actions":
- "desc": "The aartuk magically ends the [charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
...
- "desc": "The aartuk tries to use its gooey tongue to snare one Medium or smaller\
    ...
    \ saving throw. On a failed save, the target is [grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/plant/token/aartuk-starhorror-bam.webp"
```
^statblock