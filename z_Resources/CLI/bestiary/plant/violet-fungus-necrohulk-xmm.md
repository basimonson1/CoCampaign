...
- "desc": "Constitution Saving Throw: DC 15, each creature in a 20-foot-radius [Sphere\
    ...
    \ Necrotic damage, and the target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition until the start of the necrohulk's next turn. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
...
- "desc": "Strength Saving Throw: DC 15, one Medium or Small creature the necrohulk\
    ...
    \ grafted at a time.\n\nWhile grafted, the target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition and [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    ...
    \ the necrohulk regains 10 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\n\
    \nThe grafted target or a creature within 5 feet of the necrohulk can take an\
    \ action to make a DC 15 Strength ([Athletics](z_Resources/CLI/rules/skills.md#Athletics))\
