...
"condition_immunities": "[deafened](z_Resources/CLI/rules/conditions.md#Deafened)"
"senses": "blindsight 120 ft., passive Perception 19"
"languages": "Common, Druidic"
"cr": "16"
"traits":
- "desc": "When it finishes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md),\
    ...
    \ [Twig Blight](z_Resources/CLI/bestiary/plant/twig-blight-xmm.md); on 5-6, [Needle\
    \ Blight](z_Resources/CLI/bestiary/plant/needle-blight-xmm.md); on 7-8, [Vine\
    \ Blight](z_Resources/CLI/bestiary/plant/vine-blight-xmm.md)."
  "name": "Blight Seeds"
"actions":
...
- "desc": "Constitution Saving Throw: DC 20, one Huge or smaller creature the blight\
    ...
    \ DC 17) from one of six roots. Until the grapple ends, the target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition and takes 14 (4d6) Necrotic damage at the start of each of its turns.\
    \ The target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
