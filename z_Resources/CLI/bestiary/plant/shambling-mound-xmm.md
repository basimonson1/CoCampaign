...
- "desc": "Whenever the shambling mound is subjected to Lightning damage, it regains\
    \ a number of [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Strength Saving Throw: DC 15, one Medium or smaller creature within 5\
    ...
    \ DC 14). Until the grapple ends, the target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
    ...
    \ When the shambling mound moves, the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ target moves with it, costing it no extra movement. The shambling mound can\
    \ have only one creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
