...
---
# [Astral Blight](z_Resources\CLI\bestiary\plant/astral-blight-lox.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 6\
    ...
    \ it is [grappled](z_Resources/CLI/rules/conditions.md#Grappled) (escape DC 13).\
...
"source":
- "LoX"
"image": "z_Resources/CLI/bestiary/plant/token/astral-blight-lox.webp"
```
^statblock