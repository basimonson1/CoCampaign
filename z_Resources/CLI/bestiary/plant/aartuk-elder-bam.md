...
---
# [Aartuk Elder](z_Resources\CLI\bestiary\plant/aartuk-elder-bam.md)
...
- "desc": "The aartuk casts one of the following spells, requiring no spell components\
    ...
    \ each: [calm emotions](z_Resources/CLI/spells/calm-emotions-xphb.md), [detect\
    \ magic](z_Resources/CLI/spells/detect-magic-xphb.md), [sending](z_Resources/CLI/spells/sending-xphb.md)"
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/plant/token/aartuk-elder-bam.webp"
```
^statblock