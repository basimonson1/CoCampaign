...
"condition_immunities": "[blinded](z_Resources/CLI/rules/conditions.md#Blinded), [charmed](z_Resources/CLI/rules/conditions.md#Charmed),\
  ...
  \ [paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed), [poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
...
- "desc": "The gas spore bursts when it dies. Constitution Saving Throw: DC 10,\
    \ each creature in a 20-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the gas spore. Failure: The target takes 10 (3d6) Poison\
    \ damage and has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition for 1d12 hours. Unless the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition is removed, the target dies at the end of that time and sprouts 2d4\
    \ Tiny Gas Spore Fungi (each with 1 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)).\
    \ After 2d6 days, they become Large and have 13 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
  "name": "Death Burst"
"actions":
