...
- "desc": "The naga casts one of the following spells, requiring no Somatic or Material\
    ...
    \ each: [Clairvoyance](z_Resources/CLI/spells/clairvoyance-xphb.md), [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md)\
    \ (level 6 version), [Flame Strike](z_Resources/CLI/spells/flame-strike-xphb.md)\
    \ (level 6 version), [Geas](z_Resources/CLI/spells/geas-xphb.md), [True Seeing](z_Resources/CLI/spells/true-seeing-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the naga dies, it returns to life in 1d6 days and regains all its\
    \ [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) unless\
...
- "desc": "Constitution Saving Throw: DC 16, one creature the naga can see within\
    \ 60 feet. Failure: 31 (7d8) Poison damage, and the target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
