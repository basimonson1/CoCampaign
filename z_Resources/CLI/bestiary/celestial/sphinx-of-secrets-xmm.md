...
- "desc": "The sphinx casts one of the following spells, requiring no Material components\
    ...
    \ each: [Locate Object](z_Resources/CLI/spells/locate-object-xphb.md), [Remove\
...
- "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
  ...
  "name": "Inscrutable"
- "desc": "The sphinx has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
"actions":
- "desc": "The sphinx makes three Claw attacks. It can replace one attack with a use\
    \ of [Curses](z_Resources/CLI/rules/variant-rules/curses-xphb.md) of the Riddle."
  "name": "Multiattack"
...
- "desc": "Intelligence Saving Throw: DC 15, one creature the sphinx can see within\
    ...
    \ a riddle. The cursed target has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
