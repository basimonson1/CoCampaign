...
---
# [Animal Lord; Hunter](z_Resources\CLI\bestiary\celestial/animal-lord-hunter-xmm.md)
...
- "desc": "Wisdom Saving Throw: DC 20, any enemy that starts its turn in a 30-foot\
    ...
    \ originating from the animal lord. Failure: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The animal lord conjures an animal spirit that strikes at a creature and\
    ...
    \ Half damage. Failure or Success: The animal lord has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
