...
---
# [Starlight Apparition](z_Resources\CLI\bestiary\celestial/starlight-apparition-bam.md)
...
- "desc": "Melee or Ranged Spell Attack: +6 to hit, reach 5 ft. or range 120 ft.,\
    ...
    \ it must succeed on a DC 14 Wisdom saving throw or be [blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
...
- "desc": "One Humanoid that the apparition can see within 5 feet of itself must succeed\
    ...
    \ then disappears, and the target is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    ...
    \ Charisma, and immunity to being [charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/celestial/token/starlight-apparition-bam.webp"
```
^statblock