...
- "desc": "The couatl casts one of the following spells, requiring no spell components\
    ...
    \ required to maintain the spell)\n\n1/day each: [Create Food and Water](z_Resources/CLI/spells/create-food-and-water-xphb.md),\
    \ [Dream](z_Resources/CLI/spells/dream-xphb.md), [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md),\
    \ [Scrying](z_Resources/CLI/spells/scrying-xphb.md), [Sleep](z_Resources/CLI/spells/sleep-xphb.md)"
  "name": "Spellcasting"
- "desc": "The couatl casts [Bless](z_Resources/CLI/spells/bless-xphb.md), [Lesser\
    \ Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md), or [Sanctuary](z_Resources/CLI/spells/sanctuary-xphb.md),\
    \ requiring no spell components and using the same spellcasting ability as Spellcasting.\n\
    \n2/day: [Bless](z_Resources/CLI/spells/bless-xphb.md), [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md),\
    \ [Sanctuary](z_Resources/CLI/spells/sanctuary-xphb.md)"
...
- "desc": "Strength Saving Throw: DC 15, one Medium or smaller creature the couatl\
    ...
    \ has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled) condition (escape\
    \ DC 13), and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
