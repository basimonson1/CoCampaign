...
- "desc": "The sphinx casts one of the following spells, requiring no Material components\
    ...
    \ will: [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Identify](z_Resources/CLI/spells/identify-xphb.md),\
    \ [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md), [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md),\
    \ [Prestidigitation](z_Resources/CLI/spells/prestidigitation-xphb.md)\n\n1/day\
    \ each: [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md), [Legend\
    \ Lore](z_Resources/CLI/spells/legend-lore-xphb.md), [Locate Object](z_Resources/CLI/spells/locate-object-xphb.md),\
    \ [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md), [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md),\
    \ [Tongues](z_Resources/CLI/spells/tongues-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Wisdom Saving Throw: DC 16, each enemy in a 300-foot [Emanation [Area\
    ...
    \ target has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
