...
aliases: ["Reigar"]
---
# [Reigar](z_Resources\CLI\bestiary\celestial/reigar-bam.md)
...
- "desc": "The reigar casts one of the following spells, requiring no spell components\
    ...
    \ each: [mass suggestion](z_Resources/CLI/spells/mass-suggestion-xphb.md), [sending](z_Resources/CLI/spells/sending-xphb.md)\n\
    \n2/day each: [dimension door](z_Resources/CLI/spells/dimension-door-xphb.md),\
    \ [phantasmal force](z_Resources/CLI/spells/phantasmal-force-xphb.md)"
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/celestial/token/reigar-bam.webp"
```
^statblock