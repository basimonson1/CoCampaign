...
aliases: ["Mercane"]
---
# [Mercane](z_Resources\CLI\bestiary\celestial/mercane-bam.md)
...
"ac": !!int "13"
"ac_class": "[mage armor](z_Resources/CLI/spells/mage-armor-xphb.md)"
"hp": !!int "75"
"hit_dice": "10d10 + 20"
"stats":
- !!int "16"
...
- "desc": "The mercane casts one of the following spells, requiring no spell components\
    ...
    \ will: [detect magic](z_Resources/CLI/spells/detect-magic-xphb.md), [light](z_Resources/CLI/spells/light-xphb.md)\n\
    \n1/day each: [dimension door](z_Resources/CLI/spells/dimension-door-xphb.md),\
    \ [invisibility](z_Resources/CLI/spells/invisibility-xphb.md), [mage armor](z_Resources/CLI/spells/mage-armor-xphb.md)\
    \ (self only)"
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 10\
    ...
    \ on a DC 15 Wisdom saving throw or be [frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    \ of the mercane until the end of the target's next turn."
  "name": "Psi-Imbued Blade"
"source":
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/celestial/token/mercane-bam.webp"
```
^statblock