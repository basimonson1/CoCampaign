...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion),\
  \ [frightened](z_Resources/CLI/rules/conditions.md#Frightened), [poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)"
...
- "desc": "The solar casts one of the following spells, requiring no Material components\
    ...
    \n1/day each: [Commune](z_Resources/CLI/spells/commune-xphb.md), [Control\
    \ Weather](z_Resources/CLI/spells/control-weather-xphb.md), [Dispel Evil and Good](z_Resources/CLI/spells/dispel-evil-and-good-xphb.md),\
    \ [Resurrection](z_Resources/CLI/spells/resurrection-xphb.md)"
  "name": "Spellcasting"
- "desc": "The solar casts [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md)\
    \ (level 2 version), [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md),\
    \ or [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md), using the same\
    \ spellcasting ability as Spellcasting.\n\n3/day: [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md)\
    \ (level 2 version), [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md),\
    \ [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md)"
...
- "desc": "If the solar dies outside Mount Celestia, its body disappears, and it gains\
    \ a new body instantly, reviving with all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ somewhere in Mount Celestia."
  "name": "Exalted Restoration"
- "desc": "If the solar fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day)"
- "desc": "The solar has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee or Ranged Attack: +15, reach 10 ft. or range 120 ft. Hit: 22\
    \ (4d6 + 8) Slashing damage plus 36 (8d8) Radiant damage. Hit or Miss: The\
...
- "desc": "Dexterity Saving Throw: DC 21, one creature the solar can see within\
    \ 600 feet. Failure: If the creature has 100 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 25, one creature the solar can see within\
    \ 120 feet. Failure: The target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
...
- "desc": "The solar teleports up to 60 feet to an unoccupied space it can see. Dexterity\
    \ Saving Throw: DC 25, each creature in a 10-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
