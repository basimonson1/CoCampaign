...
- "desc": "The sphinx casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Evil and Good](z_Resources/CLI/spells/detect-evil-and-good-xphb.md),\
    \ [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\n1/day each:\
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md),\
    \ [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md), [Heroes'\
    \ Feast](z_Resources/CLI/spells/heroes-feast-xphb.md), [Zone of Truth](z_Resources/CLI/spells/zone-of-truth-xphb.md)"
  "name": "Spellcasting"
- "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
    \ its permission. Wisdom ([Insight](z_Resources/CLI/rules/skills.md#Insight))\
    \ checks made to ascertain its intentions or sincerity are made with [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)."
  "name": "Inscrutable"
...
- "desc": "The sphinx emits a magical roar. Whenever it roars, the roar has a different\
    \ effect, as detailed below (the sequence resets when it takes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md)):\n\
    ...
    \ originating from the sphinx. Failure: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    \ condition for 1 minute.  \n- Second Roar. Wisdom Saving Throw: DC 20,\
    \ each enemy in a 500-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the sphinx. Failure: The target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    ...
    \ [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 16, one creature the sphinx can see within\
    \ 120 feet. Failure: The target gains 1 [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion)\
    \ level. While the target has any [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion)\
...
- "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is altered\
  ...
  "name": ""
- "desc": "- Distant Sight. While in its lair, the sphinx can cast [Clairvoyance](z_Resources/CLI/spells/clairvoyance-xphb.md),\
    ...
    \ of Knowledge. Whenever the sphinx or one of its allies takes a [Study](z_Resources/CLI/rules/actions.md#Study)\
