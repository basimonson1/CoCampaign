...
- "desc": "The planetar casts one of the following spells, requiring no Material components\
  ...
  "name": "Spellcasting"
- "desc": "The planetar casts [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md),\
    \ [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md), [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md),\
...
- "desc": "If the planetar dies outside Mount Celestia, its body disappears, and it\
    \ gains a new body instantly, reviving with all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ somewhere in Mount Celestia."
  "name": "Exalted Restoration"
- "desc": "The planetar has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
"actions":
- "desc": "The planetar makes three Radiant Sword attacks or uses Holy Burst twice."
  "name": "Multiattack"
- "desc": "Melee Attack: +12, reach 10 ft. Hit: 14 (2d6 + 7) Slashing damage\
