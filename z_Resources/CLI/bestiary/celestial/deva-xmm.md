...
- "desc": "The deva casts one of the following spells, requiring no Material components\
    ...
    \ required to maintain the spell)\n\n1/day each: [Commune](z_Resources/CLI/spells/commune-xphb.md),\
    \ [Raise Dead](z_Resources/CLI/spells/raise-dead-xphb.md)"
  "name": "Spellcasting"
- "desc": "The deva casts [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md),\
    \ [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md), or\
    \ [Remove Curse](z_Resources/CLI/spells/remove-curse-xphb.md), using the same\
    \ spellcasting ability as Spellcasting.\n\n2/day: [Cure Wounds](z_Resources/CLI/spells/cure-wounds-xphb.md),\
    \ [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md), [Remove\
    \ Curse](z_Resources/CLI/spells/remove-curse-xphb.md)"
...
- "desc": "The deva has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
