...
aliases: ["Kindori"]
---
# [Kindori](z_Resources\CLI\bestiary\celestial/kindori-bam.md)
...
- "desc": "The kindori emits bright light in a 120-foot cone. Each creature in the\
    \ cone must succeed on a DC 14 Wisdom saving throw or be [blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/celestial/token/kindori-bam.webp"
```
^statblock