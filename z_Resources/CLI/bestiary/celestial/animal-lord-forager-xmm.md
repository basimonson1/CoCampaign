...
---
# [Animal Lord; Forager](z_Resources\CLI\bestiary\celestial/animal-lord-forager-xmm.md)
...
- "desc": "Wisdom Saving Throw: DC 20, any enemy that starts its turn in a 30-foot\
    ...
    \ originating from the animal lord. Failure: The target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
...
- "desc": "The animal lord conjures an animal spirit that strikes at a creature and\
    ...
    \ Half damage. Failure or Success: The animal lord gains 20 [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md)."
  "name": "Animal Spirit"
"bonus_actions":
