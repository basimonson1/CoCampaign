...
- "desc": "The animal lord casts one of the following spells, requiring no Material\
    ...
    \nAt will: [Animal Friendship](z_Resources/CLI/spells/animal-friendship-xphb.md),\
    \ [Animal Messenger](z_Resources/CLI/spells/animal-messenger-xphb.md), [Speak\
    \ with Animals](z_Resources/CLI/spells/speak-with-animals-xphb.md)\n\n1/day\
    \ each: [Animal Shapes](z_Resources/CLI/spells/animal-shapes-xphb.md), [Sunburst](z_Resources/CLI/spells/sunburst-xphb.md)\n\
    \n2/day each: [Awaken](z_Resources/CLI/spells/awaken-xphb.md), [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Wisdom Saving Throw: DC 20, any enemy that starts its turn in a 30-foot\
    ...
    \ effects:\n\n- Captivated (Forager Only). The target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ condition until the end of its next turn. While [Charmed](z_Resources/CLI/rules/conditions.md#Charmed),\
    \ the target has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition.  \n- Fearful (Hunter Only). The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
...
- "desc": "The animal lord has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The animal lord conjures an animal spirit that strikes at a creature and\
    ...
    - Fortify (Forager Only). The animal lord gains 20 [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md).\
    \  \n- Marked as Prey (Hunter Only). The animal lord has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on attack rolls against the target until the start of the animal lord's next\
    \ turn.  \n- Pesky Swarm (Sage Only). The target has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "The animal lord shape-shifts into a Huge or smaller version of the animal\
  ...
  "name": "Shape-Shift"
"legendary_actions":
- "desc": "The animal lord moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
