...
---
# [Grimzod Gargenhale](z_Resources\CLI\bestiary\npc/grimzod-gargenhale-lox.md)
...
- "desc": "A ship upon which Grimzod stands, along with all creatures and objects\
    ...
    \ to maintain it (as if [concentrating](z_Resources/CLI/rules/conditions.md#Concentration)\
...
"source":
- "LoX"
"image": "z_Resources/CLI/bestiary/npc/token/grimzod-gargenhale-lox.webp"
```
^statblock