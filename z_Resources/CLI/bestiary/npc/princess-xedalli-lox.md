...
---
# [Princess Xedalli](z_Resources\CLI\bestiary\npc/princess-xedalli-lox.md)
...
- "desc": "Xedalli casts one of the following spells, using Intelligence as the spellcasting\
  ...
  "name": "Spellcasting"
- "desc": "Xedalli has advantage on saving throws it makes to avoid or end the [charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ condition on itself, and magic can't put it to sleep."
  "name": "Fey Ancestry"
- "desc": "Xedalli wears a suit of [elven chain](z_Resources/CLI/items/elven-chain-xdmg.md)."
...
- "desc": "Xedalli has a 50 percent chance of magically summoning a [young solar dragon](z_Resources/CLI/bestiary/dragon/young-solar-dragon-bam.md).\
...
"source":
- "LoX"
"image": "z_Resources/CLI/bestiary/npc/token/princess-xedalli-lox.webp"
```
^statblock