...
aliases: ["Big Momma"]
---
# [Big Momma](z_Resources\CLI\bestiary\npc/big-momma-lox.md)
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 45\
    ...
    \ is [blinded](z_Resources/CLI/rules/conditions.md#Blinded) and [restrained](z_Resources/CLI/rules/conditions.md#Restrained),\
    ...
    \ which falls [prone](z_Resources/CLI/rules/conditions.md#Prone) in a space within\
    \ 10 feet of Big Momma. If Big Momma dies, a swallowed creature is no longer [restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ by it and can escape from the corpse by using 10 feet of movement, exiting [prone](z_Resources/CLI/rules/conditions.md#Prone)."
  "name": "Swallowing Bite"
"bonus_actions":
- "desc": "Big Momma's eye emits an [invisible](z_Resources/CLI/rules/conditions.md#Invisible),\
    \ magical ray that targets one creature Big Momma can see within 60 feet of itself.\
    \ The target must succeed on a DC 16 Wisdom saving throw or be [frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    \ of Big Momma until the start of Big Momma's next turn."
  "name": "Ray of Fear (Recharge 4-6)"
"source":
- "LoX"
"image": "z_Resources/CLI/bestiary/npc/token/big-momma-lox.webp"
```
^statblock