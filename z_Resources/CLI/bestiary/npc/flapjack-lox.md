...
aliases: ["Flapjack"]
---
# [Flapjack](z_Resources\CLI\bestiary\npc/flapjack-lox.md)
...
- "desc": "Flapjack casts one of the following spells, requiring no material components\
    ...
    \ will: [mage hand](z_Resources/CLI/spells/mage-hand-xphb.md), [minor illusion](z_Resources/CLI/spells/minor-illusion-xphb.md)\n\
    \n1/day each: [magic missile](z_Resources/CLI/spells/magic-missile-xphb.md),\
    \ [unseen servant](z_Resources/CLI/spells/unseen-servant-xphb.md)"
  "name": "Spellcasting"
- "desc": "Flapjack can perceive the content of any telepathic communication used\
    \ within 60 feet of it, and it can't be [surprised](z_Resources/CLI/rules/conditions.md#Surprised)\
    \ by creatures with any form of telepathy."
  "name": "Advanced Telepathy"
- "desc": "If Flapjack is knocked [prone](z_Resources/CLI/rules/conditions.md#Prone),\
    \ roll a die. On an odd result, Flapjack lands upside-down and is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated).\
    \ At the end of each of its turns, Flapjack can make a DC 10 Dexterity saving\
    \ throw, righting itself and ending the [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ A [lesser restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md) spell\
...
- "desc": "Each creature in a 15-foot cone originating from Flapjack must succeed\
    ...
    \ is [poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) as long as the stench\
    \ lasts, and other creatures are [poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
...
"source":
- "LoX"
"image": "z_Resources/CLI/bestiary/npc/token/flapjack-lox.webp"
```
^statblock