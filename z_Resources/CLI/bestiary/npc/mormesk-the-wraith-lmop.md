...
---
# [Mormesk the Wraith](z_Resources\CLI\bestiary\npc/mormesk-the-wraith-lmop.md)
...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [grappled](z_Resources/CLI/rules/conditions.md#Grappled),\
...
- "desc": "While in sunlight, the wraith has disadvantage on attack rolls and on Wisdom\
    \ ([Perception](z_Resources/CLI/rules/skills.md#Perception)) checks that rely\
    \ on sight."
...
"source":
- "LMoP"
"image": "z_Resources/CLI/bestiary/npc/token/mormesk-the-wraith-lmop.webp"
```
^statblock