...
aliases: ["Agony"]
---
# [Agony](z_Resources\CLI\bestiary\npc/agony-lox.md)
...
- "desc": "Each non-undead creature within 60 feet of Agony that can see it must succeed\
    \ on a DC 13 Wisdom saving throw or be [frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    \ for 1 minute. If the save fails by 5 or more, the target also ages 1d4 × 10\
    \ years. A [frightened](z_Resources/CLI/rules/conditions.md#Frightened) target\
    \ can repeat the saving throw at the end of each of its turns, ending the [frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    ...
    \ for the next 24 hours. The aging effect can be reversed with a  [greater restoration](z_Resources/CLI/spells/greater-restoration-xphb.md)\
...
- "desc": "One humanoid that Agony can see within 5 feet of it must succeed on a DC\
    ...
    \ the target is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    ...
    \ Wisdom, Charisma, and immunity to being [charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ and [frightened](z_Resources/CLI/rules/conditions.md#Frightened). It otherwise\
    ...
    \ or forced out by an effect like the [dispel evil and good](z_Resources/CLI/spells/dispel-evil-and-good-xphb.md)\
...
"source":
- "LoX"
"image": "z_Resources/CLI/bestiary/npc/token/agony-lox.webp"
```
^statblock