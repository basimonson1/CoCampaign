...
- "desc": "The marid casts one of the following spells, requiring no Material components\
    ...
    \ [Create or Destroy Water](z_Resources/CLI/spells/create-or-destroy-water-xphb.md),\
    \ [Detect Evil and Good](z_Resources/CLI/spells/detect-evil-and-good-xphb.md),\
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Purify Food and\
    \ Drink](z_Resources/CLI/spells/purify-food-and-drink-xphb.md)\n\n1/day each:\
    \ [Control Water](z_Resources/CLI/spells/control-water-xphb.md), [Gaseous Form](z_Resources/CLI/spells/gaseous-form-xphb.md),\
    \ [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md),\
    \ [Tongues](z_Resources/CLI/spells/tongues-xphb.md)"
  "name": "Spellcasting"
- "desc": "The marid casts [Fog Cloud](z_Resources/CLI/spells/fog-cloud-xphb.md),\
...
- "desc": "The marid has a 30 percent chance of knowing the [Wish](z_Resources/CLI/spells/wish-xphb.md)\
...
- "desc": "Dexterity Saving Throw: DC 18, each creature in a 60-foot-long, 10-foot-wide\
    ...
    \ it is pushed up to 20 feet straight away from the marid and has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
