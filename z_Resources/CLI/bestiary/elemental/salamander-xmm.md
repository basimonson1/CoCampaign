...
- "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
    \ choice in a 5-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "Strength Saving Throw: DC 15, one Large or smaller creature the salamander\
    ...
    \ (2d6) Fire damage. The target has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
