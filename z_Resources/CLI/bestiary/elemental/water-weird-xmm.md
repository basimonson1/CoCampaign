...
"cr": "3"
"traits":
- "desc": "The water weird has the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible)\
...
- "desc": "Melee Attack: +5, reach 10 ft. Hit: 13 (3d6 + 3) Cold damage. If\
    \ the target is a Medium or smaller creature, it has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
