...
- "desc": "The mephit explodes when it dies. Constitution Saving Throw: DC 11, each\
    ...
    \ originating from the mephit. Failure: The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
...
- "desc": "Dexterity Saving Throw: DC 11, one creature the mephit can see within\
    \ 15 feet. Failure: The target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
