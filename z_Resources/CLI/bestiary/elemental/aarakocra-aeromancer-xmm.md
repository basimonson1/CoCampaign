...
- "desc": "The aarakocra casts one of the following spells, requiring no Material\
    ...
    \nAt will: [Elementalism](z_Resources/CLI/spells/elementalism-xphb.md), [Gust\
    \ of Wind](z_Resources/CLI/spells/gust-of-wind-xphb.md), [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md),\
    \ [Message](z_Resources/CLI/spells/message-xphb.md)\n\n1/day: [Lightning Bolt](z_Resources/CLI/spells/lightning-bolt-xphb.md)"
  "name": "Spellcasting"
- "desc": "The aarakocra casts [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md)\
    \ in response to that spell's trigger, using the same spellcasting ability as\
    \ Spellcasting.\n\n1/day: [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md)"
  "name": "Feather Fall (1/Day)"
"actions":
- "desc": "The aarakocra makes two Wind Staff attacks, and it can use Spellcasting\
    \ to cast [Gust of Wind](z_Resources/CLI/spells/gust-of-wind-xphb.md)."
  "name": "Multiattack"
