...
- "desc": "Melee Attack: +8, reach 5 ft. Hit: 12 (2d6 + 5) Bludgeoning damage.\
    ...
    \ Bludgeoning damage and has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Avalanche Slam"
- "desc": "The galeb duhr magically animates one or two boulders it can see within\
    ...
    \ its turn immediately after the galeb duhr on the same [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md)\
