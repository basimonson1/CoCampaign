...
- "desc": "The efreeti casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Elementalism](z_Resources/CLI/spells/elementalism-xphb.md)\n\
    ...
    \ [Wall of Fire](z_Resources/CLI/spells/wall-of-fire-xphb.md) (level 7 version)"
  "name": "Spellcasting"
...
- "desc": "The efreeti has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "The efreeti has a 30 percent chance of knowing the [Wish](z_Resources/CLI/spells/wish-xphb.md)\
