...
"saves":
  "Dexterity": !!int "5"
  "Wisdom": !!int "5"
"condition_immunities": "[petrified](z_Resources/CLI/rules/conditions.md#Petrified)"
...
- "desc": "The dao casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Stone Shape](z_Resources/CLI/spells/stone-shape-xphb.md)\n\
    \n1/day each: [Gaseous Form](z_Resources/CLI/spells/gaseous-form-xphb.md),\
    \ [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md), [Move Earth](z_Resources/CLI/spells/move-earth-xphb.md),\
    \ [Passwall](z_Resources/CLI/spells/passwall-xphb.md), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md),\
    \ [Tongues](z_Resources/CLI/spells/tongues-xphb.md), [Wall of Stone](z_Resources/CLI/spells/wall-of-stone-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The dao has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "The dao has a 30 percent chance of knowing the [Wish](z_Resources/CLI/spells/wish-xphb.md)\
...
- "desc": "Melee Attack: +10, reach 5 ft. Hit: 20 (4d6 + 6) Bludgeoning damage.\
    ...
    \ condition."
  "name": "Earthen Maul"
- "desc": "Ranged Attack: +10, range 120 ft. Hit: 15 (2d8 + 6) Bludgeoning\
