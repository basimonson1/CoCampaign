...
- "desc": "At the end of each of the elemental's turns, each creature in a 10-foot\
    ...
    \ objects in the [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ start burning."
  "name": "Fire Aura"
- "desc": "The elemental can move through a space as narrow as 1 inch without expending\
    ...
    \ (1d10) Fire damage."
  "name": "Fire Form"
- "desc": "The elemental sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md)\
    \ in a 30- foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
