...
- "desc": "Melee Attack: +6, reach 5 ft. Hit: 8 (1d10 + 3) Slashing damage."
  "name": "Claw"
"bonus_actions":
- "desc": "The xorn moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ or [Burrow Speed](z_Resources/CLI/rules/variant-rules/burrow-speed-xphb.md)\
