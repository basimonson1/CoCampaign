...
- "desc": "The mephit explodes when it dies. Dexterity Saving Throw: DC 11, each\
    ...
    \ originating from the mephit. Failure: The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Dexterity Saving Throw: DC 11, one creature the mephit can see within\
    \ 15 feet. Failure: The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
