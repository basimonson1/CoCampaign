...
- "desc": "The djinni casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md)\n\n1/day each:\
    \ [Creation](z_Resources/CLI/spells/creation-xphb.md), [Gaseous Form](z_Resources/CLI/spells/gaseous-form-xphb.md),\
    \ [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md), [Major Image](z_Resources/CLI/spells/major-image-xphb.md),\
    \ [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md)\n\n2/day each:\
    \ [Create Food and Water](z_Resources/CLI/spells/create-food-and-water-xphb.md)\
    \ (can create wine instead of water), [Tongues](z_Resources/CLI/spells/tongues-xphb.md),\
    \ [Wind Walk](z_Resources/CLI/spells/wind-walk-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the djinni dies outside the Elemental Plane of Air, its body dissolves\
    ...
    \ Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) somewhere on\
    \ the Plane of Air."
  "name": "Elemental Restoration"
- "desc": "The djinni has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "The djinni has a 30 percent chance of knowing the [Wish](z_Resources/CLI/spells/wish-xphb.md)\
...
- "desc": "Ranged Attack: +9, range 120 feet. Hit: 13 (3d8) Thunder damage.\
    \ If the target is a Large or smaller creature, it has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Storm Bolt"
- "desc": "The djinni conjures a whirlwind at a point it can see within 120 feet.\
    \ The whirlwind fills a 20-foot-radius, 60-foot-high [Cylinder [Area of Effect]](z_Resources/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md)\
    \ centered on that point. The whirlwind lasts until the djinni's [Concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
    ...
    \ has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained) condition\
    \ and moves with the whirlwind. At the start of each of its turns, the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
