...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 8 (1d10 + 3) Piercing damage.\
    ...
    \ gains [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md)\
...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 10 (2d6 + 3) Bludgeoning damage.\
  ...
  "name": "Earthen Maul"
"bonus_actions":
- "desc": "The lizardfolk moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ or [Swim Speed](z_Resources/CLI/rules/variant-rules/swim-speed-xphb.md) straight\
