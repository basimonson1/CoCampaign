...
"cr": "5"
"traits":
- "desc": "If the elemental takes Cold damage, its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
...
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 13 (2d8 + 4) Bludgeoning damage.\
    \ If the target is a Medium or smaller creature, it has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Slam"
- "desc": "Strength Saving Throw: DC 15, each creature in the elemental's space.\
    ...
    \ creature, it has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC 14). Until the grapple ends, the target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    ...
    \ out of it by succeeding on a DC 14 Strength ([Athletics](z_Resources/CLI/rules/skills.md#Athletics))\
