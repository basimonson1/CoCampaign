...
"condition_immunities": "[blinded](z_Resources/CLI/rules/conditions.md#Blinded), [charmed](z_Resources/CLI/rules/conditions.md#Charmed),\
  \ [deafened](z_Resources/CLI/rules/conditions.md#Deafened), [exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion),\
...
"cr": "22"
"traits":
- "desc": "The cataclysm casts the [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md)\
    \ spell, requiring no spell components and using Constitution as the spellcasting\
    \ ability.\n\nAt will: [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md)"
...
- "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
    ...
    \ 60-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md)\
    ...
    \ in a 90-foot [Cone [Area of Effect]](z_Resources/CLI/rules/variant-rules/cone-area-of-effect-xphb.md).\
    \ Failure: 22 (5d8) Bludgeoning damage plus 22 (5d8) Cold damage, and the\
    \ target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition.\
    \ Success: Half damage only. Failure or Success: The target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ is reduced to 0 until the end of its next turn.  \n- 3 Raging Storm. A storm\
    \ cloud fills a 60-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md)\
    ...
    \ in the cloud have the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
    \ and [Deafened](z_Resources/CLI/rules/conditions.md#Deafened) conditions and\
    ...
    \ DC 23, each creature in a 90-foot [Cube [Area of Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
    \ originating from a point on the ground within 150 feet. Failure: 18 (4d8)\
    \ Bludgeoning damage plus 18 (4d8) Acid damage, and the target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition and is buried under rubble. A buried target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition, has [Cover](z_Resources/CLI/rules/variant-rules/cover-xphb.md), and\
    \ is suffocating. As an action, a buried creature or another creature within 5\
    \ feet of it can make a DC 18 Strength ([Athletics](z_Resources/CLI/rules/skills.md#Athletics))\
...
- "desc": "The cataclysm makes one Elemental Burst attack."
  "name": "Eruption"
- "desc": "The cataclysm moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
    \ [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md), or [Swim\
    \ Speed](z_Resources/CLI/rules/variant-rules/swim-speed-xphb.md) without provoking\
    ...
    \ Failure: The target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
