...
- "desc": "The lizardfolk casts one of the following spells, requiring no Material\
    ...
    \nAt will: [Elementalism](z_Resources/CLI/spells/elementalism-xphb.md)\n\n\
    1/day each: [Meld into Stone](z_Resources/CLI/spells/meld-into-stone-xphb.md),\
    \ [Speak with Plants](z_Resources/CLI/spells/speak-with-plants-xphb.md), [Spike\
    \ Growth](z_Resources/CLI/spells/spike-growth-xphb.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "Constitution Saving Throw: DC 12, each creature in a 20-foot-radius,\
    \ 40-foot-high [Cylinder [Area of Effect]](z_Resources/CLI/rules/variant-rules/cylinder-area-of-effect-xphb.md)\
    \ centered on a point the lizardfolk can see within 60 feet. Failure: 15 (6d4)\
    \ Bludgeoning damage, and the target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
