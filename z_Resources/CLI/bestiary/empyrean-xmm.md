...
- "desc": "The empyrean casts one of the following spells, requiring no Material components\
    ...
    \ [Calm Emotions](z_Resources/CLI/spells/calm-emotions-xphb.md), [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md),\
    \ [Pass without Trace](z_Resources/CLI/spells/pass-without-trace-xphb.md), [Water\
    \ Breathing](z_Resources/CLI/spells/water-breathing-xphb.md)\n\n1/day each:\
    \ [Commune](z_Resources/CLI/spells/commune-xphb.md), [Dispel Evil and Good](z_Resources/CLI/spells/dispel-evil-and-good-xphb.md),\
...
- "desc": "The empyrean has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The empyrean makes two attacks, using Sacred Weapon or Divine Ray in any\
    \ combination."
  "name": "Multiattack"
- "desc": "Melee Attack: +17, reach 10 ft. Hit: 31 (6d6 + 10) Force damage,\
    \ and the target has the [Stunned](z_Resources/CLI/rules/conditions.md#Stunned)\
    \ condition until the start of the empyrean's next turn. The target can choose\
    \ not to be [Stunned](z_Resources/CLI/rules/conditions.md#Stunned), in which case\
    \ it takes an extra 21 Force damage that bypasses [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md)\
    \ or [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md)."
  "name": "Sacred Weapon"
- "desc": "Ranged Attack: +15, range 600 ft. Hit: 35 (6d8 + 8) Necrotic or\
    \ Radiant damage (empyrean's choice)."
  "name": "Divine Ray"
"legendary_actions":
- "desc": "The empyrean gains 10 [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md),\
    \ and the empyrean and each ally within 30 feet of it gain [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md) until the\
