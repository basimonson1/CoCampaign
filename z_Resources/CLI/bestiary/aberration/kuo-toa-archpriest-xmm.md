...
- "desc": "The kuo-toa casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\
    \n1/day each: [Destructive Wave](z_Resources/CLI/spells/destructive-wave-xphb.md),\
    \ [Divination](z_Resources/CLI/spells/divination-xphb.md), [Hold Monster](z_Resources/CLI/spells/hold-monster-xphb.md)\
    \ (level 6 version), [Scrying](z_Resources/CLI/spells/scrying-xphb.md), [Tongues](z_Resources/CLI/spells/tongues-xphb.md)"
  "name": "Spellcasting"
- "desc": "The kuo-toa casts [Shield of Faith](z_Resources/CLI/spells/shield-of-faith-xphb.md),\
