...
aliases: ["Esthetic"]
---
# [Esthetic](z_Resources\CLI\bestiary\aberration/esthetic-bam.md)
...
"condition_immunities": "[blinded](z_Resources/CLI/rules/conditions.md#Blinded), [charmed](z_Resources/CLI/rules/conditions.md#Charmed),\
  ...
  \ [frightened](z_Resources/CLI/rules/conditions.md#Frightened), [petrified](z_Resources/CLI/rules/conditions.md#Petrified),\
...
- "desc": "Melee Weapon Attack: +11 to hit, reach 30 ft., one target. Hit: 17\
    \ (3d6 + 7) force damage, and if the target is a creature, it is [grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/aberration/token/esthetic-bam.webp"
```
^statblock