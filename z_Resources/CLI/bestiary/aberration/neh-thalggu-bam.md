...
aliases: ["Neh-thalggu"]
---
# [Neh-thalggu](z_Resources\CLI\bestiary\aberration/neh-thalggu-bam.md)
...
- "desc": "The neh-thalggu casts one of the following spells, requiring no spell components\
    ...
    \n1/day each: [arms of Hadar](z_Resources/CLI/spells/arms-of-hadar-xphb.md)\
    \ (1 brain), [detect magic](z_Resources/CLI/spells/detect-magic-xphb.md) (2 brains),\
    \ [magic missile](z_Resources/CLI/spells/magic-missile-xphb.md) (3 brains), [Tenser's\
    \ floating disk](z_Resources/CLI/spells/tensers-floating-disk-xphb.md) (4 brains),\
    \ [darkness](z_Resources/CLI/spells/darkness-xphb.md) (5 brains), [hold person](z_Resources/CLI/spells/hold-person-xphb.md)\
    \ (6 brains), [invisibility](z_Resources/CLI/spells/invisibility-xphb.md) (7 brains),\
    \ [spider climb](z_Resources/CLI/spells/spider-climb-xphb.md) (8 brains), [fear](z_Resources/CLI/spells/fear-xphb.md)\
    \ (9 brains), [hypnotic pattern](z_Resources/CLI/spells/hypnotic-pattern-xphb.md)\
    \ (10 brains), [major image](z_Resources/CLI/spells/major-image-xphb.md) (11 brains),\
    \ [stinking cloud](z_Resources/CLI/spells/stinking-cloud-xphb.md) (12 brains)"
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 4 (1d4\
    \ + 2) slashing damage."
  "name": "Claw"
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
...
- "desc": "The neh-thalggu magically emits psychic energy at one Humanoid it can see\
    ...
    \ On a failed save, the target takes 9 (2d8) psychic damage and is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ until the end of its next turn. On a successful save, the target takes half\
    \ as much damage and isn't [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)."
  "name": "Mind Blast (Recharge 5-6)"
"source":
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/aberration/token/neh-thalggu-bam.webp"
```
^statblock