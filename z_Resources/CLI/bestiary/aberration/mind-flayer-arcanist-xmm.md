...
- "desc": "The mind flayer casts one of the following spells, requiring no spell components\
    ...
    \ will: [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Detect\
    \ Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md),\
    \ [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md) (the hand is Invisible)\n\
    \n1/day each: [Clairvoyance](z_Resources/CLI/spells/clairvoyance-xphb.md),\
    \ [Dimension Door](z_Resources/CLI/spells/dimension-door-xphb.md), [Fireball](z_Resources/CLI/spells/fireball-xphb.md)\
    \ (level 5 version), [Lightning Bolt](z_Resources/CLI/spells/lightning-bolt-xphb.md)\
    \ (level 5 version), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md)\
    \ (self only), [Sending](z_Resources/CLI/spells/sending-xphb.md)"
  "name": "Spellcasting"
- "desc": "The mind flayer casts [Shield](z_Resources/CLI/spells/shield-xphb.md) in\
    \ response to that spell's trigger, using the same spellcasting ability as Spellcasting.\n\
    \n2/day: [Shield](z_Resources/CLI/spells/shield-xphb.md)"
  "name": "Shield (2/Day)"
- "desc": "The mind flayer has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee or Ranged Attack: +9, reach 5 ft. or range 120 ft. Hit: 27\
    ...
    \ Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md), the mind flayer\
