...
- "desc": "The githyanki casts one of the following spells, requiring no spell components\
    ...
    \ will: [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md) (the hand is Invisible)\n\
    \n1/day each: [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md), [Telekinesis](z_Resources/CLI/spells/telekinesis-xphb.md)\n\
    \n2/day each: [Nondetection](z_Resources/CLI/spells/nondetection-xphb.md)\
    \ (self only), [Tongues](z_Resources/CLI/spells/tongues-xphb.md)"
  "name": "Spellcasting"
- "desc": "The githyanki casts [Misty Step](z_Resources/CLI/spells/misty-step-xphb.md),\
    \ requiring no spell components and using the same spellcasting ability as Spellcasting.\n\
    \n2/day: [Misty Step](z_Resources/CLI/spells/misty-step-xphb.md)"
  "name": "Misty Step (2/Day)"
"actions":
- "desc": "The githyanki makes three Silver Sword attacks. It can replace one attack\
    \ with a use of Spellcasting to cast [Telekinesis](z_Resources/CLI/spells/telekinesis-xphb.md)\
    \ if available."
  "name": "Multiattack"
- "desc": "Melee Attack: +6, reach 5 ft. Hit: 10 (2d6 + 3) Slashing damage\
    ...
    \ body (as with the [Astral Projection](z_Resources/CLI/spells/astral-projection-xphb.md)\
