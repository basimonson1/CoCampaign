...
- "desc": "The mind flayer casts one of the following spells, requiring no spell components\
    ...
    \ will: [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md)\n\n\
...
"actions":
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 22 (4d8 + 4) Psychic damage.\
    ...
    \ the grapple ends."
  "name": "Tentacles"
- "desc": "Constitution Saving Throw: DC 15, one creature that is [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "desc": "Intelligence Saving Throw: DC 15, each creature in a 60-foot [Cone [Area\
    ...
    \ Failure: 31 (6d8 + 4) Psychic damage, and the target has the [Stunned](z_Resources/CLI/rules/conditions.md#Stunned)\
