...
- "desc": "The slaad casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md)\n\
    \n1/day each: [Fireball](z_Resources/CLI/spells/fireball-xphb.md), [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
    \ (self only)"
  "name": "Spellcasting"
...
- "desc": "Melee or Ranged Attack: +7, reach 10 ft. or range 60 ft. Hit: 8 (1d8\
    ...
    \ a condition determined by rolling 1d4: on a 1, [Charmed](z_Resources/CLI/rules/conditions.md#Charmed);\
