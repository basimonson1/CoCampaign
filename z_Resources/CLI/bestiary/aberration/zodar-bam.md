...
aliases: ["Zodar"]
---
# [Zodar](z_Resources\CLI\bestiary\aberration/zodar-bam.md)
...
"cr": "16"
"traits":
- "desc": "The zodar casts the [wish](z_Resources/CLI/spells/wish-xphb.md) spell,\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/aberration/token/zodar-bam.webp"
```
^statblock