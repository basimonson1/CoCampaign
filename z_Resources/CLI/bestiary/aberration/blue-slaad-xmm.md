...
- "desc": "Melee Attack: +8, reach 10 ft. Hit: 12 (2d6 + 5) Slashing damage\
    ...
    \ Failure: The target is cursed. The cursed target can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    ...
    \ after finishing a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md).\
    \ If the curse reduces the target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum to 0, the curse ends, and instead of dying, the target instantly transforms\
    \ into a [Red Slaad](z_Resources/CLI/bestiary/aberration/red-slaad-xmm.md) or,\
    \ if it can cast spells of level 3 or higher, a [Green Slaad](z_Resources/CLI/bestiary/aberration/green-slaad-xmm.md).\
    \ Only a [Wish](z_Resources/CLI/spells/wish-xphb.md) spell can reverse this transformation."
  "name": "Mutating Claw"
"source":
- "XMM"
```
