...
"cr": "8"
"traits":
- "desc": "The cloaker casts the [Mirror Image](z_Resources/CLI/spells/mirror-image-xphb.md)\
    \ spell, requiring no spell components and using Wisdom as the spellcasting ability.\
    \ The spell ends early if the cloaker starts or ends its turn in [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md).\n\
    \nAt will: [Mirror Image](z_Resources/CLI/spells/mirror-image-xphb.md)"
  "name": "Phantasms (Recharge after a Short or Long Rest)"
- "desc": "While in [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md),\
    \ the cloaker has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on attack rolls."
...
- "desc": "Melee Attack: +6, reach 5 ft. Hit: 13 (3d6 + 3) Piercing damage.\
    ...
    \ the cloaker is attached, the target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
    ...
    \ ([Athletics](z_Resources/CLI/rules/skills.md#Athletics)) check."
  "name": "Attach"
...
- "desc": "Wisdom Saving Throw: DC 13, each creature in a 60-foot [Emanation [Area\
    ...
    \ originating from the cloaker. Failure: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
