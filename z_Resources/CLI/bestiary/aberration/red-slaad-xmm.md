...
- "desc": "Melee Attack: +6, reach 10 ft. Hit: 10 (2d6 + 3) Piercing damage.\
    ...
    \ cursed target feels unwell; its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ is halved, and it has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md). At the\
