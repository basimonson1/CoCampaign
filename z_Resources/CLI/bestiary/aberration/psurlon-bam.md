...
aliases: ["Psurlon"]
---
# [Psurlon](z_Resources\CLI\bestiary\aberration/psurlon-bam.md)
...
- "desc": "The psurlon casts one of the following spells, requiring no spell components\
    ...
    \ self](z_Resources/CLI/spells/disguise-self-xphb.md), [mage armor](z_Resources/CLI/spells/mage-armor-xphb.md)\
    \ (self only)"
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/aberration/token/psurlon-bam.webp"
```
^statblock