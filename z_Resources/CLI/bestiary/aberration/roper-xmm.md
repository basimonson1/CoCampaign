...
| 3 | "dead magic zone" or [Wild Magic zones](z_Resources/CLI/traps-hazards/wild-magic-zone-xdmg.md). |
...
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 17 (3d8 + 4) Piercing damage."
  "name": "Bite"
- "desc": "Melee Attack: +7, reach 60 ft. Hit: The target has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC 14) from one of six tentacles, and the target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition until the grapple ends.\n\nThe tentacle can be damaged, freeing a\
    \ creature it has [Grappled](z_Resources/CLI/rules/conditions.md#Grappled) when\
    \ destroyed (AC 20, HP 10, [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md)\
  ...
  "name": "Tentacle"
- "desc": "The roper pulls each creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
