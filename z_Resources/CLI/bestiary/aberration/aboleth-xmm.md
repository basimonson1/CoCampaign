...
- "desc": "If destroyed, the aboleth gains a new body in 5d10 days, reviving with\
    \ all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "While underwater, the aboleth is surrounded by mucus. Constitution Saving\
    \ Throw: DC 14, each creature in a 5-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    \ target can breathe air and water, and it can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Melee Attack: +9, reach 15 ft. Hit: 12 (2d6 + 5) Bludgeoning damage.\
    \ If the target is a Large or smaller creature, it has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "desc": "Intelligence Saving Throw: DC 16, one creature within 30 feet that is\
    \ [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) or [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    ...
    \ is a Humanoid and is reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ by this action."
  "name": "Consume Memories"
- "desc": "Wisdom Saving Throw: DC 16, one creature the aboleth can see within 30\
    \ feet. Failure: The target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ condition until the aboleth dies or is on a different plane of existence from\
    \ the target. While [Charmed](z_Resources/CLI/rules/conditions.md#Charmed), the\
...
- "desc": "The aboleth makes one Tentacle attack."
  "name": "Lash"
- "desc": "If the aboleth has at least one creature [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ or [Grappled](z_Resources/CLI/rules/conditions.md#Grappled), it uses Consume\
    \ Memories and regains 5 (1d10) [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
  "name": "Psychic Drain"
"regional_effects":
...
- "desc": "- Foul Water. Water sources within 1 mile of the lair are supernaturally\
    ...
    \ must succeed on a DC 15 Constitution saving throw or have the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition for 1 hour.  \n- Psionic Projection. While in its lair, the aboleth\
    \ can cast [Project Image](z_Resources/CLI/spells/project-image-xphb.md), requiring\
