...
- "desc": "The chuul senses magic within 120 feet of itself. This trait otherwise\
    \ works like the [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md) spell\
...
- "desc": "Melee Attack: +6, reach 10 ft. Hit: 9 (1d10 + 4) Bludgeoning damage.\
  ...
  "name": "Pincer"
- "desc": "Constitution Saving Throw: DC 13, one creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ by the chuul. Failure: The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition and repeats the save at the end of each of its turns, ending the effect\
    \ on itself on a success. After 1 minute, it succeeds automatically. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
