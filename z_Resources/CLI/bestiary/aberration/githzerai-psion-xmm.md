...
- "desc": "The githzerai casts one of the following spells, requiring no spell components\
    ...
    \n1/day each: [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md), [See\
    \ Invisibility](z_Resources/CLI/spells/see-invisibility-xphb.md)"
  "name": "Spellcasting"
- "desc": "The githzerai casts [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md)\
    ...
    \ as Spellcasting.\n\nAt will: [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md),\
...
- "desc": "Melee or Ranged Attack: +8, reach 5 ft. or range 120 ft. Hit: 26\
    ...
    \ the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition until the\
    \ start of the githzerai's next turn or (B) the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
