...
- "desc": "The githzerai casts one of the following spells, requiring no spell components\
    ...
    \n1/day each: [Phantasmal Killer](z_Resources/CLI/spells/phantasmal-killer-xphb.md)\
    \ (level 6 version), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md),\
    \ [See Invisibility](z_Resources/CLI/spells/see-invisibility-xphb.md)"
  "name": "Spellcasting"
- "desc": "The githzerai casts [Jump](z_Resources/CLI/spells/jump-xphb.md), requiring\
    \ no spell components and using the same spellcasting ability as Spellcasting.\n\
    \n2/day: [Jump](z_Resources/CLI/spells/jump-xphb.md)"
...
- "desc": "The githzerai casts [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md)\
    ...
    \ as Spellcasting.\n\n2/day: [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md),\
