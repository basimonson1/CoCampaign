...
---
# [Aberrant Spirit](z_Resources\CLI\bestiary\aberration/aberrant-spirit-xphb.md)
...
- "desc": "At the start of each of the spirit's turns, the spirit emits psionic energy\
    \ if it doesn't have the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
...
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/aberration/token/aberrant-spirit-xphb.webp"
```
^statblock