...
Beholders are a particular threat to adventurers because both gravitate toward mysterious ruins and sites of great magic. Many beholders collect the magic items and [petrified](z_Resources/CLI/rules/conditions.md#Petrified) bodies of heroes they've defeated, displaying them as trophies.
...
"skillsaves":
  "Perception": !!int "12"
"condition_immunities": "[prone](z_Resources/CLI/rules/conditions.md#Prone)"
...
- "desc": "The beholder randomly shoots one of the following magical rays at a target\
    ...
    \ [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition for 1 hour\
    \ or until it takes damage. Success: Half damage only.  \n- 2 Paralyzing Ray.\
    \ Constitution Saving Throw: DC 16. Failure: The target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    \ condition and repeats the save at the end of each of its turns, ending the effect\
    \ on itself on a success. After 1 minute, it succeeds automatically.  \n- 3\
    \ Fear Ray. Wisdom Saving Throw: DC 16. Failure: 14 (4d6) Psychic damage,\
    \ and the target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    ...
    \ Necrotic damage. Until the end of the target's next turn, the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ is halved; the target can't take Reactions; and it can take either an action\
    \ or a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md)\
    \ on its turn, not both. Success: Half damage only.  \n- 5 Enervation Ray.\
    \ Constitution Saving Throw: DC 16. Failure: 13 (3d8) Poison damage, and\
    \ the target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition until the end of its next turn. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
    \ the target can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
    ...
    \ [Restrained](z_Resources/CLI/rules/conditions.md#Restrained) condition until\
    \ the start of the beholder's next turn or until the beholder has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    ...
    \ or an Undead). Failure: The target has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious)\
    ...
    \ Constitution Saving Throw: DC 16. {@actSaveFail 1} The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition and repeats the save at the end of its next turn if it is still [Restrained](z_Resources/CLI/rules/conditions.md#Restrained),\
    \ ending the effect on itself on a success. {@actSaveFail 2} The target has the\
    \ [Petrified](z_Resources/CLI/rules/conditions.md#Petrified) condition instead\
    \ of the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained) condition.\
    ...
    \ magical force, a 10- foot [Cube [Area of Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
    \ of it disintegrates into dust. Success: Half damage. Failure or Success:\
    \ If the target is a creature and this damage reduces it to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    ...
    \ or Success: The target dies if the ray reduces it to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
    \  "
  "name": "Eye Rays"
"bonus_actions":
- "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone\
    \ [Area of Effect]](z_Resources/CLI/rules/variant-rules/cone-area-of-effect-xphb.md).\
    \ Until the start of the beholder's next turn, that area acts as an [Antimagic\
    \ Field](z_Resources/CLI/spells/antimagic-field-xphb.md) spell, and that area\
...
- "desc": "- Scopophobia. Creatures within 1 mile of the lair feel as if they're\
    ...
    \ a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md) while\
    ...
    \ the lair that makes a [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md)\
    \ and rolls a 1 has the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition.\
    \  "
  "name": ""
