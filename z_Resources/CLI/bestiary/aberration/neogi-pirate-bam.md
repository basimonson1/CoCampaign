...
---
# [Neogi Pirate](z_Resources\CLI\bestiary\aberration/neogi-pirate-bam.md)
...
"ac": !!int "16"
"ac_class": "[breastplate](z_Resources/CLI/items/breastplate-xphb.md)"
"hp": !!int "33"
"hit_dice": "6d6 + 12"
"stats":
- !!int "6"
...
"cr": "3"
"traits":
- "desc": "The neogi has advantage on saving throws against being [charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ or [frightened](z_Resources/CLI/rules/conditions.md#Frightened), and magic can't\
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    ...
    \ on a DC 12 Constitution saving throw or become [poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/aberration/token/neogi-pirate-bam.webp"
```
^statblock