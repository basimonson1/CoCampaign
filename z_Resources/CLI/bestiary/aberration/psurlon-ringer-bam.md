...
---
# [Psurlon Ringer](z_Resources\CLI\bestiary\aberration/psurlon-ringer-bam.md)
...
- "desc": "The psurlon casts one of the following spells, requiring no spell components\
    ...
    \ armor](z_Resources/CLI/spells/mage-armor-xphb.md) (self only)"
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/aberration/token/psurlon-ringer-bam.webp"
```
^statblock