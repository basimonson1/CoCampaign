...
- "desc": "Intelligence Saving Throw: DC 12, one Small or Medium creature within\
    \ 5 feet that has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition, is a Humanoid or Beast, and has 10 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ [Cover](z_Resources/CLI/rules/variant-rules/cover-xphb.md) against attacks and\
    ...
    \ is also forced out if the target regains its devoured brain by means of a [Wish](z_Resources/CLI/spells/wish-xphb.md)\
