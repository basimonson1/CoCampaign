...
"cr": "1/8"
"traits":
- "desc": "The hawk has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 4 (1d4 + 2) Piercing damage,\
    \ or 6 (1d8 + 2) Piercing damage if the target is [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)."
  "name": "Beak"
"source":
- "XMM"
```
