...
- "desc": "Trigger: A creature ends its turn within 5 feet of the octopus while underwater.\
    \ Response: The octopus releases ink that fills a 5-foot [Cube [Area of Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
...
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/octopus-xmm.webp"
```
^statblock
