...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 9 (2d6 + 2) Bludgeoning damage,\
  ...
  "name": "Ram"
"bonus_actions":
- "desc": "While underwater, the seahorse moves up to half its [Swim Speed](z_Resources/CLI/rules/variant-rules/swim-speed-xphb.md)\
    \ without provoking Opportunity Attacks."
  "name": "Bubble Dash"
"source":
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/giant-seahorse-xmm.webp"
```
^statblock
