...
---
# [Beast of the Sea](z_Resources\CLI\bestiary\beast/beast-of-the-sea-xphb.md)
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ damage (your choice when you summon the beast), and the target has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC equals your spell save DC)."
  "name": "Beast's Strike"
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/beast-of-the-sea-xphb.webp"
```
^statblock