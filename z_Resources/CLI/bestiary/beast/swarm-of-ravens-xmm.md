...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 5 (1d6 + 2) Piercing damage,\
    \ or 2 (1d4) Piercing damage if the swarm is [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)."
  "name": "Beaks"
- "desc": "Wisdom Saving Throw: DC 10, one creature in the swarm's space. Failure:\
    \ The target has the [Deafened](z_Resources/CLI/rules/conditions.md#Deafened)\
    \ condition until the start of the swarm's next turn. While [Deafened](z_Resources/CLI/rules/conditions.md#Deafened),\
    \ the target also has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
