...
---
# [Giant Insect](z_Resources\CLI\bestiary\beast/giant-insect-xphb.md)
...
- "desc": "Constitution Saving Throw: Your spell save DC, one creature the insect\
    \ can see within 10 feet. Failure: The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition until the start of the insect's next turn."
  "name": "Venomous Spew (Centipede Only)"
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/giant-insect-xphb.webp"
```
^statblock