...
---
# [Beast of the Land](z_Resources\CLI\bestiary\beast/beast-of-the-land-xphb.md)
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ an extra 1d6 damage of the same type, and the target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition if it is a Large or smaller creature."
  "name": "Beast's Strike"
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/beast-of-the-land-xphb.webp"
```
^statblock