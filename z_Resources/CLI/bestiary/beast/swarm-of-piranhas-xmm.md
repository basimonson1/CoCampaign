...
- "desc": "Melee Attack: +5 (with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ if the target doesn't have all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)),\
    \ reach 5 ft. Hit: 8 (2d4 + 3) Piercing damage, or 5 (1d4 + 3) Piercing\
    \ damage if the swarm is [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)."
  "name": "Bites"
"source":
- "XMM"
```
