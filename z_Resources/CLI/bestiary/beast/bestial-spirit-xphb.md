...
---
# [Bestial Spirit](z_Resources\CLI\bestiary\beast/bestial-spirit-xphb.md)
...
- "desc": "The spirit has Advantage on an attack roll against a creature if at least\
    ...
    \ have the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition."
...
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/bestial-spirit-xphb.webp"
```
^statblock