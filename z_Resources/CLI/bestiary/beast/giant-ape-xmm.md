...
- "desc": "The ape hurls a boulder at a point it can see within 90 feet. Dexterity\
    \ Saving Throw: DC 17, each creature in a 5-foot-radius [Sphere [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md)\
    \ centered on that point. Failure: 24 (7d6) Bludgeoning damage. If the target\
    \ is a Large or smaller creature, it has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
