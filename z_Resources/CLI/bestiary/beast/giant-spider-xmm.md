...
- "desc": "Dexterity Saving Throw: DC 13, one creature the spider can see within\
    \ 60 feet. Failure: The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/beast/token/giant-spider-xmm.webp"
```
^statblock
