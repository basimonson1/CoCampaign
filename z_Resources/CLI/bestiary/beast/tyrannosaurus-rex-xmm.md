...
- "desc": "Melee Attack: +10, reach 10 ft. Hit: 33 (4d12 + 7) Piercing damage.\
    ...
    \ condition (escape DC 17). While [Grappled](z_Resources/CLI/rules/conditions.md#Grappled),\
...
- "desc": "Melee Attack: +10, reach 15 ft. Hit: 25 (4d8 + 7) Bludgeoning damage.\
    \ If the target is a Huge or smaller creature, it has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Tail"
"source":
- "XMM"
