...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Fear](z_Resources/CLI/spells/fear-xphb.md), [Melf's Acid Arrow](z_Resources/CLI/spells/melfs-acid-arrow-xphb.md)\
    \ (level 4 version)\n\n1/day each: [Create Undead](z_Resources/CLI/spells/create-undead-xphb.md),\
    \ [Speak with Dead](z_Resources/CLI/spells/speak-with-dead-xphb.md), [Vitriolic\
    \ Sphere](z_Resources/CLI/spells/vitriolic-sphere-xphb.md) (level 5 version)"
  "name": "Spellcasting"
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of Spellcasting to cast [Melf's Acid Arrow](z_Resources/CLI/spells/melfs-acid-arrow-xphb.md)\
    \ (level 4 version)."
  "name": "Multiattack"
...
- "desc": "Dexterity Saving Throw: DC 21, one creature the dragon can see within\
    \ 120 feet. Failure: 33 (6d10) Poison damage, and the target has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on saving throws to maintain [Concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
...
- "desc": "The dragon uses Spellcasting to cast [Fear](z_Resources/CLI/spells/fear-xphb.md).\
...
- "desc": "- Acrid Haze. Odorous and stifling fog covers the area within 1 mile\
    \ of the lair, rendering that area [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md).\
    ...
    \ a DC 15 Constitution saving throw or have the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
