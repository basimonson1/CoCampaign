...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Guiding Bolt](z_Resources/CLI/spells/guiding-bolt-xphb.md) (level 2 version),\
    ...
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Control\
    \ Water](z_Resources/CLI/spells/control-water-xphb.md), [Scrying](z_Resources/CLI/spells/scrying-xphb.md),\
    \ [Water Breathing](z_Resources/CLI/spells/water-breathing-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of (A) Repulsion Breath or (B) Spellcasting to cast [Guiding Bolt](z_Resources/CLI/spells/guiding-bolt-xphb.md)\
    \ (level 2 version)."
  "name": "Multiattack"
...
- "desc": "Strength Saving Throw: DC 23, each creature in a 30-foot [Cone [Area\
    ...
    \ and has the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition."
  "name": "Repulsion Breath"
"legendary_actions":
- "desc": "The dragon uses Spellcasting to cast [Guiding Bolt](z_Resources/CLI/spells/guiding-bolt-xphb.md)\
    \ (level 2 version)."
  "name": "Guiding Light"
...
- "desc": "Constitution Saving Throw: DC 22, each creature in a 20-foot-radius [Sphere\
    \ [Area of Effect]](z_Resources/CLI/rules/variant-rules/sphere-area-of-effect-xphb.md)\
    \ centered on a point the dragon can see within 120 feet. Failure: 13 (3d8)\
    \ Thunder damage, and the target has the [Deafened](z_Resources/CLI/rules/conditions.md#Deafened)\
...
- "desc": "- Buoying Currents. Creatures within 1 mile of the lair that lack a\
    \ [Swim Speed](z_Resources/CLI/rules/variant-rules/swim-speed-xphb.md) ignore\
    \ the extra cost of movement while swimming.  \n- Sun and Storms. While in\
    \ its lair, the dragon can cast [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md),\
