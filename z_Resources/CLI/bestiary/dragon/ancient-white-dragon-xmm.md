...
"cr": "20"
"traits":
- "desc": "The dragon casts [Fear](z_Resources/CLI/spells/fear-xphb.md), requiring\
...
- "desc": "The dragon can move across and climb icy surfaces without needing to make\
    \ an ability check. Additionally, [Difficult Terrain](z_Resources/CLI/rules/variant-rules/difficult-terrain-xphb.md)\
...
- "desc": "The dragon makes three Rend attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: +14, reach 15 ft. Hit: 17 (2d8 + 8) Slashing damage\
...
- "desc": "Constitution Saving Throw: DC 20, each creature in a 30-foot-radius [Sphere\
    ...
    \ Cold damage, and the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
...
- "desc": "- Frigid Cold. The area within 1 mile of the lair is an area of [extreme\
    \ cold](z_Resources/CLI/traps-hazards/extreme-cold-xdmg.md). Any water in that\
    \ area is [frigid water](z_Resources/CLI/traps-hazards/frigid-water-xdmg.md).\
    \ See the \"Dungeon Master's Guide\" for rules on extreme cold and frigid water.\
    \  \n- Glacial Gloom. The area within 1 mile of the lair is [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md)\
    ...
    \ or have its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) reduced\
