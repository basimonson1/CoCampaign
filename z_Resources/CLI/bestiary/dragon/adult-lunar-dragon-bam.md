...
---
# [Adult Lunar Dragon](z_Resources\CLI\bestiary\dragon/adult-lunar-dragon-bam.md)
...
"bonus_actions":
- "desc": "The dragon becomes partially incorporeal for as long as it maintains [concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
    \ on the effect (as if [concentrating](z_Resources/CLI/rules/conditions.md#Concentration)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/dragon/token/adult-lunar-dragon-bam.webp"
```
^statblock