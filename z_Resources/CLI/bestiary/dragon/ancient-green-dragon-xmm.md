...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ (level 5 version)\n\n1/day each: [Geas](z_Resources/CLI/spells/geas-xphb.md),\
    \ [Modify Memory](z_Resources/CLI/spells/modify-memory-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of Spellcasting to cast [Mind Spike](z_Resources/CLI/spells/mind-spike-xphb.md)\
    \ (level 5 version)."
  "name": "Multiattack"
...
- "desc": "- Beast Spies. Tiny Beasts magically gain the ability to understand\
    ...
    \ or its allies finishes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md)\
    \ in that area, it must succeed on a DC 15 Constitution saving throw or have the\
    \ [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition for 1 hour.\
    \  "
  "name": ""
