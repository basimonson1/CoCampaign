...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md),\
    \ [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md) (level 3 version),\
    \ [Shapechange](z_Resources/CLI/spells/shapechange-xphb.md) (Beast or Humanoid\
    \ form only, no [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md)\
    \ gained from the spell, and no Concentration or [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md)\
    \ required to maintain the spell), [Speak with Animals](z_Resources/CLI/spells/speak-with-animals-xphb.md)\n\
    \n1/day each: [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md),\
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the dragon fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day, or 5/Day in Lair)"
"actions":
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of (A) Sleep Breath or (B) Spellcasting to cast [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md)\
    \ (level 3 version)."
  "name": "Multiattack"
...
- "desc": "Dexterity Saving Throw: DC 21, each creature in a 90-foot-long, 5-foot-wide\
    \ [Line [Area of Effect]](z_Resources/CLI/rules/variant-rules/line-area-of-effect-xphb.md).\
...
- "desc": "Constitution Saving Throw: DC 21, each creature in a 90-foot [Cone [Area\
    ...
    \ Failure: The target has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition until the end of its next turn, at which point it repeats the save.\
    \ {@actSaveFail 2} The target has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious)\
  ...
  "name": "Sleep Breath"
"legendary_actions":
- "desc": "The dragon uses Spellcasting to cast [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md)\
    \ (level 3 version)."
  "name": "Blazing Light"
- "desc": "The dragon moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
    \ and it makes one Rend attack."
  "name": "Pounce"
- "desc": "Dexterity Saving Throw: DC 20, one creature the dragon can see within\
    \ 120 feet. Failure: 36 (8d8) Fire damage, and the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
...
- "desc": "The area containing an adult or ancient brass dragon's lair is altered\
  ...
  "name": ""
- "desc": "- Mirages. While in its lair, the dragon can cast [Major Image](z_Resources/CLI/spells/major-image-xphb.md),\
    ...
    \ A creature that drinks such water gains 2d4 [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md),\
