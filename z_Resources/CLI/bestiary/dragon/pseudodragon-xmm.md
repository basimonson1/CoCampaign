...
"cr": "1/4"
"traits":
- "desc": "The pseudodragon has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 12, one creature the pseudodragon can see\
    \ within 5 feet. Failure: 5 (2d4) Poison damage, and the target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition for 1 hour. Failure by 5 or More: The [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ target also has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious)\
...
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/dragon/token/pseudodragon-xmm.webp"
```
^statblock
