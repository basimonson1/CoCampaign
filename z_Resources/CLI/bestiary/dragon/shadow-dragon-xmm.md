...
- "desc": "While in [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
    \ or [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md), the dragon\
    \ has [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md) to\
    \ damage that isn't Force, Psychic, or Radiant."
  "name": "Living Shadow"
- "desc": "While in sunlight, the dragon has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "Dexterity Saving Throw: DC 17, each creature in a 60-foot [Cone [Area\
    ...
    \ Success: A Humanoid reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ by this damage dies, and a [Shadow](z_Resources/CLI/bestiary/undead/shadow-xmm.md)\
    \ rises from the corpse. The shadow is under the dragon's control and shares the\
    \ dragon's [Initiative](z_Resources/CLI/rules/variant-rules/initiative-xphb.md)\
...
- "desc": "- Negative Energy Suffusion. Whenever a creature within 1 mile of the\
    ...
    \ normally create [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md)\
    \ instead create [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md),\
    \ and creatures there have [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on Dexterity ([Stealth](z_Resources/CLI/rules/skills.md#Stealth)) checks.  "
  "name": ""
