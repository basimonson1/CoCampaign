...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ (level 3 version)\n\n1/day each: [Speak with Dead](z_Resources/CLI/spells/speak-with-dead-xphb.md),\
    \ [Vitriolic Sphere](z_Resources/CLI/spells/vitriolic-sphere-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Dexterity Saving Throw: DC 17, one creature the dragon can see within\
    \ 120 feet. Failure: 22 (4d10) Poison damage, and the target has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "The dragon can move up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
