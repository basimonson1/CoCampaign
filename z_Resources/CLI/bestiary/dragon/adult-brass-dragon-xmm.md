...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md), [Shapechange](z_Resources/CLI/spells/shapechange-xphb.md)\
    \ (Beast or Humanoid form only, no [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md)\
    ...
    \ [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Dexterity Saving Throw: DC 16, one creature the dragon can see within\
    \ 120 feet. Failure: 27 (6d8) Fire damage, and the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
