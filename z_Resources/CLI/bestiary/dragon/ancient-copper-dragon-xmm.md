...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Mind Spike](z_Resources/CLI/spells/mind-spike-xphb.md)\
    \ (level 5 version), [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md),\
    ...
    \ required to maintain the spell)\n\n1/day each: [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md),\
    \ [Major Image](z_Resources/CLI/spells/major-image-xphb.md), [Project Image](z_Resources/CLI/spells/project-image-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the dragon fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day, or 5/Day in Lair)"
"actions":
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of (A) Slowing Breath or (B) Spellcasting to cast [Mind Spike](z_Resources/CLI/spells/mind-spike-xphb.md)\
    \ (level 5 version)."
  "name": "Multiattack"
...
- "desc": "Constitution Saving Throw: DC 22, each creature in a 90-foot [Cone [Area\
    ...
    \ Failure: The target can't take Reactions; its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ is halved; and it can take either an action or a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md)\
...
- "desc": "Charisma Saving Throw: DC 21, one creature the dragon can see within\
    ...
    \ subtracts the number rolled from the [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md).\
    \ Failure or Success: The dragon can't take this action again until the start\
    \ of its next turn."
  "name": "Giggling Magic"
- "desc": "The dragon uses Spellcasting to cast [Mind Spike](z_Resources/CLI/spells/mind-spike-xphb.md)\
...
- "desc": "- Chatty Critters. Tiny Beasts magically gain the ability to speak\
    ...
    \ the lair and rolls a 1 on a [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md),\
    \ it must succeed on a DC 15 Wisdom saving throw or have the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
