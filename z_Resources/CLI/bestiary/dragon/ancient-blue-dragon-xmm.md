...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md),\
    \ [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md), [Shatter](z_Resources/CLI/spells/shatter-xphb.md)\
    \ (level 3 version)\n\n1/day each: [Scrying](z_Resources/CLI/spells/scrying-xphb.md),\
    \ [Sending](z_Resources/CLI/spells/sending-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the dragon fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day, or 5/Day in Lair)"
"actions":
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of Spellcasting to cast [Shatter](z_Resources/CLI/spells/shatter-xphb.md) (level\
    \ 3 version)."
  "name": "Multiattack"
...
"legendary_actions":
- "desc": "The dragon uses Spellcasting to cast [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
    \ on itself, and it can fly up to half its [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md).\
    \ The dragon can't take this action again until the start of its next turn."
  "name": "Cloaked Flight"
- "desc": "The dragon uses Spellcasting to cast [Shatter](z_Resources/CLI/spells/shatter-xphb.md)\
...
- "desc": "- Sinkholes. Sinkholes form more frequently in the area within 1 mile\
    ...
    \ allies finishes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md),\
    ...
    \ the lair. The area is [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md).\
    \  "
  "name": ""
