...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ with spell attacks):\n\nAt will: [Command](z_Resources/CLI/spells/command-xphb.md)\
    \ (level 2 version), [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md),\
    \ [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md) (level 3 version)\n\
    \n1/day each: [Fireball](z_Resources/CLI/spells/fireball-xphb.md) (level 6\
    \ version), [Scrying](z_Resources/CLI/spells/scrying-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the dragon fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (4/Day, or 5/Day in Lair)"
"actions":
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    \ of Spellcasting to cast [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md)\
    \ (level 3 version)."
  "name": "Multiattack"
...
"legendary_actions":
- "desc": "The dragon uses Spellcasting to cast [Command](z_Resources/CLI/spells/command-xphb.md)\
...
- "desc": "- Burning Heat. The area within 1 mile of the lair is an area of extreme\
    ...
    \ mile of the lair is [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md)\
    ...
    \ or have the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition\
    \ for 1 hour.  "
  "name": ""
