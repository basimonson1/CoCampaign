...
"cr": "1/4"
"traits":
- "desc": "The kobold has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    ...
    \ condition."
  "name": "Pack Tactics"
- "desc": "While in sunlight, the kobold has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on ability checks and attack rolls."
  "name": "Sunlight Sensitivity"
"actions":
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 6 (1d6 + 3) Piercing damage."
  "name": "Dragon-Tooth Blade"
- "desc": "Ranged Attack: +5, range 30 ft. Hit: 6 (1d6 + 3) damage of a type\
