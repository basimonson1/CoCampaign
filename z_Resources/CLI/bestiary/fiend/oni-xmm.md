...
- "desc": "The oni casts one of the following spells, requiring no Material components\
    ...
    \ each: [Charm Person](z_Resources/CLI/spells/charm-person-xphb.md) (level 2\
    \ version), [Darkness](z_Resources/CLI/spells/darkness-xphb.md), [Gaseous Form](z_Resources/CLI/spells/gaseous-form-xphb.md),\
    \ [Sleep](z_Resources/CLI/spells/sleep-xphb.md)"
  "name": "Spellcasting"
- "desc": "The oni casts [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
  ...
  "name": "Invisibility"
- "desc": "The oni regains 10 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
