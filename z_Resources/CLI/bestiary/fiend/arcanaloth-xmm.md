...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)"
...
- "desc": "The arcanaloth casts one of the following spells, requiring no Material\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Identify](z_Resources/CLI/spells/identify-xphb.md),\
    \ [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md), [Prestidigitation](z_Resources/CLI/spells/prestidigitation-xphb.md)\n\
    \n1/day each: [Contact Other Plane](z_Resources/CLI/spells/contact-other-plane-xphb.md),\
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Dimension\
    \ Door](z_Resources/CLI/spells/dimension-door-xphb.md), [Mind Blank](z_Resources/CLI/spells/mind-blank-xphb.md)"
  "name": "Spellcasting"
- "desc": "The arcanaloth casts [Counterspell](z_Resources/CLI/spells/counterspell-xphb.md)\
    \ in response to that spell's trigger, using the same spellcasting ability as\
    \ Spellcasting.\n\nAt will: [Counterspell](z_Resources/CLI/spells/counterspell-xphb.md)"
  "name": "Counterspell"
- "desc": "If the arcanaloth dies outside Gehenna, its body dissolves into ichor,\
    \ and it gains a new body instantly and revives with all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ in Gehenna."
  "name": "Fiendish Restoration"
- "desc": "The arcanaloth has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The arcanaloth has a magic tome. While holding or carrying the tome, the\
    ...
    \ and [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md) to Necrotic,\
    \ Poison, and Psychic damage. The tome regains all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ a new one when it finishes a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md)\
    \ or [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md)."
  "name": "Soul Tome"
"actions":
- "desc": "The arcanaloth makes three Fiendish Burst attacks. It can replace one attack\
    \ with a Banishing Claw attack."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: +9, reach 5 ft. or range 120 ft. Hit: 31\
    \ (4d12 + 5) Necrotic damage."
  "name": "Fiendish Burst"
- "desc": "Melee Attack: +9, reach 5 ft. Hit: 10 (2d4 + 5) Slashing damage\
    ...
    \ can escape only if the tome is reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
