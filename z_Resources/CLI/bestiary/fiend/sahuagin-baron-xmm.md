...
"cr": "5"
"traits":
- "desc": "The sahuagin has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on attack rolls against any creature that doesn't have all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
  "name": "Blood Frenzy"
...
- "desc": "Trigger: The sahuagin takes Piercing or Slashing damage. {@actResponse\
    ...
    \ is cursed until it finishes a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md)\
    \ or [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md). While\
    \ cursed, the target can't benefit from the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible)\
    \ condition, its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) decreases\
