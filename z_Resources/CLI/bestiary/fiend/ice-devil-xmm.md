...
"cr": "14"
"traits":
- "desc": "The devil casts [Wall of Ice](z_Resources/CLI/spells/wall-of-ice-xphb.md)\
...
- "desc": "Melee or Ranged Attack: +10, reach 5 ft. or range 30/120 ft. Hit:\
    ...
    \ its next turn, the target can't take a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md)\
    \ or [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md), its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
