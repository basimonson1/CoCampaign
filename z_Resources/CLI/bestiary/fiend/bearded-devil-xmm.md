...
- "desc": "Melee Attack: +5, reach 10 ft. Hit: 8 (1d10 + 3) Slashing damage.\
    ...
    \ [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) at the\
    \ start of each of its turns. The wound closes after 1 minute, after a spell restores\
    \ [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) to the\
    \ target, or after the target or a creature within 5 feet of it takes an action\
    \ to stanch the wound, doing so by succeeding on a DC 12 Wisdom ([Medicine](z_Resources/CLI/rules/skills.md#Medicine))\
    \ check."
