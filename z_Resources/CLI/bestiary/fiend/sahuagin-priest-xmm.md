...
- "desc": "The sahuagin casts one of the following spells, requiring no Material components\
    ...
    \ [Hold Person](z_Resources/CLI/spells/hold-person-xphb.md), [Tongues](z_Resources/CLI/spells/tongues-xphb.md)"
  "name": "Spellcasting"
- "desc": "The sahuagin casts [Bless](z_Resources/CLI/spells/bless-xphb.md) or [Healing\
    \ Word](z_Resources/CLI/spells/healing-word-xphb.md), using the same spellcasting\
    \ ability as Spellcasting.\n\n2/day: [Bless](z_Resources/CLI/spells/bless-xphb.md),\
    \ [Healing Word](z_Resources/CLI/spells/healing-word-xphb.md)"
