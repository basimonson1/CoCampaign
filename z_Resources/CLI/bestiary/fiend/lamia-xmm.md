...
- "desc": "The lamia casts one of the following spells, requiring no Material components\
    ...
    \ [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md) (can appear as\
    \ a Large or Medium biped), [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md)\n\
    \n1/day each: [Geas](z_Resources/CLI/spells/geas-xphb.md), [Major Image](z_Resources/CLI/spells/major-image-xphb.md),\
    \ [Scrying](z_Resources/CLI/spells/scrying-xphb.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "Wisdom Saving Throw: DC 13, one creature the lamia can see within 5 feet.\
    ...
    \ the curse ends, the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ and [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) conditions."
