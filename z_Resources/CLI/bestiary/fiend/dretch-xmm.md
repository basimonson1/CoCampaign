...
- "desc": "Constitution Saving Throw: DC 11, each creature in a 10-foot [Emanation\
    ...
    \ originating from the dretch. Failure: The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition until the end of its next turn. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
    \ the creature can take either an action or a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md)\
