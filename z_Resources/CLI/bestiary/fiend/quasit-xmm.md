...
"cr": "1"
"traits":
- "desc": "The quasit casts [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
    \ on itself, requiring no spell components and using Charisma as the spellcasting\
    \ ability.\n\nAt will: [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)"
  "name": "Invisibility"
- "desc": "The quasit has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Wisdom Saving Throw: DC 10, one creature within 20 feet. Failure: The\
  ...
  "name": "Scare (1/Day)"
- "desc": "The quasit shape-shifts to resemble a bat ([Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    ...
    \ in each form, except for its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md).\
    \ Any equipment it is wearing or carrying isn't transformed."
  "name": "Shape-Shift"
"source":
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/fiend/token/quasit-xmm.webp"
```
^statblock
