...
"cr": "1"
"traits":
- "desc": "The imp casts [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
  ...
  "name": "Invisibility"
- "desc": "The imp has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 6 (1d6 + 3) Piercing damage\
  ...
  "name": "Sting"
- "desc": "The imp shape-shifts to resemble a rat ([Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    ...
    \ for its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md). Any equipment\
    \ it is wearing or carrying isn't transformed."
  "name": "Shape-Shift"
"source":
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/fiend/token/imp-xmm.webp"
```
^statblock
