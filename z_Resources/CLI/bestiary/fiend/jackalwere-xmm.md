...
"cr": "1/2"
"traits":
- "desc": "The jackalwere has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Wisdom Saving Throw: DC 10, one creature the jackalwere can see within\
    ...
    \ has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious) condition\
