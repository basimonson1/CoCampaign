...
- "desc": "The chasme has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 16 (4d6 + 2) Piercing damage\
    \ plus 21 (6d6) Necrotic damage. If the target is a creature, its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
