...
- "desc": "The marilith has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "The marilith can take one [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md)\
...
- "desc": "Strength Saving Throw: DC 17, one Medium or smaller creature the marilith\
    ...
    \ DC 14), and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
