...
- "desc": "The rakshasa casts one of the following spells, requiring no Material components\
    ...
    \ [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md), [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md),\
    \ [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md)\n\n1/day each:\
    \ [Fly](z_Resources/CLI/spells/fly-xphb.md), [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md),\
    \ [Major Image](z_Resources/CLI/spells/major-image-xphb.md), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Attack: +10, reach 5 ft. Hit: 12 (2d6 + 5) Slashing damage\
    ...
    \ While cursed, the target gains no benefit from finishing a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md)\
...
- "desc": "Wisdom Saving Throw: DC 18, each enemy in a 30-foot [Emanation [Area\
    ...
    \ and [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) conditions\
