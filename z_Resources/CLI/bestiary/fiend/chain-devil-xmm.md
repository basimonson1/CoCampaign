...
- "desc": "The devil has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +7, reach 10 ft. Hit: 11 (2d6 + 4) Slashing damage.\
    ...
    \ condition (escape DC 14) from one of two chains, and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "The devil conjures a fiery chain to bind a creature. Dexterity Saving\
    ...
    \ + 4) Fire damage, and the target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Trigger: A creature the devil can see starts its turn within 30 feet of\
    ...
    \ the triggering creature. Failure: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
