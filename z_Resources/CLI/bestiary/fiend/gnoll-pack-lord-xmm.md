...
- "desc": "The gnoll targets another creature it can see within 60 feet of itself\
    \ that has the Rampage [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md).\
    \ The target can take a [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md)\
