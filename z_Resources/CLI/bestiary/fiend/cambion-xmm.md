...
- "desc": "The cambion casts one of the following spells, requiring no Material components\
    ...
    \ each: [Dominate Person](z_Resources/CLI/spells/dominate-person-xphb.md) (level\
    \ 8 version), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md) (self\
    \ only)\n\n2/day each: [Alter Self](z_Resources/CLI/spells/alter-self-xphb.md),\
    \ [Command](z_Resources/CLI/spells/command-xphb.md) (level 3 version), [Detect\
    \ Magic](z_Resources/CLI/spells/detect-magic-xphb.md)"
  "name": "Spellcasting"
"actions":
- "desc": "The cambion makes two attacks, using Claw or Fire Ray in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 8 (1d8 + 4) Slashing damage\
