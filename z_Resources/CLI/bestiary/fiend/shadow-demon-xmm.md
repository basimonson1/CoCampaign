...
- "desc": "While in [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md),\
    \ the demon has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "While in [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
    \ or [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md), the demon\
