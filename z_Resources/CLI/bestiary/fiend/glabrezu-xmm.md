...
- "desc": "The glabrezu casts one of the following spells, requiring no Material components\
    ...
    \ will: [Darkness](z_Resources/CLI/spells/darkness-xphb.md), [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md),\
    \ [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md)\n\n1/day each:\
    \ [Confusion](z_Resources/CLI/spells/confusion-xphb.md), [Fly](z_Resources/CLI/spells/fly-xphb.md),\
    \ [Power Word Stun](z_Resources/CLI/spells/power-word-stun-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the glabrezu dies outside the Abyss, its body dissolves into ichor,\
    \ and it gains a new body instantly, reviving with all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ somewhere in the Abyss."
  "name": "Demonic Restoration"
- "desc": "The glabrezu has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +9, reach 10 ft. Hit: 16 (2d10 + 5) Slashing damage.\
  ...
  "name": "Pincer"
- "desc": "Dexterity Saving Throw: DC 17, one creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
