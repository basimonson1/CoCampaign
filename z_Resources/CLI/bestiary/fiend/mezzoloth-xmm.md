...
- "desc": "The mezzoloth casts one of the following spells, requiring no Material\
    ...
    \n1/day each: [Cloudkill](z_Resources/CLI/spells/cloudkill-xphb.md), [Darkness](z_Resources/CLI/spells/darkness-xphb.md),\
...
- "desc": "The mezzoloth has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 9 (2d4 + 4) Slashing damage.\
    ...
    \ condition (escape DC 14) from two of four claws, and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
