...
- "desc": "Melee or Ranged Attack: +6, reach 5 ft. or range 60 ft. Hit: 20 (5d6\
    \ + 3) Poison damage."
  "name": "Abyssal Strike"
- "desc": "The gnoll conjures a 30-foot [Cube [Area of Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
    \ of magical [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md)\
    \ originating from a point it can see within 60 feet, which lasts for 1 minute\
    \ or until the gnoll's [Concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
    \ ends on it. This area is [Difficult Terrain](z_Resources/CLI/rules/variant-rules/difficult-terrain-xphb.md).\
    ...
    \ Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md). Success:\
    \ Half damage only."
  "name": "Hunger of Yeenoghu (Recharge 5-6)"
"bonus_actions":
- "desc": "Immediately after dealing damage to a creature that is already [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md),\
    \ the gnoll moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
