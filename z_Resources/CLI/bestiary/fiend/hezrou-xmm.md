...
- "desc": "The hezrou has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 16, any creature that starts its turn in\
    ...
    \ originating from the hezrou. Failure: The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
