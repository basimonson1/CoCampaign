...
| 4 | [Falling](z_Resources/CLI/traps-hazards/falling-xphb.md), drowning, or suffocating. |
...
- "desc": "The incubus casts one of the following spells, requiring no Material components\
    ...
    \ [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md), [Etherealness](z_Resources/CLI/spells/etherealness-xphb.md)\n\
    \n1/day each: [Dream](z_Resources/CLI/spells/dream-xphb.md), [Hypnotic Pattern](z_Resources/CLI/spells/hypnotic-pattern-xphb.md)"
  "name": "Spellcasting"
- "desc": "When the incubus finishes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md),\
    \ it can shape-shift into a [Succubus](z_Resources/CLI/bestiary/fiend/succubus-xmm.md),\
...
- "desc": "Wisdom Saving Throw: DC 15, one creature the incubus can see within 60\
    \ feet. Failure: If the target has 20 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ or fewer, it has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious)\
