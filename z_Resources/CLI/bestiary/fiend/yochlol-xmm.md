...
- "desc": "The yochlol casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Gaseous\
    \ Form](z_Resources/CLI/spells/gaseous-form-xphb.md) (self only), [Web](z_Resources/CLI/spells/web-xphb.md)\n\
    \n1/day: [Dominate Person](z_Resources/CLI/spells/dominate-person-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The yochlol has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The yochlol makes two Caustic Lash attacks, and it can use Spellcasting\
    \ to cast [Web](z_Resources/CLI/spells/web-xphb.md) or [Dominate Person](z_Resources/CLI/spells/dominate-person-xphb.md)\
    \ if available."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: +8, reach 10 ft. or range 120 ft. Hit: 25\
    \ (6d6 + 4) Acid damage."
  "name": "Caustic Lash"
"bonus_actions":
...
- "desc": "Trigger: The yochlol is hit by an attack roll. Response: The yochlol halves\
    ...
    \ target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition\
    \ until the end of its next turn. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
    \ it has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Toxic Escape"
"source":
- "XMM"
