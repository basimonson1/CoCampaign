...
aliases: ["Space Clown"]
---
# [Space Clown](z_Resources\CLI\bestiary\fiend/space-clown-bam.md)
...
- "desc": "The clown casts one of the following spells, requiring no material components\
    \ and using Charisma as the spellcasting ability:\n\nAt will: [friends](z_Resources/CLI/spells/friends-xphb.md),\
    \ [mage hand](z_Resources/CLI/spells/mage-hand-xphb.md), [prestidigitation](z_Resources/CLI/spells/prestidigitation-xphb.md)\n\
    \n1/day each: [mirror image](z_Resources/CLI/spells/mirror-image-xphb.md),\
    \ [spider climb](z_Resources/CLI/spells/spider-climb-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Ranged Spell Attack: +5 to hit, range 120 ft., one creature. Hit:\
    ...
    \ and is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) for\
...
- "desc": "The clown veils itself and everything it is wearing and carrying in an\
    ...
    \ as a floating balloon). Maintaining this effect requires the clown's [concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
    \ (as if [concentrating](z_Resources/CLI/rules/conditions.md#Concentration) on\
    \ a spell), and the illusion fails to hold up to physical inspection. As an action,\
    \ a creature that can see the clown's illusory form can make a DC 15 Wisdom ([Insight](z_Resources/CLI/rules/skills.md#Insight))\
    \ check, piercing the illusion and discerning the clown's true form on a success."
  "name": "Phantasmal Form (3/Day)"
"source":
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/fiend/token/space-clown-bam.webp"
```
^statblock