...
- "desc": "The goristro has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +13, reach 10 ft. Hit: 40 (6d10 + 7) Piercing damage.\
    ...
    \ away from the goristro and has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Brutal Gore"
- "desc": "Melee Attack: +13, reach 10 ft. Hit: 29 (4d10 + 7) Bludgeoning\
  ...
  "name": "Slam"
"bonus_actions":
- "desc": "The goristro moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
