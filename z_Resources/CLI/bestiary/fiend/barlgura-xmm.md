...
- "desc": "The barlgura casts one of the following spells, requiring no Material components\
    ...
    \ each: [Entangle](z_Resources/CLI/spells/entangle-xphb.md), [Phantasmal Killer](z_Resources/CLI/spells/phantasmal-killer-xphb.md)\
    \ (level 6 version)\n\n2/day each: [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md),\
