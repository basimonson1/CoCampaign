...
aliases: ["Autognome"]
---
# [Autognome](z_Resources\CLI\bestiary\construct/autognome-bam.md)
...
"condition_immunities": "[paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed),\
...
- "desc": "Whenever the autognome takes 15 damage or more from a single source and\
    ...
    \  \n- 11-12 \"My Mind Is Going. I Can Feel It.\". The autognome is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    ...
    \ autognome to be [blinded](z_Resources/CLI/rules/conditions.md#Blinded) and [deafened](z_Resources/CLI/rules/conditions.md#Deafened)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/construct/token/autognome-bam.webp"
```
^statblock