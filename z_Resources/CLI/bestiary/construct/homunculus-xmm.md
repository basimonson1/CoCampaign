...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 1 Piercing damage, and the target\
    ...
    \ The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition for 1 minute. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
    \ the target has the [Unconscious](z_Resources/CLI/rules/conditions.md#Unconscious)\
