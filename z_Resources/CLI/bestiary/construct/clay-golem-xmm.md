...
- "desc": "Whenever the golem is subjected to Acid damage, it takes no damage and\
    \ instead regains a number of [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Whenever the golem starts its turn [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it continues to be berserk until it is destroyed or it is no longer [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)."
  "name": "Berserk"
...
- "desc": "Melee Attack: +9, reach 5 ft. Hit: 10 (1d10 + 5) Bludgeoning damage\
    \ plus 6 (1d12) Acid damage, and the target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
