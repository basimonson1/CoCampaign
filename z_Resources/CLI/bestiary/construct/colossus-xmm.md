...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion),\
  ...
  \ [stunned](z_Resources/CLI/rules/conditions.md#Stunned), [unconscious](z_Resources/CLI/rules/conditions.md#Unconscious)"
...
- "desc": "The colossus has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The colossus makes three attacks, using Slam or Radiant Ray in any combination."
  "name": "Multiattack"
- "desc": "Melee Attack: +18, reach 20 ft. Hit: 32 (4d10 + 10) Bludgeoning\
    \ damage, and the colossus pushes the target up to 20 feet straight away from\
    \ itself."
  "name": "Slam"
- "desc": "Ranged Attack: +18, range 300 ft. Hit: 22 (4d10) Radiant damage.\
...
- "desc": "Dexterity Saving Throw: DC 26, each creature in a 300-foot-long, 10-foot-wide\
    ...
    \ Success: A creature reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The colossus makes one Radiant Ray attack."
  "name": "Smite"
- "desc": "The colossus moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
