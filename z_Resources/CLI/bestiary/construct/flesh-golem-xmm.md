...
"cr": "5"
"traits":
- "desc": "If the golem takes Fire damage, it has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on attack rolls and ability checks until the end of its next turn."
  "name": "Aversion to Fire"
- "desc": "Whenever the golem starts its turn [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it remains so until it is destroyed or it is no longer [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md).\n\
    \nThe golem's creator, if within 60 feet of the berserk golem, can try to calm\
    \ it by taking an action to make a DC 15 Charisma ([Persuasion](z_Resources/CLI/rules/skills.md#Persuasion))\
    ...
    \ it resumes rolling for the Berserk trait again if it is still [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)."
  "name": "Berserk"
- "desc": "The golem can't shape-shift."
  "name": "Immutable Form"
- "desc": "Whenever the golem is subjected to Lightning damage, it regains a number\
    \ of [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal\
    \ to the Lightning damage dealt."
  "name": "Lightning Absorption"
- "desc": "The golem has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
