...
- "desc": "At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation\
  ...
  "name": "Flame Aura"
- "desc": "The gorgon sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md)\
    \ in a 10-foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
...
- "desc": "Melee Attack: +8, reach 5 ft. Hit: 11 (2d6 + 4) Piercing damage\
  ...
  "name": "Gore"
- "desc": "The gorgon moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    ...
    \ DC 14); if the gorgon already has a creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled),\
    \ the target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition\
    \ instead. Until the grapple ends, the target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition. When the gorgon moves, the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
