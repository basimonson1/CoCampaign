...
Those who create gorgons strive to give them purposefully obscure command keys. Hints at command keys might be found among the records of a gorgon's creator or in the area the gorgon protects—perhaps scrawled as a [petrified](z_Resources/CLI/rules/conditions.md#Petrified) trespasser's final act. Roll on or choose a result from the Gorgon Command Keys table to inspire the word or signal that temporarily neutralizes a gorgon.
...
- "desc": "Melee Attack: +8, reach 5 ft. Hit: 18 (2d12 + 5) Piercing damage.\
    ...
    \ toward it immediately before the hit, the target has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Gore"
- "desc": "Constitution Saving Throw: DC 15, each creature in a 30-foot [Cone [Area\
    ...
    \ {@actSaveFail 1} The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Dexterity Saving Throw: DC 16, one creature within 5 feet that has the\
    \ [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition. Failure: 16\
