...
- "desc": "The performer casts one of the following spells, requiring no Material\
    ...
    \ each: [Major Image](z_Resources/CLI/spells/major-image-xphb.md), [Project\
    \ Image](z_Resources/CLI/spells/project-image-xphb.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "Wisdom Saving Throw: DC 17, each creature in a 20-foot-radius [Sphere\
    ...
    \ and the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ or [Frightened](z_Resources/CLI/rules/conditions.md#Frightened) condition (performer's\
...
- "desc": "Trigger: A creature hits the performer with an attack roll. {@actResponse\
    ...
    \ roll misses the performer, and the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
