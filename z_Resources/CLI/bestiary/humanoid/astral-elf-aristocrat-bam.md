...
---
# [Astral Elf Aristocrat](z_Resources\CLI\bestiary\humanoid/astral-elf-aristocrat-bam.md)
...
"ac": !!int "16"
"ac_class": "[elven chain](z_Resources/CLI/items/elven-chain-xdmg.md)"
"hp": !!int "103"
"hit_dice": "23d8"
"stats":
- !!int "11"
...
- "desc": "The elf casts one of the following spells, using Intelligence as the spellcasting\
    \ ability:\n\n1/day each: [fly](z_Resources/CLI/spells/fly-xphb.md), [mislead](z_Resources/CLI/spells/mislead-xphb.md),\
    \ [sending](z_Resources/CLI/spells/sending-xphb.md)"
  "name": "Spellcasting"
- "desc": "The elf has advantage on saving throws it makes to avoid or end the [charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ condition on itself, and magic can't put it to sleep."
  "name": "Fey Ancestry"
- "desc": "The elf wears a suit of [elven chain](z_Resources/CLI/items/elven-chain-xdmg.md)."
...
- "desc": "The elf has a 50 percent chance of magically summoning a [young solar dragon](z_Resources/CLI/bestiary/dragon/young-solar-dragon-bam.md).\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/humanoid/token/astral-elf-aristocrat-bam.webp"
```
^statblock