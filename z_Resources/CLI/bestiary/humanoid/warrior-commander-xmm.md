...
- "desc": "Melee Attack: +9, reach 5 ft. Hit: 19 (4d6 + 5) Slashing damage.\
    ...
    \ has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on its next attack roll before the start of the warrior's next turn.  \n- Maneuver.\
    \ One ally who can see or hear the warrior can take a [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md)\
...
- "desc": "Ranged Attack: +9, range 150/600 ft. Hit: 18 (3d8 + 5) Piercing\
    \ damage, and the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ decreases by 10 feet until the end of the target's next turn."
  "name": "Longbow"
"bonus_actions":
- "desc": "The warrior moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
