...
- "desc": "The noble casts one of the following spells, requiring no Material components\
    ...
    \ [Mage Armor](z_Resources/CLI/spells/mage-armor-xphb.md) (included in AC), [Mage\
    \ Hand](z_Resources/CLI/spells/mage-hand-xphb.md), [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md)\n\
    \n1/day each: [Befuddlement](z_Resources/CLI/spells/befuddlement-xphb.md),\
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Fly](z_Resources/CLI/spells/fly-xphb.md),\
    \ [Scrying](z_Resources/CLI/spells/scrying-xphb.md), [Shatter](z_Resources/CLI/spells/shatter-xphb.md)\
    \ (level 7 version)"
  "name": "Spellcasting"
- "desc": "The noble casts [Shield](z_Resources/CLI/spells/shield-xphb.md) in response\
...
- "desc": "Melee or Ranged Attack: +8, reach 5 ft. or range 60 ft. Hit: 18 (4d6\
    \ + 4) Psychic damage, and the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
