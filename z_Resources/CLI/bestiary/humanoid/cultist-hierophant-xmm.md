...
- "desc": "The cultist casts one of the following spells, using Charisma as the spellcasting\
    \ ability (spell save DC 17):\n\nAt will: [Mage Armor](z_Resources/CLI/spells/mage-armor-xphb.md)\
    \ (included in AC), [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\
    \n1/day each: [Jallarzi's Storm of Radiance](z_Resources/CLI/spells/jallarzis-storm-of-radiance-xphb.md)\
    \ (level 7 version), [Mass Suggestion](z_Resources/CLI/spells/mass-suggestion-xphb.md)"
  "name": "Spellcasting"
"actions":
