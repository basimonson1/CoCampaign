...
- "desc": "The cultist casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [Light](z_Resources/CLI/spells/light-xphb.md), [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\
    \n1/day: [Hold Person](z_Resources/CLI/spells/hold-person-xphb.md)\n\n2/day:\
    \ [Command](z_Resources/CLI/spells/command-xphb.md)"
  "name": "Spellcasting"
- "desc": "The cultist casts the [Spiritual Weapon](z_Resources/CLI/spells/spiritual-weapon-xphb.md)\
    \ spell, using the same spellcasting ability as Spellcasting.\n\n2/day: [Spiritual\
    \ Weapon](z_Resources/CLI/spells/spiritual-weapon-xphb.md)"
