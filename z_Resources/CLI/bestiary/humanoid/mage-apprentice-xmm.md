...
- "desc": "The mage casts one of the following spells, using Intelligence as the spellcasting\
    ...
    \n1/day each: [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md),\
    \ [Ice Knife](z_Resources/CLI/spells/ice-knife-xphb.md), [Mage Armor](z_Resources/CLI/spells/mage-armor-xphb.md)\
    \ (included in AC), [Thunderwave](z_Resources/CLI/spells/thunderwave-xphb.md)"
  "name": "Spellcasting"
"actions":
