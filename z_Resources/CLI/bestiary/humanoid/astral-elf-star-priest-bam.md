...
---
# [Astral Elf Star Priest](z_Resources\CLI\bestiary\humanoid/astral-elf-star-priest-bam.md)
...
"ac": !!int "13"
"ac_class": "[chain shirt](z_Resources/CLI/items/chain-shirt-xphb.md)"
"hp": !!int "90"
"hit_dice": "20d8"
"stats":
- !!int "11"
...
- "desc": "The elf casts one of the following spells, using Wisdom as the spellcasting\
    \ ability (spell save DC 16):\n\n1/day each: [divination](z_Resources/CLI/spells/divination-xphb.md),\
    \ [sending](z_Resources/CLI/spells/sending-xphb.md), [word of recall](z_Resources/CLI/spells/word-of-recall-xphb.md)\n\
    \n2/day each: [cure wounds](z_Resources/CLI/spells/cure-wounds-xphb.md) (8th-level\
    \ version), [hold person](z_Resources/CLI/spells/hold-person-xphb.md)"
  "name": "Spellcasting"
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/humanoid/token/astral-elf-star-priest-bam.webp"
```
^statblock