...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed) (except\
...
- "desc": "Melee or Ranged Attack: +5, reach 5 ft. or range 20/60 ft. Hit: 5\
    ...
    \ reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ by this attack, the target becomes [Stable](z_Resources/CLI/rules/variant-rules/stable-xphb.md)\
    \ but has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition\
    \ for 1 hour. While it has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition, the target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    \ condition."
  "name": "Umbral Dagger"
"bonus_actions":
