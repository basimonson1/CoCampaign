...
- "desc": "If the bandit is subjected to an effect that allows it to make a Dexterity\
    ...
    \ trait if it has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Evasion"
"actions":
...
- "desc": "Ranged Attack: +9, range 30/90 ft. Hit: 10 (1d10 + 5) Piercing\
  ...
  "name": "Pistol"
"bonus_actions":
- "desc": "The bandit gives itself [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
