...
- "desc": "The druid casts one of the following spells, using Wisdom as the spellcasting\
    \ ability (spell save DC 13):\n\nAt will: [Druidcraft](z_Resources/CLI/spells/druidcraft-xphb.md),\
    \ [Speak with Animals](z_Resources/CLI/spells/speak-with-animals-xphb.md)\n\n\
    1/day each: [Animal Messenger](z_Resources/CLI/spells/animal-messenger-xphb.md),\
    \ [Longstrider](z_Resources/CLI/spells/longstrider-xphb.md), [Moonbeam](z_Resources/CLI/spells/moonbeam-xphb.md)\n\
    \n2/day each: [Entangle](z_Resources/CLI/spells/entangle-xphb.md), [Thunderwave](z_Resources/CLI/spells/thunderwave-xphb.md)"
  "name": "Spellcasting"
"actions":
