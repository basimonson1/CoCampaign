...
- "desc": "The knight casts one of the following spells, using Charisma as the spellcasting\
    \ ability (spell save DC 16):\n\n1/day each: [Daylight](z_Resources/CLI/spells/daylight-xphb.md),\
    \ [Dispel Evil and Good](z_Resources/CLI/spells/dispel-evil-and-good-xphb.md),\
    \ [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md), [Phantom\
    \ Steed](z_Resources/CLI/spells/phantom-steed-xphb.md)"
  "name": "Spellcasting"
- "desc": "Creatures of the knight's choice in a 30-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from it have [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md)\
    \ to the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) and [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
