...
- "desc": "The performer casts one of the following spells, requiring no Material\
    ...
    \nAt will: [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md),\
    \ [Prestidigitation](z_Resources/CLI/spells/prestidigitation-xphb.md)\n\n1/day:\
    \ [Tasha's Hideous Laughter](z_Resources/CLI/spells/tashas-hideous-laughter-xphb.md)\
    \ (level 3 version)"
  "name": "Spellcasting"
"actions":
- "desc": "The performer makes three Rapier attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 8 (1d8 + 4) Piercing damage\
