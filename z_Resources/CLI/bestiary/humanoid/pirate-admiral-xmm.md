...
- "desc": "Melee Attack: +10, reach 5 ft. Hit: 16 (3d6 + 6) Slashing damage\
    ...
    \ of the pirate's choice:\n\n- Awestruck. The target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
...
- "desc": "The pirate chooses up to three other creatures it can see within 30 feet.\
    \ Until the start of the pirate's next turn, the targets have [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
