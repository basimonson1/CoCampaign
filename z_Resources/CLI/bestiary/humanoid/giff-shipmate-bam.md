...
---
# [Giff Shipmate](z_Resources\CLI\bestiary\humanoid/giff-shipmate-bam.md)
...
- "desc": "On the deck of a ship, the giff has advantage on ability checks and saving\
    \ throws made against effects that would knock it [prone](z_Resources/CLI/rules/conditions.md#Prone)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/humanoid/token/giff-shipmate-bam.webp"
```
^statblock