...
- "desc": "The cultist casts one of the following spells, using Wisdom as the spellcasting\
    \ ability (spell save DC 14):\n\nAt will: [Speak with Dead](z_Resources/CLI/spells/speak-with-dead-xphb.md),\
...
- "desc": "The cultist makes three attacks, using Dread Scythe or Deathly Ray in any\
    \ combination."
  "name": "Multiattack"
- "desc": "Melee Attack: +7, reach 10 ft. Hit: 9 (1d10 + 4) Slashing damage\
    \ plus 11 (2d10) Necrotic damage, and the target can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
