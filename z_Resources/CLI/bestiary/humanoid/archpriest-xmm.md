...
- "desc": "The archpriest casts one of the following spells, requiring no Material\
    ...
    \nAt will: [Light](z_Resources/CLI/spells/light-xphb.md), [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\
    \n1/day each: [Flame Strike](z_Resources/CLI/spells/flame-strike-xphb.md)\
    \ (level 6 version), [Greater Restoration](z_Resources/CLI/spells/greater-restoration-xphb.md),\
    \ [Raise Dead](z_Resources/CLI/spells/raise-dead-xphb.md), [Zone of Truth](z_Resources/CLI/spells/zone-of-truth-xphb.md)"
  "name": "Spellcasting"
- "desc": "The priest casts [Bless](z_Resources/CLI/spells/bless-xphb.md), [Dispel\
    \ Magic](z_Resources/CLI/spells/dispel-magic-xphb.md), [Healing Word](z_Resources/CLI/spells/healing-word-xphb.md),\
    \ or [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md),\
    \ using the same spellcasting ability as Spellcasting.\n\n3/day: [Bless](z_Resources/CLI/spells/bless-xphb.md),\
    \ [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md), [Healing Word](z_Resources/CLI/spells/healing-word-xphb.md),\
    \ [Lesser Restoration](z_Resources/CLI/spells/lesser-restoration-xphb.md)"
...
- "desc": "Wisdom Saving Throw: DC 17, each enemy in a 20-foot [Emanation [Area\
    ...
    \ target has the [Stunned](z_Resources/CLI/rules/conditions.md#Stunned) condition\
