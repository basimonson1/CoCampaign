...
- "desc": "The cultist casts one of the following spells, using Wisdom as the spellcasting\
    ...
    \ [Scorching Ray](z_Resources/CLI/spells/scorching-ray-xphb.md) (level 5 version),\
    \ [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\n2/day: [Fireball](z_Resources/CLI/spells/fireball-xphb.md)\
    \ (level 6 version)"
  "name": "Spellcasting"
- "desc": "The cultist casts [Hellish Rebuke](z_Resources/CLI/spells/hellish-rebuke-xphb.md)\
    \ in response to that spell's trigger, using the same spellcasting ability as\
    \ Spellcasting.\n\nAt will: [Hellish Rebuke](z_Resources/CLI/spells/hellish-rebuke-xphb.md)"
  "name": "Hellish Rebuke"
"actions":
