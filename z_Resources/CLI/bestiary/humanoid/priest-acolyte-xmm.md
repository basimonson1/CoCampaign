...
- "desc": "The priest casts one of the following spells, using Wisdom as the spellcasting\
  ...
  "name": "Spellcasting"
- "desc": "The priest casts [Bless](z_Resources/CLI/spells/bless-xphb.md), [Healing\
    \ Word](z_Resources/CLI/spells/healing-word-xphb.md), or [Sanctuary](z_Resources/CLI/spells/sanctuary-xphb.md),\
    \ using the same spellcasting ability as Spellcasting.\n\n1/day: [Bless](z_Resources/CLI/spells/bless-xphb.md),\
    \ [Healing Word](z_Resources/CLI/spells/healing-word-xphb.md), [Sanctuary](z_Resources/CLI/spells/sanctuary-xphb.md)"
