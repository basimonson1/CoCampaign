...
---
# [Githyanki Buccaneer](z_Resources\CLI\bestiary\humanoid/githyanki-buccaneer-bam.md)
...
- "desc": "The githyanki casts one of the following spells, requiring no spell components\
    ...
    \ will: [light](z_Resources/CLI/spells/light-xphb.md), [mage hand](z_Resources/CLI/spells/mage-hand-xphb.md)\
    \ (the hand is invisible)\n\n1/day each: [plane shift](z_Resources/CLI/spells/plane-shift-xphb.md),\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/humanoid/token/githyanki-buccaneer-bam.webp"
```
^statblock