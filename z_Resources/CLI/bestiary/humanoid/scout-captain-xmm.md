...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 6 (1d6 + 3) Piercing damage,\
    \ plus 10 (3d6) Piercing damage if the attack was made with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)."
  "name": "Shortsword"
- "desc": "Ranged Attack: +5, range 150/600 ft. Hit: 7 (1d8 + 3) Piercing\
    \ damage, plus 10 (3d6) Piercing damage if the attack was made with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)."
  "name": "Longbow"
"bonus_actions":
- "desc": "The scout has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
