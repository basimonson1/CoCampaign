...
aliases: ["B'rohg"]
---
# [B'rohg](z_Resources\CLI\bestiary\giant/brohg-bam.md)
...
- "desc": "The b'rohg uses all four of its hands to target one Large or smaller creature\
    ...
    \ saving throw or be [grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/giant/token/brohg-bam.webp"
```
^statblock