...
aliases: ["Braxat"]
---
# [Braxat](z_Resources\CLI\bestiary\giant/braxat-bam.md)
...
- "desc": "The braxat casts one of the following spells, requiring no spell components\
    ...
    \ each: [compulsion](z_Resources/CLI/spells/compulsion-xphb.md), [fear](z_Resources/CLI/spells/fear-xphb.md)"
...
"reactions":
- "desc": "When the braxat would be hit by an attack roll or a [magic missile](z_Resources/CLI/spells/magic-missile-xphb.md)\
    \ spell that originates from a source the braxat can see, the braxat can create\
    \ an [invisible](z_Resources/CLI/rules/conditions.md#Invisible) barrier of magical\
    ...
    \ and prevents [magic missile](z_Resources/CLI/spells/magic-missile-xphb.md) spells\
    \ from damaging it."
  "name": "Psionic Shield (3/Day)"
"source":
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/giant/token/braxat-bam.webp"
```
^statblock