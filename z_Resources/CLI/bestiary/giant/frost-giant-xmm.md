...
- "desc": "Ranged Attack: +9, range 150/600 ft. Hit: 17 (2d10 + 6) Piercing\
    \ damage plus 7 (2d6) Cold damage, and the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
...
- "desc": "The giant or one creature of its choice that can see or hear it gains 16\
    \ (2d10 + 5) [Temporary Hit Points](z_Resources/CLI/rules/variant-rules/temporary-hit-points-xphb.md)\
    \ and has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md) on\
