...
- "desc": "The cyclops casts one of the following spells, requiring no Material components\
    ...
    \ [Legend Lore](z_Resources/CLI/spells/legend-lore-xphb.md)\n\n2/day each:\
    \ [Arcane Eye](z_Resources/CLI/spells/arcane-eye-xphb.md), [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md),\
    \ [Locate Object](z_Resources/CLI/spells/locate-object-xphb.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "Ranged Attack: +10, range 120 ft. Hit: 17 (2d10 + 6) Radiant damage,\
    \ and the target has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on attack rolls until the end of the cyclops's next turn."
  "name": "Flash of Light"
"reactions":
- "desc": "Trigger: The cyclops or an ally it can see makes a [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md).\
    \ Response: The cyclops rolls  and chooses whether to use that roll in place\
    \ of the d20 rolled for the [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md)."
