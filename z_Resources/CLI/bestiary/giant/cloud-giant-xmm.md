...
- "desc": "The giant casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Fog Cloud](z_Resources/CLI/spells/fog-cloud-xphb.md),\
    \ [Light](z_Resources/CLI/spells/light-xphb.md)\n\n1/day each: [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md),\
    \ [Gaseous Form](z_Resources/CLI/spells/gaseous-form-xphb.md), [Telekinesis](z_Resources/CLI/spells/telekinesis-xphb.md)"
  "name": "Spellcasting"
- "desc": "The giant casts the [Misty Step](z_Resources/CLI/spells/misty-step-xphb.md)\
    \ spell, using the same spellcasting ability as Spellcasting.\n\nAt will:\
    \ [Misty Step](z_Resources/CLI/spells/misty-step-xphb.md)"
  "name": "Misty Step"
"actions":
- "desc": "The giant makes two attacks, using Thunderous Mace or Thundercloud in any\
    ...
    \ Cloud](z_Resources/CLI/spells/fog-cloud-xphb.md)."
  "name": "Multiattack"
