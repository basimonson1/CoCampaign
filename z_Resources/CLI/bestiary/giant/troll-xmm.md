...
"cr": "5"
"traits":
- "desc": "If the troll ends any turn [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md)\
    \ and took 15+ Slashing damage during that turn, one of the troll's limbs is severed,\
    \ falls into the troll's space, and becomes a [Troll Limb](z_Resources/CLI/bestiary/giant/troll-limb-xmm.md).\
    \ The limb acts immediately after the troll's turn. The troll has 1 [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion)\
...
- "desc": "The troll regains 15 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ its turn with 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Melee Attack: +7, reach 10 ft. Hit: 11 (2d6 + 4) Slashing damage."
  "name": "Rend"
"bonus_actions":
- "desc": "The troll moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
