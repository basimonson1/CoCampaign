...
- "desc": "The giant casts one of the following spells, requiring no Material components\
    ...
    \ [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md), [Light](z_Resources/CLI/spells/light-xphb.md)\n\
    \n1/day: [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Ranged Attack: +14, range 500 ft. Hit: 22 (2d12 + 9) Lightning\
    \ damage, and the target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
    \ and [Deafened](z_Resources/CLI/rules/conditions.md#Deafened) conditions until\
