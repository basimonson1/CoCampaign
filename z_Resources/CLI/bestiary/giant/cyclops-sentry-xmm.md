...
- "desc": "Trigger: A creature the cyclops can see makes an attack roll against it.\
    \ Response: The cyclops imposes [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on the roll, and the cyclops gains [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
