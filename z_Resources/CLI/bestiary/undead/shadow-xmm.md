...
- "desc": "The shadow can move through a space as narrow as 1 inch without expending\
  ...
  "name": "Amorphous"
- "desc": "While in sunlight, the shadow has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on [D20 Test](z_Resources/CLI/rules/variant-rules/d20-test-xphb.md)."
...
- "desc": "While in [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
    \ or [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md), the shadow\
