...
- "desc": "The lich casts one of the following spells, using Intelligence as the spellcasting\
    \ ability (spell save DC 20):\n\nAt will: [Detect Magic](z_Resources/CLI/spells/detect-magic-xphb.md),\
    \ [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md), [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md),\
    \ [Fireball](z_Resources/CLI/spells/fireball-xphb.md) (level 5 version), [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md),\
    \ [Lightning Bolt](z_Resources/CLI/spells/lightning-bolt-xphb.md) (level 5 version),\
    \ [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md), [Prestidigitation](z_Resources/CLI/spells/prestidigitation-xphb.md)\n\
    \n1/day each: [Chain Lightning](z_Resources/CLI/spells/chain-lightning-xphb.md),\
    \ [Finger of Death](z_Resources/CLI/spells/finger-of-death-xphb.md), [Power Word\
    \ Kill](z_Resources/CLI/spells/power-word-kill-xphb.md), [Scrying](z_Resources/CLI/spells/scrying-xphb.md)\n\
    \n2/day each: [Animate Dead](z_Resources/CLI/spells/animate-dead-xphb.md),\
    \ [Dimension Door](z_Resources/CLI/spells/dimension-door-xphb.md), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md)"
  "name": "Spellcasting"
- "desc": "The lich casts [Counterspell](z_Resources/CLI/spells/counterspell-xphb.md)\
    \ or [Shield](z_Resources/CLI/spells/shield-xphb.md) in response to the spell's\
    \ trigger, using the same spellcasting ability as Spellcasting.\n\nAt will:\
    \ [Counterspell](z_Resources/CLI/spells/counterspell-xphb.md), [Shield](z_Resources/CLI/spells/shield-xphb.md)"
  "name": "Protective Magic"
- "desc": "The lich casts [Fear](z_Resources/CLI/spells/fear-xphb.md), using the same\
...
- "desc": "If destroyed, the lich reforms in 1d10 days if it has a spirit jar, reviving\
    \ with all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
...
- "desc": "The lich makes three attacks, using Eldritch Burst or Paralyzing Touch\
    \ in any combination."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: +12, reach 5 ft. or range 120 ft. Hit: 31\
    \ (4d12 + 5) Force damage."
  "name": "Eldritch Burst"
- "desc": "Melee Attack: +12, reach 5 ft. Hit: 15 (3d6 + 5) Cold damage, and\
    \ the target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
...
- "desc": "Constitution Saving Throw: DC 20, each creature that isn't an Undead\
    \ in a 20-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "The region containing a lich's lair is warped by its presence, creating\
  ...
  "name": ""
- "desc": "- All-Seeing. While in its lair, the lich can cast [Clairvoyance](z_Resources/CLI/spells/clairvoyance-xphb.md),\
    ...
    \ Resurrection or [Wish](z_Resources/CLI/spells/wish-xphb.md) spell.  "
  "name": ""
