...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 9 (2d6 + 2) Cold damage, and\
    \ the target's [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) decreases\
...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 4 (1d4 + 2) Slashing damage.\
    ...
    \ has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed) condition\
    \ until the end of its next turn."
  "name": "Claw"
"bonus_actions":
- "desc": "While underwater, the ghoul moves up to half its [Swim Speed](z_Resources/CLI/rules/variant-rules/swim-speed-xphb.md)\
