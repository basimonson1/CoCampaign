...
"cr": "15"
"traits":
- "desc": "The vampire casts [Hunger of Hadar](z_Resources/CLI/spells/hunger-of-hadar-xphb.md)\
...
- "desc": "If the vampire drops to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ its resting place, it has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    \ condition for 1 hour, after which it regains 1 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
  "name": "Shadow Escape"
...
- "desc": "Ranged Attack: +10, range 120 ft. Hit: 16 (2d10 + 5) Necrotic damage,\
    \ and the target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
...
- "desc": "Constitution Saving Throw: DC 18, one creature the vampire can see within\
    ...
    \ [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) equal to\
    \ that amount."
  "name": "Sanguine Drain"
"legendary_actions":
