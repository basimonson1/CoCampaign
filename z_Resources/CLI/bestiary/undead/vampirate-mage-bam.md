...
---
# [Vampirate Mage](z_Resources\CLI\bestiary\undead/vampirate-mage-bam.md)
...
- "desc": "The mage casts one of the following spells, using Charisma as the spellcasting\
    ...
    \ [message](z_Resources/CLI/spells/message-xphb.md)\n\n1/day: [darkness](z_Resources/CLI/spells/darkness-xphb.md),\
    \ [dimension door](z_Resources/CLI/spells/dimension-door-xphb.md), [fly](z_Resources/CLI/spells/fly-xphb.md),\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/undead/token/vampirate-mage-bam.webp"
```
^statblock