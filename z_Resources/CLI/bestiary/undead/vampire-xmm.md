...
"cr": "13"
"traits":
- "desc": "The vampire casts [Charm Person](z_Resources/CLI/spells/charm-person-xphb.md),\
...
- "desc": "The vampire casts [Command](z_Resources/CLI/spells/command-xphb.md), requiring\
...
- "desc": "If the vampire drops to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) in mist form,\
    ...
    \ form and has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    \ condition until it regains any [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    \ and it regains 1 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The vampire has these weaknesses:\n\n- Forbiddance. The vampire can't\
    ...
    \ the vampire's heart while the vampire has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition in its resting place, the vampire has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    ...
    \ [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md) on\
...
- "desc": "Constitution Saving Throw: DC 17, one creature within 5 feet that is\
    \ willing or that has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled),\
    \ [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated), or [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition. Failure: 6 (1d4 + 4) Piercing damage plus 13 (3d8) Necrotic\
    \ damage. The target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum decreases by an amount equal to the Necrotic damage taken, and the vampire\
    \ regains [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ equal to that amount. A Humanoid reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ by this damage and then buried rises the following sunset as a [Vampire Spawn](z_Resources/CLI/bestiary/undead/vampire-spawn-xmm.md)\
    \ under the vampire's control."
  "name": "Bite (Bat or Vampire Form Only)"
"bonus_actions":
- "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
    \ a Tiny bat ([Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) 5 ft.,\
    \ [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md) 30 ft.) or\
    \ a Medium cloud of mist ([Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
    \ 5 ft., [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md) 20\
    ...
    \ other than its size and [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
    ...
    \ through liquid. It has [Resistance](z_Resources/CLI/rules/variant-rules/resistance-xphb.md)\
    \ to all damage, except the damage it takes from sunlight."
  "name": "Shape-Shift"
"legendary_actions":
- "desc": "The vampire moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
...
- "desc": "- Children of the Night. The vampire exerts influence over the animals\
    \ in its domain. From dusk until dawn, Medium or smaller Beasts have the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    ...
    \ the vampire and its allies) that finishes a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md)\
    ...
    \ the lair is [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md)\
