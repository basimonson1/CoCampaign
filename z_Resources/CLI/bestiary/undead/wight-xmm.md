...
"cr": "3"
"traits":
- "desc": "While in sunlight, the wight has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 13, one creature within 5 feet. Failure:\
    \ 6 (1d8 + 2) Necrotic damage, and the target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum decreases by an amount equal to the damage taken.\n\nA Humanoid slain\
    \ by this attack rises 24 hours later as a [Zombie](z_Resources/CLI/bestiary/undead/zombie-xmm.md)\
