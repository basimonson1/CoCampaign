...
- "desc": "The death tyrant randomly shoots one of the following magical rays at a\
    ...
    \ the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition for 1 hour\
    \ or until it takes damage. Success: Half damage only.  \n- 2 Paralyzing Ray.\
    \ Constitution Saving Throw: DC 17. Failure: The target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    ...
    \ Reactions; its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md) is\
    \ halved; and it can take either an action or a [Bonus Action](z_Resources/CLI/rules/variant-rules/bonus-action-xphb.md)\
    ...
    \ the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained) condition until\
    \ the start of the death tyrant's next turn or until the death tyrant has the\
    \ [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated) condition.\
    ...
    \ Constitution Saving Throw: DC 17. {@actSaveFail 1} The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
    \ negative energy in a 150-foot [Cone [Area of Effect]](z_Resources/CLI/rules/variant-rules/cone-area-of-effect-xphb.md).\
    \ Creatures in that area can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ until the start of the death tyrant's next turn. An intact Humanoid corpse there\
    \ instantly rises as a [Zombie](z_Resources/CLI/bestiary/undead/zombie-xmm.md)\
...
- "desc": "- Negative Energy Suffusion. Whenever a creature within 1 mile of the\
    \ lair regains [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ from a spell, it subtracts 1d10 from the number of [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ that finishes a [Short Rest](z_Resources/CLI/rules/variant-rules/short-rest-xphb.md)\
