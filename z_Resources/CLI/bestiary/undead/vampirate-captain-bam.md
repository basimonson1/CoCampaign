...
---
# [Vampirate Captain](z_Resources\CLI\bestiary\undead/vampirate-captain-bam.md)
...
- "desc": "A ship upon which the captain stands, along with all creatures and objects\
    \ aboard it, becomes [invisible](z_Resources/CLI/rules/conditions.md#Invisible)\
    \ to creatures not aboard the ship. The captain must concentrate on this magical\
    \ effect to maintain it (as if [concentrating](z_Resources/CLI/rules/conditions.md#Concentration)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/undead/token/vampirate-captain-bam.webp"
```
^statblock