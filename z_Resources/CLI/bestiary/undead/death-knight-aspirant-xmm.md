...
- "desc": "The aspirant casts one of the following spells, using Charisma as the spellcasting\
    \ ability (spell save DC 15):\n\nAt will: [Phantom Steed](z_Resources/CLI/spells/phantom-steed-xphb.md)\n\
    \n1/day each: [Destructive Wave](z_Resources/CLI/spells/destructive-wave-xphb.md)\
    \ (Necrotic), [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md)"
  "name": "Spellcasting"
- "desc": "The aspirant has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
