...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 8 (1d10 + 3) Bludgeoning damage\
    ...
    \ its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) maximum\
    \ doesn't return to normal when finishing a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md),\
...
- "desc": "Wisdom Saving Throw: DC 11, one creature the mummy can see within 60\
    \ feet. Failure: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
