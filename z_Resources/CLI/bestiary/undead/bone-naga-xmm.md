...
- "desc": "The naga casts one of the following spells, requiring no Material components\
    ...
    \ will: [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md), [Thaumaturgy](z_Resources/CLI/spells/thaumaturgy-xphb.md)\n\
    \n1/day each: [Command](z_Resources/CLI/spells/command-xphb.md), [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md),\
    \ [Lightning Bolt](z_Resources/CLI/spells/lightning-bolt-xphb.md)"
  "name": "Spellcasting"
"actions":
...
- "desc": "Wisdom Saving Throw: DC 13, one creature the naga can see within 60 feet.\
    \ Failure: 13 (3d6 + 3) Psychic damage, and the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
