...
- "desc": "The flameskull casts one of the following spells, requiring no Somatic\
    ...
    \ save DC 13):\n\nAt will: [Mage Hand](z_Resources/CLI/spells/mage-hand-xphb.md)\n\
    \n1/day: [Fireball](z_Resources/CLI/spells/fireball-xphb.md)\n\n2/day:\
    \ [Magic Missile](z_Resources/CLI/spells/magic-missile-xphb.md) (level 2 version)"
  "name": "Spellcasting"
- "desc": "The flameskull sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md)\
    \ in a 15- foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
    \ for an additional 15 feet."
  "name": "Illumination"
- "desc": "The flameskull has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "If the flameskull is destroyed, it regains all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ in 1 hour unless Holy Water is sprinkled on its remains or the [Dispel Evil\
    \ and Good](z_Resources/CLI/spells/dispel-evil-and-good-xphb.md) spell is cast\
    \ on them."
