...
---
# [Undead Spirit](z_Resources\CLI\bestiary\undead/undead-spirit-xphb.md)
...
- "desc": "Constitution Saving Throw: DC equals your spell save DC, any creature\
    ...
    \ from the spirit. Failure: The creature has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition,\
    \ it has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed) condition\
    \ until the end of its next turn."
  "name": "Rotting Claw (Putrid Only)"
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/undead/token/undead-spirit-xphb.webp"
```
^statblock