...
- "desc": "The poltergeist can move through other creatures and objects as if they\
    \ were [Difficult Terrain](z_Resources/CLI/rules/variant-rules/difficult-terrain-xphb.md).\
    \ It takes 5 (1d10) Force damage if it ends its turn inside an object."
  "name": "Incorporeal Movement"
"actions":
- "desc": "The poltergeist makes one [Object](z_Resources/CLI/rules/variant-rules/object-xphb.md)\
...
"bonus_actions":
- "desc": "The poltergeist gives itself the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible)\
