...
- "desc": "While in sunlight, the specter has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on ability checks and attack rolls."
  "name": "Sunlight Sensitivity"
"actions":
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 7 (2d6) Necrotic damage. If\
    \ the target is a creature, its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
