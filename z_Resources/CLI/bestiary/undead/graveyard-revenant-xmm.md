...
- "desc": "Melee Attack: +8, reach 10 ft. Hit: 10 (1d10 + 5) Bludgeoning damage\
    ...
    \ can have up to two targets [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "desc": "Wisdom Saving Throw: DC 15, each creature in a 30-foot [Emanation [Area\
    ...
    \ originating from the revenant. Failure: The target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
