...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion),\
  ...
  \ [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated), [paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed),\
...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 20 (4d8 + 2) Necrotic damage,\
    \ or 11 (2d8 + 2) Necrotic damage if the swarm is [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md).\
