...
- "desc": "The wisp can't wear or carry anything."
  "name": "Ephemeral"
- "desc": "The wisp sheds [Bright Light](z_Resources/CLI/rules/variant-rules/bright-light-xphb.md)\
    \ in a 20-foot radius and [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
    \ for an additional 20 feet."
  "name": "Illumination"
- "desc": "The wisp can move through other creatures and objects as if they were [Difficult\
    \ Terrain](z_Resources/CLI/rules/variant-rules/difficult-terrain-xphb.md). It\
...
- "desc": "Constitution Saving Throw: DC 10, one living creature the wisp can see\
    \ within 5 feet that has 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
    \ Failure: The target dies, and the wisp regains 10 (3d6) [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
  "name": "Consume Life"
- "desc": "The wisp and its light have the [Invisible](z_Resources/CLI/rules/conditions.md#Invisible)\
    \ condition until the wisp's [Concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
