...
"condition_immunities": "[charmed](z_Resources/CLI/rules/conditions.md#Charmed), [deafened](z_Resources/CLI/rules/conditions.md#Deafened),\
  \ [exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion), [frightened](z_Resources/CLI/rules/conditions.md#Frightened),\
...
- "desc": "If the demilich is destroyed, it reforms and regains all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ in 1d10 days unless a [Wish](z_Resources/CLI/spells/wish-xphb.md) spell is\
    \ cast on its remains."
  "name": "Undead Restoration"
"actions":
- "desc": "The demilich makes three Necrotic Burst attacks."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: +11, reach 5 ft. or range 120 ft. Hit: 24\
    \ (7d6) Necrotic damage."
  "name": "Necrotic Burst"
- "desc": "Constitution Saving Throw: DC 19, each creature in a 30-foot [Emanation\
    ...
    \ or Success: The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
...
- "desc": "Constitution Saving Throw: DC 19, one creature the demilich can see within\
    \ 120 feet. Failure: The target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum decreases by 14 (4d6). Failure or Success: The demilich can't take\
    \ this action again until the start of its next turn."
  "name": "Energy Drain"
- "desc": "The demilich flies up to its [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md),\
    ...
    \ Failure: The target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
...
- "desc": "- Enervating Domain. Whenever a creature other than the demilich or\
    \ one of its allies finishes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md)\
    \ within 1 mile of the lair, the creature must succeed on a DC 20 Constitution\
    \ saving throw or have its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum reduced by 1d4. This reduction lasts until the creature finishes a\
    \ [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md) outside that\
