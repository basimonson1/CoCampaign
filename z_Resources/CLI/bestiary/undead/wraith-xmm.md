...
- "desc": "While in sunlight, the wraith has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
    \ on ability checks and attack rolls."
  "name": "Sunlight Sensitivity"
"actions":
- "desc": "Melee Attack: +6, reach 5 ft. Hit: 21 (4d8 + 3) Necrotic damage.\
    \ If the target is a creature, its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum decreases by an amount equal to the damage taken."
  "name": "Life Drain"
- "desc": "The wraith targets a Humanoid corpse within 10 feet of itself that has\
    \ been dead for no longer than 1 minute. The target's spirit rises as a [Specter](z_Resources/CLI/bestiary/undead/specter-xmm.md)\
