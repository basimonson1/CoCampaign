...
- "desc": "The vampire takes 10 Radiant damage if it starts its turn in sunlight.\
    \ While in sunlight, it has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 7 (1d6 + 4) Piercing damage\
    \ plus 10 (3d6) Necrotic damage. The target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "While in [Dim Light](z_Resources/CLI/rules/variant-rules/dim-light-xphb.md)\
    \ or [Darkness](z_Resources/CLI/rules/variant-rules/darkness-xphb.md), the vampire\
