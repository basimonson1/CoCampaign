...
"cr": "5"
"traits":
- "desc": "If damage reduces the zombie to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    \ it makes a Constitution saving throw (DC 5 plus the damage taken) unless the\
    \ damage is Radiant or from a [Critical Hit](z_Resources/CLI/rules/variant-rules/critical-hit-xphb.md).\
    \ On a successful save, the zombie drops to 1 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ instead."
...
- "desc": "The zombie randomly shoots one of the following magical rays at a target\
    ...
    \ Throw: DC 14. Failure: The target has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    ...
    \ has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition until\
    \ the end of its next turn. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
    ...
    \ object or a creation of magical force, a 10-foot [Cube [Area of Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md)\
