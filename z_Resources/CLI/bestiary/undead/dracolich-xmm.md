...
- "desc": "The dracolich casts one of the following spells, requiring no Material\
    ...
    \ [Ray of Sickness](z_Resources/CLI/spells/ray-of-sickness-xphb.md) (level 2 version)\n\
    \n1/day each: [Create Undead](z_Resources/CLI/spells/create-undead-xphb.md)\
    \ (level 8 version), [Finger of Death](z_Resources/CLI/spells/finger-of-death-xphb.md)"
  "name": "Spellcasting"
- "desc": "If the dracolich fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (3/Day, or 4/Day in Lair)"
- "desc": "Creatures within 60 feet of the dracolich can't regain [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)."
  "name": "Life Suppression"
- "desc": "The dracolich has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The dracolich has a magical gem. If the dracolich is destroyed while the\
    ...
    \ in  days, regaining all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ and appearing within 5 feet of the gem.\n\nThe gem is a Tiny object that has\
    \ AC 20; HP 50; and [Immunity](z_Resources/CLI/rules/variant-rules/immunity-xphb.md)\
    \ to Necrotic, Poison, and Psychic damage. The gem regains all its [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ at the end of every turn, but it turns to dust if reduced to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
...
- "desc": "The dracolich makes three Rend attacks. It can replace one attack with\
    \ a use of Spellcasting to cast [Ray of Sickness](z_Resources/CLI/spells/ray-of-sickness-xphb.md)\
    \ (level 2 version)."
  "name": "Multiattack"
...
"legendary_actions":
- "desc": "The dracolich moves up to half its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md),\
    \ and it makes one Rend attack."
  "name": "Pounce"
- "desc": "The dracolich uses Spellcasting to cast [Ray of Sickness](z_Resources/CLI/spells/ray-of-sickness-xphb.md)\
...
- "desc": "Wisdom Saving Throw: DC 19, each creature in a 30-foot [Emanation [Area\
    \ of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "The region containing a dracolich's lair is warped by its presence, creating\
  ...
  "name": ""
- "desc": "- Sapping Mist. The area within 1 mile of the lair is [Lightly Obscured](z_Resources/CLI/rules/variant-rules/lightly-obscured-xphb.md)\
    \ by pale fog. Whenever a creature other than the dracolich or one of its allies\
    \ finishes a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md)\
    \ in that area, it must succeed on a DC 15 Constitution saving throw or gain 1\
    \ [Exhaustion](z_Resources/CLI/rules/conditions.md#Exhaustion) level.  \n- Soul\
    \ Drain. Creatures within 1 mile of the lair have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
