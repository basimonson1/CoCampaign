...
"cr": "2"
"traits":
- "desc": "The ankheg can burrow through solid rock at half its [Burrow Speed](z_Resources/CLI/rules/variant-rules/burrow-speed-xphb.md)\
...
- "desc": "Melee Attack: +5 (with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    ...
    \ Acid damage. If the target is a Large or smaller creature, it has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
