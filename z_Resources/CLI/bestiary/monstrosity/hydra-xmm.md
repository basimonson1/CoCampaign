...
- "desc": "The hydra has five heads. Whenever the hydra takes 25 damage or more on\
    ...
    \ it has taken Fire damage since its last turn. The hydra regains 20 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ when it grows new heads."
  "name": "Multiple Heads"
- "desc": "For each head the hydra has beyond one, it gets an extra [Reaction](z_Resources/CLI/rules/variant-rules/reaction-xphb.md)\
