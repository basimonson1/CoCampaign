...
- "desc": "The quaggoth casts one of the following spells, requiring no spell components\
    ...
    \ [Mind Spike](z_Resources/CLI/spells/mind-spike-xphb.md)"
  "name": "Spellcasting"
- "desc": "The quaggoth casts [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md)\
    ...
    \ as Spellcasting.\n\n3/day: [Feather Fall](z_Resources/CLI/spells/feather-fall-xphb.md),\
...
- "desc": "While [Bloodied](z_Resources/CLI/rules/variant-rules/bloodied-xphb.md),\
    \ the quaggoth has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on attack rolls."
  "name": "Bloodied Fury"
"actions":
