...
Carrion crawlers have segmented bodies like gigantic cutworms. From beneath their multipart maws protrude eight thin, lashing tentacles. Creatures struck by these tentacles risk being [paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed) and consumed.
...
- "desc": "Dexterity Saving Throw: DC 12, one creature the carrion crawler can see\
    \ within 10 feet. Failure: The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
