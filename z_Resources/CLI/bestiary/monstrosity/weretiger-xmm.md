...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 12 (2d8 + 3) Piercing damage.\
    ...
    \ it instead becomes a Weretiger under the DM's control and has 10 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
...
"bonus_actions":
- "desc": "The weretiger moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
