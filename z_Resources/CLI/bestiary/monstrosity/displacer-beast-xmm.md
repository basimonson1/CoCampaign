...
- "desc": "If the displacer beast is subjected to an effect that allows it to make\
  ...
  "name": "Avoidance"
- "desc": "Attack rolls against the displacer beast have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md),\
    \ since it projects an illusion that makes it appear to be near its actual location.\
    \ This trait is suppressed while the displacer beast has the [Incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
    \ condition."
  "name": "Displacement"
"actions":
...
- "desc": "Melee Attack: +6, reach 5 feet. Hit: 9 (1d10 + 4) Slashing damage.\
    \ If target is a Large or smaller creature, it has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition."
  "name": "Rend"
