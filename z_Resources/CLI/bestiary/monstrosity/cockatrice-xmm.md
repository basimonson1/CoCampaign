...
- "desc": "Melee Attack: +3, reach 5 ft. Hit: 3 (1d4 + 1) Piercing damage.\
    ...
    \ Saving Throw: DC 11. {@actSaveFail 1} The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition. The target repeats the save at the end of its next turn if it is\
    \ still [Restrained](z_Resources/CLI/rules/conditions.md#Restrained), ending the\
    \ effect on itself on a success. {@actSaveFail 2} The target has the [Petrified](z_Resources/CLI/rules/conditions.md#Petrified)\
    \ condition, instead of the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
