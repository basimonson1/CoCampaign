...
- "desc": "Melee Attack: +4, reach 5 ft. Hit: 4 (1d4 + 2) Piercing damage.\
    ...
    \ Saving Throw: DC 12. {@actSaveFail 1} The target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned), the\
    \ target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    \ maximum doesn't return to normal when finishing a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md),\
    \ and it repeats the save every 24 hours that elapse, ending the effect on itself\
    \ on a success. Subsequent Failures: The [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ target's [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
