...
- "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
    \ adhered to the mimic has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC 13). Ability checks made to escape this grapple have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)."
  "name": "Adhesive (Object Form Only)"
"actions":
- "desc": "Melee Attack: +5 (with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ if the target is [Grappled](z_Resources/CLI/rules/conditions.md#Grappled) by\
    \ the mimic), reach 5 ft. Hit: 7 (1d8 + 3) Piercing damage—or 12 (2d8 + 3)\
    \ Piercing damage if the target is [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 7 (1d8 + 3) Bludgeoning damage\
    ...
    \ DC 13). Ability checks made to escape this grapple have [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)."
  "name": "Pseudopod"
"bonus_actions":
