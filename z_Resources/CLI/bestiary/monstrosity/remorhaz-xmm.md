...
- "desc": "Melee Attack: +11, reach 10 ft. Hit: 18 (2d10 + 7) Piercing damage\
    ...
    \ DC 17), and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Strength Saving Throw: DC 19, one Large or smaller creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    ...
    \ The target is swallowed by the remorhaz, and the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    ...
    \ it has [Cover](z_Resources/CLI/rules/variant-rules/cover-xphb.md) against attacks\
    ...
    \ a space within 5 feet of the remorhaz and has the [Prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ condition. If the remorhaz dies, any swallowed creature no longer has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
