...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 8 (1d10 + 3) Piercing damage\
    \ plus 9 (2d8) Poison damage. If this damage reduces the target to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    \ the target becomes [Stable](z_Resources/CLI/rules/variant-rules/stable-xphb.md),\
    \ and it has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned) condition\
    \ for 1 hour. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
    \ the target also has the [Paralyzed](z_Resources/CLI/rules/conditions.md#Paralyzed)\
    \ condition."
  "name": "Bite"
"bonus_actions":
