...
"condition_immunities": "[frightened](z_Resources/CLI/rules/conditions.md#Frightened),\
...
- "desc": "Melee Attack: +17, reach 30 ft. Hit: 24 (4d6 + 10) Bludgeoning\
    \ damage. The target has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC 20) from one of ten tentacles, and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition until the grapple ends."
  "name": "Tentacle"
- "desc": "The kraken throws a Large or smaller creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    ...
    \ has the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition. Success:\
    \ Half damage only."
  "name": "Fling"
...
- "desc": "Dexterity Saving Throw: DC 25, one creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    ...
    \ and no longer [Grappled](z_Resources/CLI/rules/conditions.md#Grappled). A swallowed\
    \ creature has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition, has [Cover](z_Resources/CLI/rules/variant-rules/cover-xphb.md) against\
    \ attacks and other effects outside the kraken, and takes 24 (7d6) Acid damage\
    \ at the start of each of its turns.\n\nIf the kraken takes 50 damage or more\
    \ on a single turn from a creature inside it, the kraken must succeed on a DC\
    \ 25 Constitution saving throw at the end of that turn or regurgitate all swallowed\
    \ creatures, each of which falls in a space within 10 feet of the kraken with\
    \ the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition. If the kraken\
    \ dies, any swallowed creature no longer has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Constitution Saving Throw: DC 23, each creature in a 15-foot [Emanation\
    ...
    \ the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded) and [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ conditions until the end of the kraken's next turn. The kraken then moves up\
    \ to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md). Failure\
...
- "desc": "- Ocean Tyrant. The kraken exerts its dominance over animals in its\
    \ domain. All Beasts within 1 mile of the lair have the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ condition while in that area.  \n- Sea and Storms. While in its lair, the\
    \ kraken can cast [Control Weather](z_Resources/CLI/spells/control-weather-xphb.md),\
