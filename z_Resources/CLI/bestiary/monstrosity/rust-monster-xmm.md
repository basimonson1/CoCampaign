...
- "desc": "The rust monster targets one nonmagical metal object—armor or a weapon—\
    ...
    \ reaches -5. The penalty can be removed by casting the [Mending](z_Resources/CLI/spells/mending-xphb.md)\
...
- "desc": "The rust monster touches a nonmagical metal object within 5 feet of itself\
    ...
    \ Effect]](z_Resources/CLI/rules/variant-rules/cube-area-of-effect-xphb.md) of\
    \ the object."
  "name": "Destroy Metal"
"reactions":
