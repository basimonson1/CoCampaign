...
- "desc": "The yuan-ti casts one of the following spells, requiring no Material components\
    ...
    \ [Animal Friendship](z_Resources/CLI/spells/animal-friendship-xphb.md) (snakes\
    \ only)\n\n3/day: [Suggestion](z_Resources/CLI/spells/suggestion-xphb.md)"
  "name": "Spellcasting (Yuan-ti Form Only)"
- "desc": "The yuan-ti has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
"actions":
- "desc": "The yuan-ti makes two Bite attacks, and it can use Spellcasting to cast\
    \ [Suggestion](z_Resources/CLI/spells/suggestion-xphb.md) if available."
  "name": "Multiattack"
...
- "desc": "Strength Saving Throw: DC 15, one Large or smaller creature within 5\
    \ feet. Failure: 28 (7d6 + 4) Bludgeoning damage. The target has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC 14), and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
...
- "desc": "Constitution Saving Throw: DC 14, each creature in a 30-foot [Cone [Area\
    ...
    \ Failure: 21 (6d6) Poison damage, and the target has the [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned)\
    \ condition until the end of the yuan-ti's next turn. While [Poisoned](z_Resources/CLI/rules/conditions.md#Poisoned),\
