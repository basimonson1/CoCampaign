...
---
# [Void Scavver](z_Resources\CLI\bestiary\monstrosity/void-scavver-bam.md)
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 45\
    ...
    \ the swallowed creature, which falls [prone](z_Resources/CLI/rules/conditions.md#Prone)\
    \ in a space within 10 feet of the scavver. If the scavver dies, a swallowed creature\
    \ is no longer [restrained](z_Resources/CLI/rules/conditions.md#Restrained) by\
    \ it and can escape from the corpse by using 10 feet of movement, exiting [prone](z_Resources/CLI/rules/conditions.md#Prone)."
  "name": "Swallowing Bite"
"bonus_actions":
- "desc": "The scavver's eye emits an [invisible](z_Resources/CLI/rules/conditions.md#Invisible),\
    \ magical ray that targets one creature the scavver can see within 60 feet of\
    \ itself. The target must succeed on a DC 16 Wisdom saving throw or be [frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    \ of the scavver until the start of the scavver's next turn."
  "name": "Ray of Fear (Recharge 4-6)"
"source":
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/monstrosity/token/void-scavver-bam.webp"
```
^statblock