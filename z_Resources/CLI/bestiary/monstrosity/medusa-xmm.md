...
With their hair of living snakes and their infamous petrifying gazes, medusas are hubristic creatures that inhabit sites of fallen glory. They often dwell beyond the fringes of civilization or travel in disguise, leaving trails of [petrified](z_Resources/CLI/rules/conditions.md#Petrified) victims. Some medusas dominate groups of monsters or criminals, controlling them with threats of [petrified](z_Resources/CLI/rules/conditions.md#Petrified) doom, while others recruit servants that are immune to being [petrified](z_Resources/CLI/rules/conditions.md#Petrified), such as gargoyles and gorgons.
...
- "desc": "Constitution Saving Throw: DC 13, each creature in a 30-foot [Cone [Area\
    ...
    \ If the medusa sees its reflection in the [Cone [Area of Effect]](z_Resources/CLI/rules/variant-rules/cone-area-of-effect-xphb.md),\
    \ the medusa must make this save. {@actSaveFail 1} The target has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
