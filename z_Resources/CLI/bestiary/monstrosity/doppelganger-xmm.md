...
"cr": "3"
"traits":
- "desc": "The doppelganger casts [Detect Thoughts](z_Resources/CLI/spells/detect-thoughts-xphb.md),\
...
- "desc": "The doppelganger makes two Slam attacks and uses Unsettling Visage if available."
  "name": "Multiattack"
- "desc": "Melee Attack: +6 (with [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Wisdom Saving Throw: DC 12, each creature in a 15-foot [Emanation [Area\
    ...
    \ The target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
