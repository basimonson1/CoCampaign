...
---
# [Thri-kreen Mystic](z_Resources\CLI\bestiary\monstrosity/thri-kreen-mystic-bam.md)
...
- "desc": "The thri-kreen casts one of the following spells, requiring no spell components\
    \ and using Wisdom as the spellcasting ability:\n\nAt will: [levitate](z_Resources/CLI/spells/levitate-xphb.md)\
    \ (self only), [mage hand](z_Resources/CLI/spells/mage-hand-xphb.md) (the hand\
    \ is invisible)\n\n1/day each: [freedom of movement](z_Resources/CLI/spells/freedom-of-movement-xphb.md)\
    \ (self only), [invisibility](z_Resources/CLI/spells/invisibility-xphb.md) (self\
    \ only)"
...
- "desc": "The thri-kreen changes the color of its carapace to match the color and\
    \ texture of its surroundings, gaining advantage on Dexterity ([Stealth](z_Resources/CLI/rules/skills.md#Stealth))\
    \ checks it makes to hide in those surroundings."
  "name": "Chameleon Carapace"
"source":
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/monstrosity/token/thri-kreen-mystic-bam.webp"
```
^statblock