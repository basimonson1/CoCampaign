...
---
# [Ssurran Defiler](z_Resources\CLI\bestiary\monstrosity/ssurran-defiler-bam.md)
...
- "desc": "The ssurran casts one of the following spells, requiring no spell components\
    ...
    \ (the hand is invisible)\n\n1/day: [invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
    \ (self only)"
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/monstrosity/token/ssurran-defiler-bam.webp"
```
^statblock