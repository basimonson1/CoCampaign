...
- "desc": "Melee Attack: +13, reach 5 ft. Hit: 23 (4d6 + 9) Slashing damage.\
    \ If the target is a Huge or smaller creature, it has the [Grappled](z_Resources/CLI/rules/conditions.md#Grappled)\
    \ condition (escape DC 19) from both talons, and it has the [Restrained](z_Resources/CLI/rules/conditions.md#Restrained)\
    \ condition until the grapple ends."
  "name": "Talons"
"bonus_actions":
- "desc": "If the roc has a creature [Grappled](z_Resources/CLI/rules/conditions.md#Grappled),\
    \ the roc flies up to half its [Fly Speed](z_Resources/CLI/rules/variant-rules/fly-speed-xphb.md)\
