...
- "desc": "Melee Attack: +3, reach 5 ft. Hit: 6 (2d4 + 1) Slashing damage."
  "name": "Claw"
- "desc": "The harpy sings a magical melody, which lasts until the harpy's [Concentration](z_Resources/CLI/rules/conditions.md#Concentration)\
    ...
    \ [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition until the song\
    \ ends and repeats the save at the end of each of its turns. While [Charmed](z_Resources/CLI/rules/conditions.md#Charmed),\
