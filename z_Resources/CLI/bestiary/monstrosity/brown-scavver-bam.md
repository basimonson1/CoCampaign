...
---
# [Brown Scavver](z_Resources\CLI\bestiary\monstrosity/brown-scavver-bam.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 11\
    ...
    \ swallowed creature, which falls [prone](z_Resources/CLI/rules/conditions.md#Prone)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/monstrosity/token/brown-scavver-bam.webp"
```
^statblock