...
aliases: ["Megapede"]
---
# [Megapede](z_Resources\CLI\bestiary\monstrosity/megapede-bam.md)
...
- "desc": "The megapede targets one creature it can see within 60 feet of itself.\
    ...
    \ takes 22 (5d8) psychic damage and is [incapacitated](z_Resources/CLI/rules/conditions.md#Incapacitated)\
...
- "BAM"
- "LoX"
"image": "z_Resources/CLI/bestiary/monstrosity/token/megapede-bam.webp"
```
^statblock