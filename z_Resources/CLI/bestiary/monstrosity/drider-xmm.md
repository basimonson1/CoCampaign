...
"cr": "6"
"traits":
- "desc": "The drider casts [Darkness](z_Resources/CLI/spells/darkness-xphb.md), [Faerie\
    \ Fire](z_Resources/CLI/spells/faerie-fire-xphb.md), or [Web](z_Resources/CLI/spells/web-xphb.md),\
...
- "desc": "The drider can climb difficult surfaces, including along ceilings, without\
  ...
  "name": "Spider Climb"
- "desc": "While in sunlight, the drider has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
