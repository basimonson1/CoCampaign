...
aliases: ["Fey Spirit"]
---
# [Fey Spirit](z_Resources\CLI\bestiary\fey/fey-spirit-xphb.md)
...
- "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
    ...
    \ Failure: The target is [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
...
"source":
- "XPHB"
"image": "z_Resources/CLI/bestiary/fey/token/fey-spirit-xphb.webp"
```
^statblock