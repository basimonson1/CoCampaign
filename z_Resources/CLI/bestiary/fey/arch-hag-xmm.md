...
- "desc": "While within 30 feet of at least two hag allies, the hag can cast one of\
    ...
    \ DC 19): [Augury](z_Resources/CLI/spells/augury-xphb.md), [Find Familiar](z_Resources/CLI/spells/find-familiar-xphb.md),\
...
- "desc": "The hag casts one of the following spells, requiring no Material components\
    ...
    \ Door](z_Resources/CLI/spells/dimension-door-xphb.md), [Dispel Magic](z_Resources/CLI/spells/dispel-magic-xphb.md),\
    \ [Hypnotic Pattern](z_Resources/CLI/spells/hypnotic-pattern-xphb.md)\n\n2/day\
    \ each: [Mass Suggestion](z_Resources/CLI/spells/mass-suggestion-xphb.md), [Modify\
    \ Memory](z_Resources/CLI/spells/modify-memory-xphb.md), [Plane Shift](z_Resources/CLI/spells/plane-shift-xphb.md)"
  "name": "Spellcasting"
- "desc": "The hag casts [Counterspell](z_Resources/CLI/spells/counterspell-xphb.md)\
...
- "desc": "When the hag drops to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md),\
    \ it dies only if it is within 30 feet of its anathema (a thing the DM chooses\
    \ as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ the space it left is cursed. Until the curse ends, a creature has [Disadvantage](z_Resources/CLI/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "Melee or Ranged Attack: +14, reach 10 ft. or range 60 ft. Hit: 17\
    ...
    \ the [Prone](z_Resources/CLI/rules/conditions.md#Prone) condition."
  "name": "Spectral Claw"
...
- "desc": "The hag makes one Spectral Claw attack."
  "name": "Hag's Swipe"
- "desc": "The hag uses Spellcasting to cast [Dimension Door](z_Resources/CLI/spells/dimension-door-xphb.md)\
    \ or [Hypnotic Pattern](z_Resources/CLI/spells/hypnotic-pattern-xphb.md). The\
...
- "desc": "- Lapsus Linguae. Creatures (excluding the hag and its allies) within\
    ...
    \ take the [Influence](z_Resources/CLI/rules/actions.md#Influence) action.  \n\
    - Meddlesome Magic. Whenever a creature other than the hag or its allies finishes\
    \ a [Long Rest](z_Resources/CLI/rules/variant-rules/long-rest-xphb.md) while within\
    \ 1 mile of the lair, the next time that creature casts a spell using a spell\
    \ slot, it also casts [Confusion](z_Resources/CLI/spells/confusion-xphb.md) centered\
    \ on itself. The spell uses the creature's spellcasting ability and doesn't require\
    \ [Concentration](z_Resources/CLI/rules/conditions.md#Concentration).  "
  "name": ""
