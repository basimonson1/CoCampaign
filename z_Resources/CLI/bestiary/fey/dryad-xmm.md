...
| 4 | A lonely tree that stands atop a windswept mountain or amid a [petrified](z_Resources/CLI/rules/conditions.md#Petrified) forest. |
...
- "desc": "The dryad casts one of the following spells, requiring no Material components\
    ...
    \ [Animal Friendship](z_Resources/CLI/spells/animal-friendship-xphb.md), [Charm\
    \ Monster](z_Resources/CLI/spells/charm-monster-xphb.md) (lasts 24 hours; ends\
    \ early if the dryad casts the spell again), [Druidcraft](z_Resources/CLI/spells/druidcraft-xphb.md)\n\
    \n1/day each: [Entangle](z_Resources/CLI/spells/entangle-xphb.md), [Pass without\
    \ Trace](z_Resources/CLI/spells/pass-without-trace-xphb.md)"
  "name": "Spellcasting"
- "desc": "The dryad has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The dryad makes one Vine Lash or Thorn Burst attack, and it can use Spellcasting\
    \ to cast [Charm Monster](z_Resources/CLI/spells/charm-monster-xphb.md)."
  "name": "Multiattack"
