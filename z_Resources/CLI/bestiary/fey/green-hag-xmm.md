...
- "desc": "The hag casts one of the following spells, requiring no Material components\
    ...
    \ [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md) (24-hour duration),\
    \ [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md) (self only, and\
    \ the hag leaves no tracks while Invisible), [Minor Illusion](z_Resources/CLI/spells/minor-illusion-xphb.md),\
    \ [Ray of Sickness](z_Resources/CLI/spells/ray-of-sickness-xphb.md) (level 3 version)"
  "name": "Spellcasting"
...
- "desc": "The hag can mimic animal sounds and humanoid voices. A creature that hears\
    ...
    \ ([Insight](z_Resources/CLI/rules/skills.md#Insight)) check."
  "name": "Mimicry"
"actions":
