...
"cr": "6"
"traits":
- "desc": "The satyr has [Advantage](z_Resources/CLI/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "The satyr conjures a charming or frightening song. Wisdom Saving Throw:\
    \ DC 14, each enemy in a 60-foot [Emanation [Area of Effect]](z_Resources/CLI/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the satyr. Failure: The target is subjected to the song's\
    \ effect:\n\n- Charming. The target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
    \ condition for 1 minute. While [Charmed](z_Resources/CLI/rules/conditions.md#Charmed),\
    ...
    \ damage, and the target has the [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
