...
Sprites can sense the innate goodness or wickedness of other creatures. Those that enter their realms with good intentions might be treated to tiny feasts and celebrations. The wicked face nasty tricks and bold ambushes at the hands of [invisible](z_Resources/CLI/rules/conditions.md#Invisible) sprite defenders. These woodland guardians enchant the arrows of their tiny bows with charming magic that can pierce the heart of the fiercest foe.
...
"cr": "1/4"
"traits":
- "desc": "The sprite casts [Invisibility](z_Resources/CLI/spells/invisibility-xphb.md)\
...
- "desc": "Ranged Attack: +6, range 40/160 ft. Hit: 1 Piercing damage, and the\
    \ target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed) condition\
...
- "XMM"
- "XPHB"
"image": "z_Resources/CLI/bestiary/fey/token/sprite-xmm.webp"
```
^statblock
