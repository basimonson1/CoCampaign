...
- "desc": "The goblin casts one of the following spells, using Intelligence as the\
    ...
    \n1/day each: [Blindness/Deafness](z_Resources/CLI/spells/blindness-deafness-xphb.md),\
    \ [Faerie Fire](z_Resources/CLI/spells/faerie-fire-xphb.md), [Grease](z_Resources/CLI/spells/grease-xphb.md)"
  "name": "Spellcasting"
"actions":
