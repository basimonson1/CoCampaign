...
- "desc": "Ranged Attack: +7, range 90 ft. Hit: 14 (3d6 + 4) Radiant damage,\
    \ and the target has the [Blinded](z_Resources/CLI/rules/conditions.md#Blinded)\
    \ condition until the start of the centaur's next turn."
  "name": "Sun Ray"
"bonus_actions":
- "desc": "The centaur moves up to its [Speed](z_Resources/CLI/rules/variant-rules/speed-xphb.md)\
