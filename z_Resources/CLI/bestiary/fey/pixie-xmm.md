...
- "desc": "The pixie casts one of the following spells, requiring no Material components\
    ...
    \ [Fly](z_Resources/CLI/spells/fly-xphb.md), [Sleep](z_Resources/CLI/spells/sleep-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "Melee or Ranged Attack: +4, reach 5 ft. or range 60 ft. Hit: 1 Radiant\
    \ damage, and the target has the [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
