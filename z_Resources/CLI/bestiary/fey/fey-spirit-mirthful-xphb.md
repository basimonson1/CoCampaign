...
---
# [Fey Spirit (Mirthful)](z_Resources\CLI\bestiary\fey/fey-spirit-mirthful-xphb.md)
...
- "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
    ...
    \ spirit can see within 10 feet of itself. Failure: The target is [Charmed](z_Resources/CLI/rules/conditions.md#Charmed)\
