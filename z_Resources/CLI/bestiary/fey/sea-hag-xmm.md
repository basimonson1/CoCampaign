...
Sea hags loathe peace and beauty. Bitter, jealous creatures, they spread chaos and undermine joy however they can, undertaking elaborate deceptions to sow discord for its own sake. The hags' true forms are supernaturally vile, and their baleful gazes can strike down creatures [frightened](z_Resources/CLI/rules/conditions.md#Frightened) by their appearance.
...
- "desc": "While within 30 feet of at least two hag allies, the hag can cast one of\
    ...
    \ DC 11): [Augury](z_Resources/CLI/spells/augury-xphb.md), [Find Familiar](z_Resources/CLI/spells/find-familiar-xphb.md),\
  ...
  "name": "Coven Magic"
- "desc": "The hag casts [Disguise Self](z_Resources/CLI/spells/disguise-self-xphb.md),\
...
- "desc": "Melee Attack: +5, reach 5 ft. Hit: 10 (2d6 + 3) Slashing damage."
  "name": "Claw"
- "desc": "Wisdom Saving Throw: DC 11, one [Frightened](z_Resources/CLI/rules/conditions.md#Frightened)\
    \ creature the hag can see within 30 feet. Failure: If the target has 20 [Hit\
    \ Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md) or fewer, it\
    \ drops to 0 [Hit Points](z_Resources/CLI/rules/variant-rules/hit-points-xphb.md).\
